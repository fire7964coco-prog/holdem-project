...
> 직전 회차 = **ja 회차 14 머지**(09-11 (16) · ff `975226b5` · 직답 «개수 열거» 축 II 8편 9자리 · §5-L 1·2 → queue Q4-a · §2-N 전건 → queue Q6 — 경위 WORKLOG).
> 🔴🔴 **ja 소급 회차는 14로 끝났다 — 사장님 결재(09-11 「머지하고 그만하자 어차피 끝이 없다며」).** 정본 = `settled-decisions` §1-D. **회차 15를 열지 마라.** ja 잔여는 queue Q6 «ja 잔여 묶음»이 ja 파일을 직접 고친다. ja 레인은 `lane:sync` 수신만. **세 로케일 레인 전부 회차 없음 · zh·zh-hant 회차 8(직답 길이)도 같은 판정 대상**(열려면 사장님 지시 · 아니면 queue Q6에 흡수).
