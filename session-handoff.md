...
> 마지막 갱신 **2026-09-20** · HEAD = **`20d1aae0`** · **미커밋 0 · 배포·라이브 확인·IndexNow 완료.**
>
> **최근 3회차(전부 종결 — 경위는 WORKLOG, 되묻지 말 것)**
...
>
> 🔴 **되살리기 금지 셋**: ① (not set)은 구조적 동작이다 — «유실»로 되돌리지 마라(보정 ② 유지 · `RULES_VERSION` 1)
