...
> 🧰 **queue 상태(09-14 (28))**: Q1·Q2-a·Q2-b·Q2-c·Q4-a·Q5-a·Q5-b·Q7-a ✅ · **Q7-b ✅**(게이트 II · 글 무변경 · 머지 `f6f1bb04`). 남은 회차 = **Q6**(로케일 표기·ja 잔여 + 🆕 새 게이트가 드러낸 부채) · **Q8-a/b**(pt·id·de 용어 분열) · 🏆 **Q4-b**(대회 묶음). 🆕 **새 재료** = `en-first-queue` §1 ㉒-c(직답 리드 4편) · ㉙(이미지 1장) · §3 EN `holdem-hand-rankings` 리드↔표 축어 중복. 다음 권장 = **Q6**(새 부채가 세 레인 파일이라 워크트리 겹침 확인 먼저).
