...
> **Respuesta rápida**
> **En posición (IP)** significa que hablas último; **fuera de posición (OOP)** significa que hablas primero. La posición suele mejorar la realización de equity porque actuar último aporta más información, pero ningún asiento queda necesariamente por encima o por debajo del 100%: los rangos, el board y la acción pueden invertir el patrón habitual. Por eso UTG abre ~13% de las manos, el botón ~43%, y por eso cada c-bet, cada farol y cada decisión de control del bote cambia con tu asiento.
...
|:---|:---:|:---|
| **En posición** | ==g:**Suele ser mayor — depende del spot**== | Hablas último → lo ves todo → apuestas por valor y faroleas en el momento justo |
| **Fuera de posición** | ==r:**Suele ser menor — puede superar el 100%**== | Hablas primero → foldeas manos ganadoras, pagas con perdedoras, regalas cartas gratis |

Estas etiquetas son una regla general, no una ley. La posición crea una ventaja media, pero los rangos, el board y la acción determinan qué asiento sobre-realiza o infra-realiza en un spot concreto.

![Comparación IP vs OOP — el botón (IP) habla último; los rangos, el board y la acción determinan la realización exacta de equity de cada asiento](/images/holdem-position-play-ip-vs-oop.webp)
...
Aquí tienes la ventaja del botón en una mano concreta. Abres A♦9♦ en el botón, la ciega grande iguala, y el flop viene **K♦7♠2♥** — una mesa seca que no le pega a casi nadie. La ciega grande pasa, lo que aquí no dice casi nada: en esta mesa pasa prácticamente con todo su rango. La información está en otro sitio: un rey conecta mucho más con tu rango de apertura que con su rango de pago. ==g:Una apuesta aquí gana muchas más veces de las que pierde==, y cuando foldea, el as alto se lleva el bote sin showdown. Ahora invierte los asientos: OOP con la misma A♦9♦, pasas, él apuesta, y estás foldeando la mejor mano una parte nada despreciable de las veces. Las mismas cartas; el asiento hizo todo el trabajo.
...
A. Depende de la calle. En el *preflop*, la ciega pequeña habla antes que la ciega grande, y la ciega grande habla la última — «cierra» la acción. En el *postflop* (flop, turn y river), la ciega pequeña es la primera en actuar y la ciega grande justo después, así que una vez que salen las cartas la ciega pequeña habla antes que la ciega grande (la única excepción es el heads-up, donde el botón pone la ciega pequeña y aun así habla último en el postflop, de modo que la ciega grande va primero). El botón siempre habla último en el postflop, que es justo por lo que es el asiento más rentable.
...
A. Porque hablar último convierte las mismas cartas en más dinero. Suele mejorar la realización de equity, pero no obliga al asiento en posición a superar el 100% ni al que está fuera de posición a quedar por debajo; los rangos, el board y la acción pueden invertir el patrón. El jugador en posición sigue viendo la decisión de cada rival antes de tomar la suya, así que apuesta por valor, farolea y foldea en mejores momentos con las mismas manos.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/es/blog/holdem-positions" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Nombres de asientos y mapa de la mesa</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">UTG, Lojack, Hijack, Cutoff, Botón — cada asiento explicado</div>
  </a>
  <a href="/es/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Qué manos jugar desde cada asiento — tabla de referencia imprimible</div>
  </a>
  <a href="/es/blog/holdem-blind-meaning" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Estrategia de ciega pequeña y ciega grande</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por qué los asientos con descuento son los más difíciles de rentabilizar</div>
  </a>
  <a href="/es/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Estrategia de torneo vs cash game</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Cómo cambian las decisiones de posición cuando aplica el ICM</div>
  </a>
</div>
`.trim(),
};
