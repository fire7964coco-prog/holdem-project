...
- **face-down muck कर सकते हैं** अगर उन्हें दिख जाए कि हार गए — अपने कार्ड दिखाने की ज़रूरत नहीं। पर यह तभी तक है जब तक कोई all-in न हुआ हो: जैसे ही कोई खिलाड़ी all-in होता है, TDA नियम 16 उस pot की हर हैंड खोलना अनिवार्य कर देता है और कोई muck नहीं कर सकता
...
| river पर की गई all-in bet call हो जाती है | all-in करने वाला last aggressor के नाते पहले दिखाता है — पर ==r:यहाँ कोई muck नहीं कर सकता==: TDA नियम 16 के तहत caller को भी हैंड खोलनी होती है |
...
A. हाँ — अगर आप river पर सबसे आख़िर में bet या raise करने वाले थे, तो call मिलने पर आपको पहले दिखाना होगा। अगर आपने किसी और की bet call की, तो उसकी हैंड देखने के बाद, हारने पर आप face-down muck कर सकते हैं। अपवाद all-in है: TDA नियम 16 के तहत caller को भी हैंड खोलनी पड़ती है। और टूर्नामेंट में हैंड देखने की माँग वही कर सकता है जिसके पास अब भी कार्ड हैं या जिसने उन्हें खोल दिया है — अटूट रूप से, सिर्फ़ last aggressor की हैंड पर।
