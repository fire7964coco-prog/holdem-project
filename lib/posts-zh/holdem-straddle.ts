...
如果你在现场局见过凭空多出来一个盲注，你要找的就是这个词。straddle 属于强制盲注这一家族——想先把整套黑话过一遍，看[术语大全](/zh/blog/holdem-glossary "thumb:/images/holdem-glossary-hero.webp")；本文只对 straddle 这一个词做单点深挖。它也是整个扑克术语大全里最容易被误解的词条之一，所以我们把它彻底讲清楚。下面讲清楚 **straddle（抓头）** 到底是什么、你会碰到的每一种、有人抓了之后谁先说话，以及那个唯一要紧的问题的老实答案：==g:你到底该不该抓？==
