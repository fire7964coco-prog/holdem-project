...
- **face-down muck कर सकते हैं** अगर उन्हें दिख जाए कि हार गए — अपने कार्ड दिखाने की ज़रूरत नहीं। पर यह तभी तक है जब तक कोई all-in न हुआ हो: टूर्नामेंट में, जैसे ही कोई खिलाड़ी all-in होता है, TDA नियम 16 उस pot की हर हैंड खोलना अनिवार्य कर देता है और कोई muck नहीं कर सकता (cash game में house rules चलते हैं, और ज़्यादातर cardroom caller को muck करने देते हैं)

==r:पर एक अहम अपवाद है:== अगर आपकी river bet call हुई थी, तो call करने वाले ने आपकी हैंड देखने की पूरी क़ीमत चुकाई है। dealer से यह माँगना कि muck हो चुकी हैंड पलट कर दिखाई जाए — यही **"I want to see that hand"** नियम है। टूर्नामेंट में ==TDA नियम 18== इसकी हद बहुत कसकर खींचता है: showdown पर जिसके हाथ में कार्ड नहीं बचे, या जिसने मुँह नीचे muck कर दिया, वह माँगने का हक़ खो देता है। यह हक़ अटूट सिर्फ़ उसी का है जिसने river की bet call की और अपने कार्ड खोले या पकड़े रखे — और वह भी सिर्फ़ ==last aggressor== की हैंड पर, यानी उसी हैंड पर जिसके लिए उसने पैसे दिए। बाक़ी सब टूर्नामेंट डायरेक्टर के विवेक पर है; cash game में कई cardroom इसे ज़्यादा उदारता से लागू करते हैं। (इसे "show one, show all" से न उलझाएँ, जिसका मतलब है कि अगर आप अपने कार्ड ख़ुद किसी एक खिलाड़ी को दिखाते हैं, तो टेबल के सबको देखने का हक़ मिल जाता है।)

व्यावहारिक नियम: ==last aggressor होने के नाते कार्ड आप पलटते हैं — call हो चुका bluff भी।== मुँह नीचे muck करना caller का विकल्प है, वह भी bettor की हैंड देख लेने के बाद। bet करके झटपट muck करेंगे तो दोहरा नुक़सान: caller फिर भी आपकी हैंड देखने की माँग कर सकता है, और cards speak के चलते कई pot ऐसे खिलाड़ियों ने फेंके हैं जिनका ace-high दरअसल आगे था।
...
| river पर की गई all-in bet call हो जाती है | all-in करने वाला last aggressor के नाते पहले दिखाता है — पर टूर्नामेंट में ==r:यहाँ कोई muck नहीं कर सकता==: TDA नियम 16 के तहत caller को भी हैंड खोलनी होती है |
| कई all-in जिनसे कई side pot बनते हैं | हर pot अलग-अलग सुलझता है; शामिल सभी हैंड दिखाई जाती हैं |

</div>

एक बारीकी: अगर कोई **side pot** है (बाक़ी खिलाड़ियों के पास अब भी chips हैं और वे betting जारी रखते हैं), तो side pot पहले दिया जाता है और उसके बाद main pot। यह **भुगतान का क्रम** है, कार्ड खोलने के समय से इसका कोई लेना-देना नहीं: all-in खिलाड़ी की हैंड तो उसी क्षण खुली पड़ी होती है जब और betting संभव नहीं रहती। TDA के नियम 16 का उदाहरण यही साफ़ कहता है — all-in की हैंड पलटने के लिए side pot बँटने का इंतज़ार मत कीजिए।
...
यह दोनों तरफ़ चलता है। अगर आपको लगे कि आप हार गए और बिना दिखाए muck कर दें, पर आपकी हैंड ही जीतने वाली थी — ==r:तो pot गया==। हैंड तभी मरती है जब dealer उसे muck में धकेल दे और वह साफ़ पहचानी न जा सके — मुँह नीचे रखे कार्ड अपने आप नहीं मरते (TDA नियम 14)। फिर भी इस पर कभी भरोसा न करें। अगर आपको 100% यक़ीन नहीं कि आप हारे हैं, तो muck करने से पहले हमेशा dealer को अपनी हैंड पढ़ने दें।
...
showdown पर — यानी जब सारी betting ख़त्म हो चुकी हो — आधिकारिक तौर पर अपनी बारी आने से पहले हैंड पलटने के ख़िलाफ़ कोई नियम नहीं है। पर जब तक हैंड चालू है और कहीं कोई action बाक़ी है, उल्टा लागू होता है: कार्ड दिखाने पर ==WSOP नियम 117== के तहत पेनल्टी लगती है। ==g:अगर आपके पास nuts या कोई बहुत मज़बूत हैंड है, तो तुरंत दिखा दें।== बाक़ी खिलाड़ी इसकी क़द्र करते हैं। इससे खेल तेज़ होता है। और यह slow rolling का ठीक उल्टा है।
...
A. हाँ — अगर आप river पर सबसे आख़िर में bet या raise करने वाले थे, तो call मिलने पर आपको पहले दिखाना होगा। अगर आपने किसी और की bet call की, तो उसकी हैंड देखने के बाद, हारने पर आप face-down muck कर सकते हैं। अपवाद टूर्नामेंट का all-in है: TDA नियम 16 के तहत caller को भी हैंड खोलनी पड़ती है। और टूर्नामेंट में हैंड देखने की माँग वही कर सकता है जिसके पास अब भी कार्ड हैं या जिसने उन्हें खोल दिया है — अटूट रूप से, सिर्फ़ last aggressor की हैंड पर।
