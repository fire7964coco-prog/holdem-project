...
메인이벤트에 도전하기로 했다면 구조를 미리 알아두면 좋습니다. 2026년은 APT 20주년 시즌이라 규모가 더 큽니다.
...
메인이벤트뿐 아니라 Super High Roller·High Roller·Superstar Challenge·Zodiac Classic·Mini Main Event 등도 시트를 배출해, 대회 전체에서 총 **9장의 타이베이 챔피언십 시트**가 걸려 있습니다.
...
**메가 위성 구조:**
- $35 메가 위성: Live Day 1 시트 **52석 보장** 배출
- $200 메가 위성: Live Day 1 시트 **22석 보장** 배출

**OnLive 경로 (선택지):**
$20 스텝 위성 → OnLive Day 1 → **집에서 Day 1 플레이** → ITM 생존하면 **Day 2부터 현장 합류**
