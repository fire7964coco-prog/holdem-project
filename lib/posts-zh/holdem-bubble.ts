...
export const POST: Post = {
  ...
  tldr: "钱圈（bubble）就是进钱前的那一段——再淘汰一个人，其余所有人就都进钱了。因为出局什么都拿不到，活下来的价值就超过了你能赢到的筹码——所以跟注范围收得很紧，而 shove（推）依然要宽。大码进攻，中码最被困死（不是 short stack），而在卫星赛的钱圈上，一旦你的席位锁定，什么都弃，连口袋 A 都弃。",
  category: "tournament",
  date: "2026-07-09",
  updated: "2026-09-09",
