...
**straddle（第三盲注；台港俗称强抓，澳门/亚洲牌房也叫抓头）就是发牌前主动补的一个盲注——通常是大盲的 2 倍。** 在一个 $1/$2 的局里，枪口位（大盲紧左边）的人可以扔出 $4「抓 straddle」，这手牌立刻就当成一张 $1/$2/$4 的桌子来打。
...
大多数页面只讲「抓不抓」，却漏了更常发生的一半：**牌桌上有人抓了 straddle，轮到你时该怎么打。** 关键不在心态，而在一个数字——**有效筹码（用 BB 算）被砍了一半。**
...
:::card
📉 | 小对子、投机牌掉价 | 22–66、后门同花连张这类牌靠的是「便宜进场、中暗三条/顺子听牌后拿走深筹码」。50BB 的隐含赔率远不如 100BB——中了也套不到那么多，跟进价格却翻倍，所以这些牌要**大幅收紧**
🎯 | 大牌、高牌相对升值 | 筹码变浅时，摊牌价值和翻前主动权的权重上升。AA–TT、AK、AQ 这类**不依赖深筹码兑现**的牌，在被 straddle 的浅池里相对更值钱——该 3-bet 就 3-bet，别只跟
📐 | SPR 被压低，翻后更简单 | straddle 吹大了起始底池却没加深筹码，翻牌一到 **SPR（筹码底池比）明显更低**。这意味着中顶对就常常是「一手到底」的局面——少了转牌河牌的花哨操作空间，反过来又惩罚那些指望花式打法的投机牌
:::

一句话记牢：**被 straddle 后不是「照打再加一档」，而是「当成一个更浅的局重打」**——收掉投机牌，把范围往大牌、能主动施压的牌上靠。想系统补这块，先把 [位置](/zh/blog/holdem-position-play) 和 [底池赔率](/zh/blog/holdem-pot-odds) 的底层逻辑吃透，被 straddle 的池只是它们的一个放大版。
