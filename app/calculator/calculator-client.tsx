...
const HAND_TABLE: TierEntry[] = [
  ...
  [2, "88",  "드로우 잠재력 좋은 포켓페어", "LP 레이즈, EP에선 레이즈에 콜 고려 — 오픈 림프 금지"],
  ...
  [3, "77",  "셋 드로우 기대, 오버카드 주의", "LP 레이즈, EP에선 레이즈에 콜 — 오픈 림프 금지"],
  ...
  [5, "44",  "셋 없으면 가치 거의 없음", "레이즈 앞에선 콜 금액의 15배 이상이 뒤에 남았을 때만 콜"],
  [5, "33",  "셋 드로우 필요, 도박성↑", "멀티웨이 팟, 딥스택에서만"],
  [5, "22",  "가장 낮은 포켓페어", "멀티웨이 팟, 딥스택에서만"],
