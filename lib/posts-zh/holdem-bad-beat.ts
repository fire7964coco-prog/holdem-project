...
> **快速回答**
> 2008 年 WSOP 主赛事：Motoyuki Mabuchi 凑成四条 A，却输给 Justin Phillips 的方块同花大顺——同一张河牌 A♦ 同时做出了两手牌。严格按门槛算它甚至不算 bad beat：钱是河牌之后才进池的。

如果你想让自己心里好受点，记住：最惨的 bad beat 都发生在最大的舞台上。最传奇的那一次发生在 **2008 年世界扑克大赛（WSOP）主赛事**上，**Motoyuki Mabuchi** 把他的一对 A 打成了 **four of a kind——四条 A**，一手全扑克里只有同花顺能击败的牌——却*还是输了*。river 河牌那张 **A♦** 凑成了他的四条，而与此同时，同一张牌又给了 **Justin Phillips**（手握 K♦ J♦）一个 **同花大顺**——方块的 10‑J‑Q‑K‑A。钱是在那之后才进池的：Mabuchi 过牌，Phillips 下注，Mabuchi 全下，Phillips 立刻跟注。让他凑成四条 A 的那唯一一张牌，正是唯一能击败它的那张牌。
...
这不是安慰话，而是一条能推到底的道理。想想一次 bad beat 需要什么：一个把钱在*落后*时、作为数学上的弱势方推进去，然后走运的对手。那是一个在做**亏钱决策**的玩家——正是你想要的那种对手。如果你牌桌上从来没人逆袭你，那就意味着每个人都在正确地弃掉自己的弱牌，也就没有钱可赢了。正如一句广为人知的教练格言所说，来自弱手的一次 suckout 是一份*礼物*：它是你另外四次拿走他们筹码的入场费。
...
A. 不算。一次 bad beat 需要你是个大热门——通常约 80% 或以上——然后被 suck out。输掉一个接近五五开的对局，比如 A‑K 对 Q‑Q（大约 50/50），只是正常的 variance。如果那手牌接近一次抛硬币，这不算被爆冷，你只是输了一次本来就有大约一半概率会输的对翻。
