...
| **Example** | QQ+, AK, AQs, JJ, TT, KQs | QQ+ and AK + A5s-type bluffs; flat the JJ/AQ/TT middle |
| **Use it when** | The open is **wide and weak** (late position), or you're **in position**. Against the same open, the small blind leans more linear than the big blind, because it rarely flats | The open is **strong/tight** (early position), or you're in the **big blind** (where you flat the middle at a discount) |
...
| Your hand | In position (e.g. button vs a steal) | Out of position (small blind — the big blind flats wider, see below) |
|:---|:---|:---|
...
The big takeaway: **flatting is legitimate in position** — modern solvers keep a healthy flatting range on the button because you act last on every postflop street and only the two blinds are left behind you, so the squeeze risk is small and you can see flops profitably. Out of position it's weaker, but with one important split: from the **small blind**, lean toward *3-bet or fold* with a more **linear** range: calling wide OOP realizes your equity poorly and builds a weak, cappable range, so you raise the top of your range and let the rest go. The **big blind** is the exception — because you close the action and are already getting a price, you defend by *calling* far wider there, especially against late-position steals. That leaves your big-blind 3-bets comparatively **polarized**: the strong hands and the bluffs, with the middle flatted. Position, again, changes everything — the same lesson as the [position playbook](/en/blog/holdem-position-play).
...
A. 4-bet a polarized range: premiums for value (QQ+ and AK — against opponents who rarely 3-bet, tighten the core to AA–KK) and a few blocker bluffs like A5s that block your opponent's aces and ace-king. Size a 4-bet to roughly 2.2–2.5x the 3-bet in position and a touch larger out of position — smaller than most beginners expect, because the pot is already big. As a frequency, solid players 4-bet only a few percent of hands; widen your value 4-bets against opponents who 3-bet too often.
...
A. A linear (merged) range is one solid block of your best hands — used against wide, weak opens or when in position. A polarized range is your strongest hands plus bluffs, with the medium hands removed and flatted instead — used against tight opens, and from the big blind, where the price you're already getting lets you call with the middle instead of getting it blasted off by 4-bets. The small blind, with no cheap call available, leans more linear.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/en/blog/holdem-strategy" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Where 3-betting fits in a winning game</div>
  </a>
  <a href="/en/blog/holdem-limping" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Strategy</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Why Limping Costs You</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Raise or fold — don't just call</div>
  </a>
  <a href="/en/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Why 3-bets work better in position</div>
  </a>
  <a href="/en/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Which hands are worth raising at all</div>
  </a>
</div>
`.trim(),
};
