...
在德州撲克裡，唯一會正面發出的牌就是那五張公共牌——其他牌都蓋著，除非在攤牌時亮出、在全下時翻開、被主動亮出，或是意外露出（不小心翻出的牌），所以幾乎沒有東西可以追蹤。但梭哈——以及同樣發明牌的梭哈系玩法，像 Razz 和梭哈高低分——獎勵的，正是 21 點算牌者最擅長的那種記牌本領。這是撲克裡最接近電影版的一種玩法。
