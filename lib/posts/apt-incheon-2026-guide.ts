...
| # | 이벤트명 | 바이인 | 날짜 | GTD |
|---|---------|--------|------|-----|
| #1 | Korea National Cup | 70만원 | 8/7~8 | 2억원 |
| #2 | Mystery Bounty Hunter | 90만원 | 8/8~9 | 3억원 |
| #8 | Mini Main Event | 90만원 | 8/14~15 | 4억원 |
| #10 | Ultra Stack | 70만원 | 8/15~16 | 1.5억원 |
| **#5** | **APT Main Event** | **250만원** | **8/9~15** | **15억원** |
| #7 | Zodiac Classic | 300만원 | 8/13~14 | 5억원 |
| #11 | APT High Roller | 500만원 | 8/15~16 | 5억원 |
| #3 | APT Super High Roller | 1,500만원 | 8/8~9 | 5억원 |
| #6 | Superstar Challenge | 3,500만원 | 8/10~11 | 비공개 |

==r:초보자 현실 목표: #8 Mini Main Event(90만원) 또는 #5 Main Event 위성 경로==
...
**1.** $3.50 스텝 위성 → 2. $35 메가 위성 → 3. 메인이벤트 시트(250만원 상당)

**방법 B: Natural8 메가 위성 직접 (중간)**
**1.** $35 또는 $200 메가 위성 → 2. 메인이벤트 시트

**방법 C: 현장 직접 바이인 (가장 확실)**
**1.** 현장 등록 데스크 → 2. 250만원 결제 → 3. 즉시 착석
...
**OnLive 경로 (선택지):**
$20 스텝 위성 → OnLive Day 1 → **집에서 Day 1 플레이** → ITM 생존하면 **Day 3부터 현장 합류**
...
A. 8월 9일(Day 1A) 오전 11시 이전 APT 등록 데스크에서 250만원 직접 결제하면 됩니다. 결제 수단: 현금(KRW) 또는 신용카드. 사전 이메일 등록도 가능합니다(registrations@apt.poker). Day 1B 이후도 레이트 등록 가능하며 Day 2 첫 레벨까지는 참가할 수 있습니다.
