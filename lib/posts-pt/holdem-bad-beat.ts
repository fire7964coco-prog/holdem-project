...
export const POST: Post = {
  ...
  imageAlt: "Um jogador de poker segurando a cabeça em agonia depois de perder um pote enorme que era grande favorito para vencer, com suas fichas empilhadas no feltro verde",
  tags: ["bad beat", "o que é bad beat no poker", "bad beat vs cooler", "bad beat jackpot", "suckout no poker", "colocar as fichas bem", "como lidar com bad beats"],
  content: `
...
Um **bad beat** é quando você coloca suas fichas como favorito estatístico pesado e perde mesmo assim, porque o adversário pega uma carta de sorte pra dar um ==g:suckout== em você. A palavra-chave é *favorito* — você estava vencendo quando o dinheiro entrou, e só uma carta improvável virou o resultado. É uma das palavras mais mal usadas de todo o [glossário de poker](/pt/blog/holdem-glossary "thumb:/images/holdem-glossary-hero.webp"), então abaixo está exatamente o que conta como bad beat, como ele difere de um [cooler](/pt/blog/holdem-cooler "thumb:/images/holdem-cooler-hero.webp"), quanto paga um "bad beat jackpot", e a verdade contraintuitiva que todo jogador vencedor acaba aprendendo: bad beats costumam ser um *bom* sinal.
...
![Infográfico que separa o bad beat do cooler — ases contra setes que melhoram para uma trinca, ao lado de reis que esbarram em ases que nunca precisaram melhorar](/images/holdem-bad-beat-litmus.webp "A divisão estrita: os ases estavam na frente quando as fichas entraram e foram superados — bad beat; os reis entraram atrás e nunca alcançaram — cooler")

As pessoas usam "bad beat" e "cooler" como sinônimos, e não existe uma linha oficial única entre os dois — mas, no sentido estrito que este guia usa, eles são opostos, e saber qual dos dois acabou de acontecer te diz se você deve ficar irritado com o baralho ou impressionado com ele. A diferença toda é **quem estava na frente quando o dinheiro entrou, e se houve um suckout:**

<div style="background:rgba(255,248,210,0.10);border:1px solid rgba(255,240,180,0.35);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| | Bad Beat | Cooler (sentido estrito) |
|:---|:---|:---|
| **Quem liderava quando as fichas entraram** | **Você** era o favorito (muitas vezes 80%+) | Você estava **atrás** |
| **Houve um suckout?** | Sim — uma carta de sorte virou tudo | Não — o líder liderou o caminho todo |
| **Dava pra dar fold?** | Não importa — você estava vencendo | Não — mão forte demais pra foldar |
| **Exemplo clássico** | AA perde quando 7‑7 acerta uma trinca | KK esbarra em AA |
| **A sensação** | "Ele me sugou" | "Eu nunca tive chance" |

</div>

Um teste rápido: **se você era favorito pesado quando o dinheiro entrou e o seu adversário precisou *melhorar* pra ganhar, é um bad beat.** Se ele já estava na frente quando o dinheiro entrou e você simplesmente não conseguiu foldar seu monstro, isso é um [cooler](/pt/blog/holdem-cooler) no sentido estrito — sem suckout, sem bad beat. E repare na armadilha: **trinca flopada sobre trinca flopada não é bad beat.** Quando a sua trinca de damas perde pra uma trinca de reis feita no mesmo flop, ninguém deu sorte no river — a trinca maior estava na frente o tempo inteiro. (Se os reis só acertaram a trinca no turn ou no river *depois* que o dinheiro entrou, o teste aponta suckout — aí *é* bad beat. Se as fichas só entraram depois que a trinca maior chegou, continua sendo cooler.) Isso é um cooler vestido de bad beat.

---

## Que tamanho de favorito faz um bad beat ser "de verdade"?

![Um visual simples de três passos de um bad beat — um favorito de 80 por cento, depois um suckout no river, depois a derrota](/images/holdem-bad-beat-suckout.webp "A forma de um bad beat: você é favorito de ~80%, o river entrega um suckout, e a mão que você deveria ter ganhado se foi")

Aqui é onde os jogadores casuais e os sérios se separam: **nem toda derrota como favorito é um bad beat.** Existe uma barra de equity não escrita, e ela importa se você quer usar o termo com honestidade.

- **~80% ou mais, e você perde pra um suckout** — um bad beat genuíno. Seus ases (favoritos de ~4 para 1 sobre um par menor) sendo quebrados é o caso de manual. Um **one-outer** — perder pra única carta restante no baralho — é o bad beat mais puro de todos.
- **Favorito de 60–70% perdendo** — desagradável, mas na real só variância. Você era um favorito modesto; o outro resultado sempre ia acontecer com bastante frequência.
- **Um coinflip nunca é um bad beat.** Perder A‑K pra Q‑Q (uns 43/57 offsuit, 46/54 suited), ou um par pra duas overcards, é perto o bastante de um cara-ou-coroa — chamar isso de bad beat é chamar a variância de roubo. Se a mão era basicamente um par ou ímpar, você não *apanhou*, só perdeu um flip.

A regra prática: um bad beat exige **ambos** uma grande vantagem (favorito pesado) **e** um suckout (o azarão melhorando pra ganhar). Falte qualquer uma das condições e é só a textura normal do jogo. Ser honesto sobre isso é o que separa um jogador que estuda de um que culpa o baralho por toda derrota — a mesma autohonestidade que distingue um cooler de verdade de uma [mão mal jogada](/pt/blog/holdem-pot-odds "thumb:/images/holdem-pot-odds-hero.webp").
...
| A batida | Você tinha | Você era | Como acontece |
|:---|:---|:---:|:---|
...
## O que é um bad beat jackpot?

Algumas salas de poker transformam a dor em prêmio. Um **bad beat jackpot** é um pote progressivo — construído com uma pequena taxa recolhida dos potes ao longo do dia, o "drop" do jackpot — que paga quando uma mão muito forte perde no showdown. A ideia é recompensar o jogador que sofre uma batida espetacular, e o pagamento muitas vezes muda a vida.

As regras **variam por sala**, mas a estrutura comum é assim:

- **O qualificador.** Um mínimo típico é **"ases full de valetes ou melhor, batidos por uma quadra ou melhor".** Algumas salas colocam a barra mais alta (quadra batida). A mão perdedora tem que ser enorme — você não consegue disparar isso com um cooler de tamanho normal. (Curiosidade: tecnicamente até um confronto desse tamanho costuma ser um **cooler**, não um bad beat — mas o jackpot herdou o nome antigo e ninguém vai mudar.)
- **As duas hole cards têm que jogar.** Quase toda sala exige que *as duas* hole cards do perdedor (e muitas vezes as do vencedor) façam parte da mão, então você não pode reivindicar numa mão feita inteiramente pelo board.
- **A divisão.** O jogador que levou o bad beat fica com a **maior fatia**, o vencedor da mão fica com a segunda fatia, e os demais jogadores **que receberam cartas naquela mão** dividem o resto.

<div style="background:rgba(255,248,210,0.10);border:1px solid rgba(255,240,180,0.35);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| Quem | Fatia típica |
|:---|:---:|
| **Perdedor (a mão do bad beat)** | ~50% |
| **Vencedor da mão** | ~25% |
| **Outros que receberam cartas** | ~25% (dividido igualmente) |

</div>

**Uma coisa o jackpot não usa: o teste do começo desta página.** O qualificador dele é escrito em força de mão, e não em quem estava na frente quando o dinheiro entrou. Faça o teste no gatilho clássico: você tem A♠A♥ num board A♣ J♠ J♦ 7♥ 2♣ para full de ases com valetes, e o adversário tem J♥J♣ para quadra de valetes. As duas mãos já estavam completas no flop e foi ali que as fichas entraram, então ninguém foi ultrapassado depois do dinheiro ir — pelo critério acima isso é um **cooler**, e é exatamente o que o jackpot paga. Trate "bad beat jackpot" como nome de produto da sala, não como uma segunda definição do termo.

Uma ressalva importante: **cada clube, cassino ou site de poker define seu próprio qualificador e divisão** — alguns usam 40/30/30, alguns exigem um par na mão pra formar a quadra qualificadora, alguns recolhem o drop do jackpot de forma diferente. Nunca presuma; sempre confira as regras publicadas da sala específica antes de contar com um pagamento.
...
## Por que os bad beats são na verdade bons pra você

Agora a verdade que transforma bad beats de combustível de tilt numa fonte silenciosa de confiança. **Uma sequência constante de bad beats normalmente é sinal de que você está jogando num jogo vencível.**
...
## Como lidar com um bad beat

Depois de conferir que colocar o dinheiro foi certo — sizing, profundidade de stack, pressão de torneio —, um bad beat não carrega nenhuma lição sobre o seu jogo, e o principal perigo dele é o que faz com as suas *próximas* mãos. Proteja elas:

1. **Aceite em voz alta.** Um simples "coloquei bem, não tinha nada que eu pudesse fazer" é melhor do que remoer em silêncio. Nomear como variância fecha o caso.
2. **Fique de olho no tilt.** O pote que você perdeu já era; as três mãos imprudentes que você joga tentando recuperá-lo são o custo real de um bad beat. Se você sentir o calor subir, esse é o seu sinal pra desacelerar.
3. **Faça uma pausa.** Fique de fora de uma rodada, beba água, dê uma volta por cinco minutos. É o seguro mais barato do poker contra transformar uma mão perdida numa sessão perdida.
4. **Confie no seu bankroll.** Bad beats são o motivo de você manter um bankroll construído pra absorver variância. Num cash game, uma batida é um erro de arredondamento ao longo de dezenas de milhares de mãos — o estrago duradouro vem de deixar que ela mude o seu jeito de jogar. Num torneio ela pode encerrar a sua campanha na hora; essa é a variância que você aceita ao se inscrever.
5. **Pule a história do bad beat.** Ninguém quer ouvir, e recontar só te faz reviver o tilt. A marca de um profissional não é nunca levar batidas — é esquecê-las na mão seguinte.

---

:::readnext[Continue lendo]
/pt/blog/holdem-cooler | O que é cooler no poker? | /images/holdem-cooler-hero.webp
/pt/blog/holdem-fish | O que é um fish no poker? | /images/holdem-fish-hero.webp
:::

## FAQ

**Q. O que é um bad beat no poker?**

A. Um bad beat é quando você perde uma mão que era favorito estatístico forte pra ganhar, porque o adversário pegou uma carta improvável pra te ultrapassar. Você colocou o seu dinheiro "bem" — na frente na matemática — e só um suckout improvável virou o resultado. O caso clássico é um par de ases sendo quebrado por um par menor que acerta uma trinca.
...
A. Não. Um bad beat exige que você seja favorito pesado — geralmente por volta de 80% ou mais — e então leve um suckout. Perder um confronto quase par como A‑K contra Q‑Q (A‑K só ganha uns 43% offsuit, 46% suited) é só variância normal. Se a mão estava perto de um cara-ou-coroa, você não apanhou feio, só perdeu um flip que sempre ia pro outro lado mais ou menos metade das vezes.

**Q. O que é um bad beat jackpot e o que qualifica?**

A. Um bad beat jackpot é um prêmio progressivo que algumas salas pagam quando uma mão excepcionalmente forte perde no showdown. Um qualificador comum é "ases full de valetes ou melhor batidos por uma quadra ou melhor", com as duas hole cards do perdedor exigidas pra jogar. O perdedor normalmente fica com a maior fatia, o vencedor com a segunda, e o resto da mesa divide o que sobra — mas qualificadores e divisões variam por sala, então sempre confira as regras locais.
...
A. Pode parecer que sim, mas é principalmente uma ilusão de volume. Online você joga muito mais mãos por hora — muitas vezes em várias mesas — então você simplesmente *vê* mais bad beats no mesmo tempo. As cartas são distribuídas aleatoriamente; você não tem mais azar online, só está passando por muito mais mãos, e mais mãos significam mais suckouts nas duas direções.

**Q. Como você lida com bad beats no poker?**

A. Aceite a mão como variância, fique bem atento ao tilt, e proteja as suas próximas decisões — o pote perdido já era, mas as mãos imprudentes que você joga tentando recuperá-lo são o custo real. Faça uma pausa curta se precisar, apoie-se num bankroll construído pra absorver variância, e pule o recontar da história do bad beat, que só te faz revivê-la.
...
1. **Um bad beat é perder como grande favorito pra um suckout de sorte** — você estava na frente quando o dinheiro entrou e foi outdrawn. Se colocar o dinheiro foi a jogada certa, é variância, não erro.
2. **Na definição estrita, é o oposto de um cooler.** Um bad beat precisa de uma grande vantagem e de um suckout (o azarão melhora); um cooler estrito não tem suckout (o líder continuou na frente). Se você era favorito pesado ao entrar e o seu adversário teve que melhorar pra ganhar, foi um bad beat.
...
Bad beats são o imposto que você paga por jogar um jogo vencedor. Os melhores jogadores levam muitos — muitas vezes mais, porque são favoritos com mais frequência — eles só aprenderam a registrá-los como variância, proteger a próxima mão do tilt, e voltar a [jogar melhor que a mesa](/pt/blog/holdem-fish). Coloque o seu dinheiro bem com frequência suficiente, e a crueldade do baralho vira o seu lucro.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/holdem-cooler" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">O que é um cooler?</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">A derrota sem suckout — em sentido estrito, sem bad beat</div>
  </a>
  <a href="/pt/blog/holdem-fish" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">O jogador cujos suckouts pagam as suas contas</div>
  </a>
  <a href="/pt/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Saiba quando você é o favorito, pra começar</div>
  </a>
  <a href="/pt/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Como a mão vencedora é realmente decidida</div>
  </a>
</div>
`.trim(),
};
