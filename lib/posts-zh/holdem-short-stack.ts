...
export const POST: Post = {
  ...
  tags: ["短码策略", "德州扑克短码怎么打", "push fold 策略", "push fold 图表", "M值 德州扑克", "德州扑克短码", "锦标赛 20bb 策略", "fold equity"],
  content: `
...
问题在于 fold equity 会==随着你码量缩水而衰减==。在 12–15 个大盲时，对手弃牌很多——你的推很吓人。到大约 8–10 个大盲它开始消退，到 4–5 个时对手拿到的[底池赔率](/zh/blog/holdem-pot-odds)好到几乎什么牌都跟——你的 fold equity 基本没了。这正是别等的全部理由：==趁你的 all in 还吓得住人时就推==，而不是等之后。
...
| 🟡 黄 | 10 以上、低于 20 | ~15–30bb | 收紧，开始找推的机会 |
| 🟠 橙 | 6 以上、低于 10 | ~9–15bb | push/fold；first-in 施压，偷盲 |
| ⚠ 红 | 1 以上、低于 6 | ~1.5–9bb | 任何合理的牌都推或弃 |
...
**Q. 扑克里的“全下或弃牌（all-in or fold）”是什么意思？**

A. “全下或弃牌”和 push/fold 是同一个意思：当你短码、又是第一个进池时，你只有两个选择——要么全押 all in，要么弃牌，不平跟、不小加注。它同时也是一种线上快节奏赛制的名字（GGPoker 的 All-in or Fold），在那里每一个翻前决策字面上就只能推或弃。不管哪种情况，短码逻辑都成立：靠推保住你的 fold equity，永远别在一个你守不住的加注上白流筹码。
...
**Q. 短码在大盲位怎么反偷盲（re-steal）？**

A. 你短码坐在大盲位、后位的人开池偷你的盲注时，别习惯性弃牌。你已经有一个大盲在池里，而对方的偷盲范围往往很宽，所以你可以拿一个不算强、但对着他那个宽范围有胜率的牌直接推回去（re-shove）——把这次偷盲变成他的一个艰难抉择。范围随他偷得越宽而放宽：面对按钮位的大范围偷盲，像 A-x、K-Q、中小对子这类牌都能反推；面对枪口位的紧开池就收紧。关键是靠 fold equity 让他弃掉大部分牌——一旦你的码量跌破约 8 个大盲，反推吓不动人了，就只剩牌力硬碰硬。

**Q. 什么是 M 值（M-ratio）？**

A. M值是你的码量除以一圈的成本（小盲 + 大盲 + ante）——你靠弃牌还能撑几轮。Harrington 的分区是绿（20+）、黄（10 以上、低于 20）、橙（6 以上、低于 10）、红（1 以上、低于 6）和死（低于 1）。你的 M 越低，就越必须抓推或弃的位置。没有 ante 时，M 大约是你的大盲数 ÷ 1.5。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  ...
  <a href="/zh/blog/holdem-icm" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">锦标赛</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">ICM 详解</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">为什么生存能胜过筹码</div>
  </a>
