...
> **快速解答**
> 攤牌會卡住，通常是因為兩件事被混在一起：「誰先開牌」看的是**最後一輪下注怎麼結束的**（有人下注被跟，還是全員過牌），而「能不能不亮就蓋掉」看的是**你是不是那個被跟的人**、以及桌上有沒有人全下。下面把這幾種情況分開講。
...
- **亮牌**，如果你覺得自己贏
- **正面朝下蓋牌（Muck）**，如果你看出自己輸了——不需要秀出你的牌。但這只在沒人全下時成立：在錦標賽裡，一旦有人全下，依 TDA 第 16 條，該底池牽涉到的每一手牌都必須攤開，誰都不能蓋牌（現金桌則看各撲克室自己的規矩，多半允許跟注方蓋牌）
...
> **快速解答**
> 要看全下發生在哪一條街。河牌上的全下被跟到，還是照最後主動下注者的規則走——全下的人先亮。但如果全下發生在更早的街、後面已經不可能再有下注，牌會在發完剩下的公牌之前就全部翻開，這時「誰先亮」根本不成立。
...
有一個細節：如果還有 **邊池（side pot）**（其他人手上還有籌碼、繼續下注），邊池會先結算，然後才是主池。但那只是**派彩順序**，跟什麼時候翻牌是兩回事：全下玩家的牌，在不可能再有下注的那一刻就已經攤開了。TDA 第 16 條的圖解講得很白——不要等邊池分完才去翻全下玩家的牌。
...
> **快速解答**
> 這條規則保護的是「看錯自己牌的人」：荷官照牌面判勝負，你嘴上說錯不影響結果。但它保護不了「已經丟進蓋牌堆、認不出來的牌」——所以不確定的時候，先讓荷官讀完再決定要不要蓋。
...
> **快速解答**
> 四個常見錯誤裡有三個同一個根：搞不清楚「我這一手是下注方還是跟注方」。下注方要先亮、不能等；跟注方才有蓋牌不亮的選擇。剩下一個是手速——荷官還沒讀完就把牌丟掉。
...
在攤牌階段——也就是所有下注都結束之後——沒有任何規則禁止你在還沒正式輪到你之前就翻牌。但只要這手牌還在進行、還有動作沒走完，情況就完全相反：亮牌要依 ==WSOP 第 117 條== 受罰。==g:如果你手上是堅果牌或一手很強的牌，馬上亮。== 別的玩家會感激你。這能加快牌局。而且這正是搓牌的相反面。
...
A. 要——如果你是河牌圈最後一個下注或加注的人，被跟到時你必須先亮。如果是你跟了別人的注，你可以在看到對方的牌、確認自己輸了之後，正面朝下蓋牌。例外是錦標賽中的全下：依 TDA 第 16 條，跟注方同樣必須攤牌。而在錦標賽裡，只有手上還有牌、或已經攤牌的人才能要求看牌——不可剝奪的，僅限最後主動下注者那一手。
