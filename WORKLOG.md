...
- holdem-starting-hands-chart: **§13 AK 에쿼티 오류 정정**(모든 페어 상대 코인플립, 66↓ clear favorite 아님). :::rangechart::: 인터랙티브 삽입(이미지 0→1), 내부링크 2(hand-rankings·betting-actions), slash 5곳. ⚠️스타팅핸드 이미지 전부 한국어→EN 재사용불가
