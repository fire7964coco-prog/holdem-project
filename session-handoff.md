...
- 🆕 **fr 전략 코퍼스 확장**(starting-hands-chart·pot-odds·equity·3bet·strategy·glossary 우선 —
  fr 랜딩 내부링크가 규칙 6편뿐이라 이 확장이 랜딩도 보강한다. EN 마스터 → fr 재저작 ·
  `docs/local-voice/fr-fr.md` 참조)
