...
export const CALC_DICT_FR: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "Le grand chiffre est la valeur exacte",
  ...
  starting: {
    ...
    hands: {
      ...
      A10s: { desc: "L'un des meilleurs as assortis", action: "Relancer en LP ; se coucher en EP, sauf si la table est passive — dans ce cas, ouvrir d'une relance" },
      ...
      "88": { desc: "Paire servie avec un bon potentiel de brelan", action: "Relancer en LP ; en EP, envisager de payer une relance — jamais d'open-limp" },
      ...
      "109s": { desc: "Connecteur assorti solide", action: "Relancer en LP ; payer une relance avec la position" },
      "77": { desc: "Main à chercher le brelan, attention aux overcards", action: "Relancer en LP ; en EP, payer une relance — jamais d'open-limp" },
      ...
      "55": { desc: "Peu de valeur sans brelan", action: "Payer une seule relance en LP ; relancer si tu ouvres le coup depuis la LP" },
      ...
      "98s": { desc: "Connecteur assorti solide", action: "Payer une relance en LP ; relancer avec la position" },
      "87s": { desc: "Bon connecteur assorti", action: "Payer une relance en LP" },
      ...
      "44": { desc: "Presque aucune valeur sans brelan", action: "Ne payer une relance que si toi et le relanceur avez au moins ~15× le call derrière" },
      "33": { desc: "Doit toucher le brelan ; spéculative", action: "Pots multiway en tapis profonds uniquement" },
      "22": { desc: "La plus petite paire servie", action: "Pots multiway en tapis profonds uniquement" },
      ...
      "65s": { desc: "Connecteur assorti ; veut du multiway et des cotes implicites", action: "Payer une relance en LP" },
      "54s": { desc: "Petit connecteur assorti ; spéculatif", action: "Payer une relance en LP, pots multiway pas chers" },
    },
  },
