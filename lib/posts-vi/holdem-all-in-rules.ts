...
2. Người chơi B tố lên $25.
3. Người chơi C all-in **$30** (chỉ hơn nước tố $25 của B đúng $5 — chưa đủ một bậc tố đủ mức).

Người chơi A và Người chơi D thì sao?

- Người chơi A đã hành động (cược $10). Vì cú all-in $30 của C **ít hơn một nước tố đủ mức** (muốn đủ phải ít nhất $40 = $25 + $15 mức tố tối thiểu), vòng cược KHÔNG mở lại cho Người chơi A. ==A chỉ được theo hoặc bỏ bài — không được tố lại.==
- Người chơi D chưa hành động — **D vẫn được tố bình thường**.
...
A. Cú all-in sau cùng được tính là hành động tấn công cuối. Luật showdown thông thường áp dụng: người all-in hoặc tấn công cuối cùng lật trước. Trong cash game, nếu đó là cú all-in được theo mà không còn hành động nào nữa, người theo có thể úp bài bỏ nếu thua sau khi xem bài của người all-in (trong giải đấu, mọi tay bài liên quan đều phải lật ngửa).
