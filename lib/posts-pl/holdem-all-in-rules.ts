...
1. Gracz A stawia $10.
2. Gracz B wchodzi all-in za **$14** (tylko $4 więcej niż zakład A wynoszący $10 — to nie pełne przebicie, które wymagałoby co najmniej $20).

Co dzieje się z Graczem A i z Graczem C, który jeszcze nie zagrał?

- Gracz A już zagrał (postawił $10) i teraz mierzy się tylko z niepełnym przebiciem. Ponieważ all-in B za $14 jest **mniejszy niż pełne przebicie**, akcja NIE otwiera się na nowo dla Gracza A. ==A może tylko sprawdzić albo spasować — nie może przebić.==
- Gracz C jeszcze nie zagrał — **Gracz C wciąż może przebić normalnie**.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pl/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Wszystkie zasady, od blindów po showdown</div>
  </a>
  <a href="/pl/blog/holdem-showdown-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Zasady showdownu</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kto pokazuje pierwszy i kiedy możesz wyrzucić karty</div>
  </a>
</div>
`.trim(),
};
