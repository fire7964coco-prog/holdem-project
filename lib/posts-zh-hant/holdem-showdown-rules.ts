...
- **亮牌**，如果你覺得自己贏
- **正面朝下蓋牌（Muck）**，如果你看出自己輸了——不需要秀出你的牌。但這只在沒人全下時成立：一旦有人全下，依 TDA 第 16 條，該底池牽涉到的每一手牌都必須攤開，誰都不能蓋牌
...
A. 要——如果你是河牌圈最後一個下注或加注的人，被跟到時你必須先亮。如果是你跟了別人的注，你可以在看到對方的牌、確認自己輸了之後，正面朝下蓋牌。例外是全下：依 TDA 第 16 條，跟注方同樣必須攤牌。而在錦標賽裡，只有手上還有牌、或已經攤牌的人才能要求看牌——不可剝奪的，僅限最後主動下注者那一手。
