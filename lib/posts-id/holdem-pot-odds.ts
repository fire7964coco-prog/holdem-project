...
Angka di balik draw Anda berasal dari [bagan peluang dan probabilitas poker](/id/blog/holdem-probability "thumb:/images/holdem-probability-hero.webp") — panduan ini adalah cara Anda mengubah angka itu menjadi call atau fold yang benar.
...
Angka "seberapa sering Anda perlu menang" itulah intinya. Mendapat 3:1 berarti call itu balik modal jika Anda menang setidaknya **25% dari waktu** atau lebih. Pot odds mengubah "haruskah saya call?" yang samar menjadi target pasti: *apakah saya menang cukup sering untuk mengalahkan harga ini?*
...
> Selalu sertakan call Anda sendiri dalam pot akhir. "Mendapat 3:1" dan "butuh 25%" menggambarkan spot yang *sama* — rasio adalah harganya, persentase adalah targetnya. Sebagian besar kesalahan pemula datang dari mencampur kedua konvensi ini; pilih persentase dan jangan kembali ke rasio.
...
**Q. Bagaimana cara menghitung ukuran pot di poker?**

A. Pot adalah semua chip yang sudah ada di tengah plus taruhan apa pun di street yang berjalan. Sebelum menghitung pot odds, jumlahkan pot awal dan taruhan lawan — lalu sertakan call Anda sendiri dalam pot *akhir*. Contoh: pot $100, taruhan $50, dan call $50 Anda menjadikan pot akhir $200.
...
A. Ukuran taruhan adalah sisi lain dari pot odds — taruhan Anda menentukan harga yang didapat lawan. Taruhan setengah pot memberi mereka 3:1 (butuh 25%), taruhan sebesar pot memberi 2:1 (butuh 33%), dan overbet menuntut lebih lagi. Bertaruhlah lebih besar di board yang sarat draw agar tangan draw tak mendapat harga call yang profit; kecilkan ukuran saat Anda ingin tangan yang lebih lemah call untuk value. Ukuran umum berkisar dari ⅓ pot sampai sebesar pot, tergantung board dan tujuan Anda.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-probability" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Setiap tangan, flop, dan draw — angka di balik harga</div>
  </a>
  ...
  <a href="/id/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Cash vs Turnamen</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Turnamen vs Cash Game</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kenapa implied odds lebih dalam di cash game</div>
  </a>
</div>
`.trim(),
};
