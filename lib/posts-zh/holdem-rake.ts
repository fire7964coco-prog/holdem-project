...
抽水，就是一间牌局一手牌都不打、却还能靠这场牌赚钱的方式。下面把它到底是什么、有哪几种收法、==g:你一个 session 实际交多少==的老实账算给你看，还有 rakeback 又是怎么把一部分抠回来的。正是这笔费用，决定了打赢小级别德扑到底有没有可能。
...
**抽水就是牌局为了主办这场现金局而抽走的佣金。**因为扑克是牌手对牌手打的——牌局本身从不下注——所以抽水就是这间房、这家赌场、这个 App 真正赚钱的方式。它是给荷官、牌桌、筹码、安保的一笔服务费，一点一点从底池里刮出来。
