...
A **limp** is when you enter a pot before the flop by just *calling* the big blind, instead of raising or folding. It sounds harmless, and occasionally it's fine — but ==g:open-limping as the first player in== is one of the most common and costly habits in the game. Below is exactly what limping is, why it usually loses money, the specific spots where it's actually correct (it's not *always* wrong), and how strong players turn your limp into their profit. Getting this one concept right is a bigger leap than most players realize, and it starts with understanding [position](/en/blog/holdem-position-play "thumb:/images/holdem-button-position-hero.webp").
