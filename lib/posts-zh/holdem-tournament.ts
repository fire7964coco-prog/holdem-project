...
**一句话总结：**在现金局里你的筹码就是真钱，你随时可以离场。而在 freezeout 锦标赛里，你的最大损失恰好就是那笔买入——有重入和增购的话就不止——但你争的是一个大得多的奖池里的一份。
...
这 13 个术语覆盖了你在桌上会听到的大部分内容。想要完整的 A 到 Z，看 [poker 术语表](/zh/blog/holdem-glossary)。
