...
**Karena uang hadiah tersebar di beberapa posisi dan sebagian sudah terkunci di bawah Anda — menggandakan chip tidak menggandakan equity hadiah Anda.** Misalkan tiga hadiah membayar $50 / $30 / $20. Begitu Anda masuk uang, Anda dijamin setidaknya $20 — jadi chip yang melindungi $20 itu berharga, sementara chip yang meraih juara pertama mengejar hadiah yang hanya bisa Anda menangkan sekali.
...
- **Heads-up untuk gelar**, tempat hanya dua hadiah tersisa, jadi uang yang masih diperebutkan bisa dinilai dengan chip EV.
...
A. Anda tak pernah benar-benar mematikannya, tapi efeknya cukup kecil untuk memakai chip EV sebagai aproksimasi di tahap awal dan tengah serta di permainan deep-stack dengan blind kecil — spot-spot tempat pay jump masih jauh. Di heads-up untuk gelar hanya dua hadiah tersisa, jadi selisih antara juara satu dan dua bisa dinilai dengan chip EV. Bahkan begitu, tetap periksa struktur payout dan sebaran stack.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-tournament" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Strategi Turnamen Texas Hold'em</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Pilar tempat ICM berada</div>
  </a>
  <a href="/id/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kenapa ICM tak pernah berlaku di cash</div>
  </a>
