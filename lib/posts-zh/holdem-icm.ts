...
export const POST: Post = {
  ...
  tldr: "ICM（独立筹码模型）用奖金结构和所有人的码量，把你锦标赛的筹码换算成它真正值多少奖金。因为冠军只有一个，翻倍你的筹码永远不会翻倍你的钱——所以 chip leader 的码量值得比它的筹码占比更少，而 short stack 值得更多。这个差距，正是你在 bubble 上会弃掉那些在现金局里轻松跟的牌的原因。",
  category: "tournament",
  date: "2026-07-09",
  updated: "2026-07-09",
