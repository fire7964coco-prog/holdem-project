...
export const POST: Post = {
  ...
  desc: "25만 원 이하 상금은 세금이 0원입니다. 국내 대회 4.4% 원천징수 구조와 과세최저한, 기타소득 300만 원 기준, WSOP 30% 원천징수와 외국납부세액공제를 법령·국세청·IRS 원문으로 정리했습니다.",
...
> **한 줄 답**
> 국내 대회 상금은 **소득세법 시행령 제87조**가 "다수가 순위 경쟁하는 대회 입상 상금"에 **필요경비 80%**를 인정하므로, 남은 20%에 22%(소득세 20% + 지방소득세 2%)를 매겨 **지급액 기준 실효 4.4%**가 원천징수되는 구조입니다. 건별 기타소득금액이 **5만 원 이하**(지급액 25만 원 이하)면 과세최저한으로 세금이 없습니다. 반면 **미국 WSOP 상금은 30%가 먼저 빠집니다** — IRS 간행물 515의 도박소득 면제국 목록에 **일본은 있고 한국은 없기 때문**입니다. 한국에서는 외국납부세액공제로 조정합니다.
...
- 미국 WSOP 포커 토너먼트는 비거주자 상금에 **30% 원천징수**가 적용되고, IRS 면제국 목록에 **한국은 없다**(일본은 있음)
...
:::note[출처: 국세청 — 기타소득 원천징수 방법(과세최저한 "매 건마다 5만원 이하", 필요경비 80% 대상 항목) · 소득세법 시행령 제87조. 2026-07-28 확인]:::
...
> 비거주 외국인에게 지급하는 도박 상금은 **§1441(a)·§1442(a)에 따라 30% 원천징수 대상**이며, **Form W-2G가 아니라 Forms 1042 및 1042-S로 보고**한다.
...
:::note[출처: IRS — Instructions for Forms W-2G and 5754(비거주 외국인 30% 원천징수·1042/1042-S 보고 조항). ⚠️ W-2G 기준액은 2026년부터 물가연동으로 매년 조정되며 게임 종류별로 다릅니다. 이 글은 한국 거주자에게 적용되는 1042-S 경로만 다루므로, 미국 거주자라면 원문을 직접 확인하세요. 2026-07-28 확인]:::
...
A. 대회 상금으로 필요경비 80%가 인정되면 기타소득금액은 200만 원입니다. 300만 원 이하라 분리과세 선택이 가능할 수 있습니다. 하지만 다른 소득과 개인 상황에 따라 신고가 유리하거나 필요할 수 있으므로 원천징수영수증을 들고 세무사에게 확인하는 것이 안전합니다.


**Q. WSOP에서 상금 받으면 미국에서 세금 30% 떼나요?**

A. 미국 포커 토너먼트에서 비거주 외국인이 일정 기준 이상의 상금을 받으면 30% 원천징수가 적용될 수 있습니다. 조세조약, ITIN, W-8BEN 여부에 따라 달라질 수 있고, 환급을 위해 Form 1040-NR 신고가 필요할 수 있습니다.
...
- **원천징수세율·필요경비 80% 대상·과세최저한 (본문 근거)**: [국세청 — 기타소득 원천징수 방법](https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?mi=6457&cntntsId=7893) · 기타소득 원천징수세율 20%(지방소득세 별도) / 필요경비 80% 대상에 **"다수가 순위 경쟁하는 대회에서 입상자가 받는 상금 및 부상"** 명시 / 과세최저한 **"그 밖의 기타소득금액이 매 건마다 5만원 이하인 경우"**
- **근거 조문**: **소득세법 시행령 제87조**(기타소득의 필요경비계산) — 법령 원문은 [법제처 국가법령정보센터](https://www.law.go.kr/법령/소득세법시행령)에서 조문을 직접 확인하세요. *(본문 서술은 위 국세청 안내에서 확인한 문구를 근거로 했으며, 조문 번호는 참조 편의를 위해 병기했습니다.)*

**미국 세금**

- **비거주 외국인 30% 원천징수 · 조세조약 면제국 목록 · 블랙잭·룰렛 등 면세 조항**: [IRS Publication 515 — Withholding of Tax on Nonresident Aliens and Foreign Entities](https://www.irs.gov/publications/p515)
