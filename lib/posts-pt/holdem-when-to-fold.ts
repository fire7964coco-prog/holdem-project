...
export const POST: Post = {
  ...
  imageAlt: "Um jogador de poker deslizando as cartas viradas para baixo em direção ao muck sob as luzes da mesa, escolhendo foldar em vez de pagar uma aposta",
...
- **Você está em posição inicial** — quase todos os outros decidem depois de você, e depois do flop só os blinds agem antes, então precisa de uma mão mais forte para entrar. K‑J offsuit é fold no under the gun e raise no button.
...
**Turn — a street da desistência.** Este é o fold mais importante do poker e o que os jogadores pulam. No turn, os ranges polarizam para "muito forte ou estourado", e os tamanhos das apostas incham. Seu float do flop que não melhorou, seu second pair que agora enfrenta um segundo barrel, seu projeto que acabou de errar com uma carta restante e um preço ruim — estes são turns para largar, não para se convencer de mais um call. Se você estava "dando float no flop pra blefar o turn" e o turn não te deu um motivo, desista.

**River — puro bluff-catching.** Você não tem mais projeto nenhum; a única pergunta é *"minha mão vence as mãos que eles apostariam por valor aqui?"* Se um jogador passivo dispara grande numa mesa assustadora, a resposta honesta costuma ser não. Folde as mãos que só vencem um blefe quando seu adversário raramente blefa. O que nos leva à matemática.
...
Agora coloque em prática. Digamos que você tem um flush draw — nove cartas o completam — com uma carta por vir. Nove outs entre as 46 cartas não vistas é ==9 ÷ 46 ≈ 19,6%==, ou cerca de **4 para 1 contra** fechar. (Atalho rápido: a [regra do 2 e 4](/pt/blog/holdem-outs "thumb:/images/holdem-outs-hero.webp") — outs × 2 ≈ sua porcentagem para uma carta, então 9 × 2 ≈ 18%.)
...
| **Hero-call pra "mantê-lo honesto"** | Você pega um blefe, paga dez apostas de valor | Reserve para jogadores que realmente blefam |
...
A. Folde top pair quando seu kicker é fraco e você enfrenta apostas grandes no turn e no river, quando a mesa fecha quatro pra um flush ou uma sequência óbvia e o adversário mostra agressão de verdade nela, ou quando um jogador passivo dá raise. Top pair vence blefes e pares piores, mas contra uma linha value-heavy costuma estar atrás — e pagar três streets pra pegar um blefe perde dinheiro.

**Q. O que é a falácia do sunk cost no poker?**
...
**Q. Dá pra foldar demais no poker?**
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/holdem-strategy" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Onde o fold se encaixa num jogo vencedor</div>
  </a>
  <a href="/pt/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">O limite por trás de todo fold</div>
  </a>
  <a href="/pt/blog/holdem-3bet" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Quando foldar para um re-raise</div>
  </a>
  <a href="/pt/blog/holdem-continuation-bet" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Estratégia</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">A continuation bet</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Quando foldar para uma c-bet</div>
  </a>
</div>
`.trim(),
};
