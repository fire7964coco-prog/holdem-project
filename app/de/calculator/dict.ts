...
export const CALC_DICT_DE: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "Die große Zahl ist der exakte Wert",
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "Pocket Pair mit gutem Set-Potenzial", action: "Spät raisen; früh einen Raise-Call erwägen – niemals open-limpen" },
      ...
      "77": { desc: "Set-Mining-Hand, auf Overcards achten", action: "Spät raisen; früh einen Raise callen – niemals open-limpen" },
      A9s: { desc: "Suited Ace mit Flush-Potenzial", action: "Spät raisen" },
      "66": { desc: "Set-Mining – braucht Implied Odds", action: "Einen Raise callen, wenn beide ~15× den Call hinter sich haben; spät raisen" },
      "55": { desc: "Ohne Set wenig Wert", action: "Spät einen einzelnen Raise callen; spät auch first-in raisen" },
      ...
      "44": { desc: "Ohne Set fast wertlos", action: "Einen Raise nur callen, wenn beide ~15× den Call hinter sich haben" },
      "33": { desc: "Muss set-minen; spekulativ", action: "Nur Multiway-Pots mit tiefen Stacks" },
      "22": { desc: "Niedrigstes Pocket Pair", action: "Nur Multiway-Pots mit tiefen Stacks" },
