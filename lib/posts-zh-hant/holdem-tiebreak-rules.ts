...
> **快速解答**
> 牌桌上判錯平手的人，多半不是不知道比法，而是==數錯了哪五張真的算數==。先把兩邊的最強五張各自定下來，再開始比大小 —— 順序顛倒過來，就會為一張根本沒上場的牌吵半天。
...
> **快速解答**
> 平手一律照固定順序比：先比牌型，再比組成牌型的牌，然後從最大到最小逐張比踢腳牌——如果五張牌還是全一樣，就平分底池。三道檢查每次攤牌都一樣，第一個不一樣的地方就結束。
