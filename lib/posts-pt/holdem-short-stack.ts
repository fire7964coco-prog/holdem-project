...
**Quando você é o primeiro jogador a entrar no pote e está curto, sua decisão é shove ou fold — e quão amplo você dá shove depende do tamanho do seu stack e, na mesma medida, da sua posição.** Quanto mais tarde a sua posição, menos jogadores restam atrás de você para acordar com uma mão grande — então sobe a chance de todos foldarem, e com ela a ==fold equity== que faz o shove pagar. É por isso que ==seu range de shove amplia dramaticamente em direção ao button==.
