...
export const POST: Post = {
  ...
  tldr: "踢腳牌（Kicker，亦稱旁牌）是你最強五張裡、不屬於成牌本身的那張最大牌——當兩位玩家湊成同一種牌型時，用它來決定誰贏。高牌用 4 張踢腳、一對 3 張、兩對 1 張、三條 2 張；順子、同花、葫蘆、同花順則完全沒有踢腳。這就是為什麼公牌成 A 時，AK 會贏 AQ。",
  ...
  content: `
那把讓我終於搞懂踢腳牌是什麼的牌，賠掉了我整整一個買入。我拿的是 ==b:A♠ 9♣==，公牌配成了我的 A，我心想頂對穩了，直接梭下去。他一翻 ==b:A♥ K♦== —— 一樣是一對 A，但他的 K 踢腳牌壓過了我，底池就這樣滑到他那邊。我輸的不是更大的*牌型*，而是輸給了一張更大的 ==旁牌==。這張旁牌就是踢腳牌，它決定的底池比多數新手想像的還多。
...
> **快速解答**
> 踢腳牌是你最強五張牌裡、不屬於成牌組合的那張最大牌——當兩位玩家湊成同一種牌型時，就靠它決定贏家。它也叫「旁牌」，只有在牌型完全相同時才會登場。

撲克永遠是五張牌的遊戲（德州是七張取五），所以一旦你的對子或三條定下來，剩下的空位就由踢腳牌填滿。
...
> **快速解答**
> 只有那些用不到五張牌就湊成的牌型才有踢腳——凡是自己就填滿五張的，一張踢腳都沒有。所以順子、同花、葫蘆、同花順從頭到尾都不比踢腳，而高牌、一對、兩對、三條、四條才會比到旁牌。

這是新手最容易誤會的一條：踢腳有沒有登場，看的是牌型本身用掉幾張，跟你手氣好不好無關。這張表是競爭對手都藏在一堆段落裡的。這裡一次看清楚：
...
背後的邏輯就是純算術：**組合牌 + 踢腳牌永遠等於五張。** 一對用掉 2 張，所以剩下 3 張踢腳來補。順子、同花、葫蘆、同花順本身就用滿五張，沒有多的牌可以拿來當踢腳 —— 兩副順子或兩副葫蘆，是靠它們**內部**的點數來分高下，不是靠旁牌。
...
> **快速解答**
> 高牌用四張踢腳、一對用三張、三條用兩張、兩對和四條各只用一張。知道張數，你就清楚一場破平手最深能比到哪裡——一對可以一路比到第三張旁牌，兩對卻只有一張可以吵。
...
> **快速解答**
> 這是踢腳最標準的樣子：公牌配成一張 A，兩邊都是一對 A，牌型一模一樣，於是比第一張旁牌——K 壓過 Q，底池歸 AK。沒有人湊成更大的牌型，勝負完全由踢腳決定。
...
> **快速解答**
> 如果你的底牌無法讓五張公牌已經做成的牌更好，那你就是在「用公牌打（playing the board）」——這時候你的踢腳就不再決定任何事，因為你的兩張底牌一張都沒進到最強五張裡。

但「我在打公牌」不等於「大家都在打公牌」：只要有任何一位對手能用底牌把公牌做得更大，底池就是他的。只有在==沒有人==改善得了公牌時，還在牌裡的每個人才是用同樣的五張牌，底池才平分。
...
你們誰都湊不出比 A 更高的，所以雙方都「用公牌打」，==g:平分底池==——但前提是你把底牌翻開；把牌蓋掉就一毛都拿不到，就算在這種局面也一樣（TDA 2024 年版第 19 條）。順子沒有踢腳，所以那些底牌是死重。當你聽到「the board plays（公牌自己成牌）」，講的就是這個 —— 這也是唯一一個看起來很強的底牌，實際上一文不值的場合。（關於辨識這類公牌走勢，更多內容看[如何讀公牌](/zh-hant/blog/holdem-reading-the-board)。）
...
> **快速解答**
> 當一手牌跟一手更強的牌共用一張牌、而且幾乎每次連上時都會輸掉踢腳戰，就叫這手牌「被壓制（dominated）」了——最經典的陷阱就是像 A9 這種弱 A 對上 AK。

到了這裡，踢腳就不再是冷知識，而是開始讓你賠錢。
...
> **快速解答**
> 有——四條有一張踢腳，但在德州撲克裡它幾乎從不決定勝負：那要兩位玩家湊到同一副四條，也就是四張全攤在公牌上，這種牌面很少見。

這是多數教學搞砸的例外，它們把四條跟「用滿五張、沒有踢腳的牌型」混為一談。

算術很清楚：四張牌組成四條，一張牌是踢腳。它只有在兩位玩家湊成**同樣**四條時才有用 —— 而這在德州撲克裡需要四張同點數全攤在公牌上（因為每個點數就只有四張）。如果公牌是 ==b:5♠ 5♥ 5♦ 5♣ K♦==，每個人都有四條 5，第五張就是踢腳：手上有一張 A 的玩家打 ==g:5-5-5-5-A==，贏過拿公牌 ==5-5-5-5-K== 的玩家。少見，但真的會發生 —— 而把這種邊界情況講對，正是一份值得信賴的教學跟一份含糊帶過的教學之間的差別。
...
A. 有。三條用兩張踢腳，所以當兩位玩家湊成同樣的三條時，接下來最大的兩張牌決定勝負 —— 公共牌 K♣ K♥ 7♦ 5♣ 2♠ 上，拿 K♠ A♠ 的玩家打出 K-K-K-A-7，贏過拿 K♦ Q♦ 的 K-K-K-Q-7，因為 A 壓過 Q。（用口袋對子做成的真正暗三條（Set）很少打平，因為那個對子只有一個人握得到。）

**Q. 兩對有踢腳牌嗎？**

A. 有 —— 兩對用一張踢腳。如果你拿 K♥ Q♦、對手拿 J♠ Q♥，公牌是 Q♣ 7♠ 7♦ 4♥ 2♣，你們都是 Q 帶 7，但你的 K 踢腳贏他的 J（Q-Q-7-7-K 贏 Q-Q-7-7-J）。踢腳只有在雙方握有一模一樣的兩對時才登場。

**Q. 四條有踢腳牌嗎？**

A. 有，四條有一張踢腳，但在德州撲克裡很少用到。它只有在兩位玩家湊成同一組四條時才決定勝負 —— 而那需要四張同點數全攤在公牌上 —— 這時最大的第五張贏。
...
A. 看牌型：高牌用四張踢腳（五張全部依序比）、一對用三張、三條用兩張、兩對和四條各用一張。順子、同花、葫蘆、同花順沒有踢腳，因為它們已經填滿五張。
...
A. 用公牌打指五張公牌就是你的最強牌、你的底牌無法讓它更好。只要沒有人能用底牌把公牌做得更大，大家就都用同樣的五張牌，底池平分。你的旁牌不再決定任何事，因為你的底牌沒有一張進得了你打的那五張——這手牌裡每一張牌都是共用的。

**Q. 兩人對子一樣大時，踢腳牌真的那麼重要嗎？**
...
2. **組合牌 ＋ 踢腳 ＝ 五張。** 高牌有 4 張踢腳、一對 3 張、三條 2 張、兩對和四條 1 張；順子、同花、葫蘆、同花順都沒有。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/zh-hant/blog/holdem-hand-rankings" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">踢腳牌坐落在其下的完整順序</div>
  </a>
  <a href="/zh-hant/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">平手比法</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">牌型一樣誰贏？平手比法</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">每種牌型完整的破平手順序</div>
  </a>
  <a href="/zh-hant/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">為什麼弱踢腳的 A 該蓋掉</div>
  </a>
  <a href="/zh-hant/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">位置怎麼放大你的踢腳優勢</div>
  </a>
</div>
`.trim(),
};
