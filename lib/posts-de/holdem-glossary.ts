...
export const POST: Post = {
  ...
  seoTitle: "Von den Nuts bis zum Fish – das Poker-Glossar",
  desc: "Jeder Poker-Begriff, den du am Tisch hörst, einfach erklärt und nach Situation gruppiert: Setzaktionen, Positionen, Hände, Slang und verwechselte Begriffe.",
  tldr: "Das ist ein Poker-Glossar in einfachem Deutsch mit den Begriffen, die in einem Texas-Hold'em-Spiel wirklich vorkommen, gruppiert danach, wie du ihnen begegnest – Setzaktionen, Positionen, Hände und Board, Spielertypen, Geld und Tischsituationen. Beginn mit den 'am häufigsten verwechselten' Begriffen unten (Check vs. Call, Set vs. Trips, Cooler vs. Bad Beat), dann stöber nach Kategorie. Begriffe mit einem tieferen Guide verlinken direkt darauf.",
  category: "glossary",
  date: "2026-07-05",
  updated: "2026-08-10",
  ...
  tags: ["poker begriffe", "poker glossar", "texas holdem begriffe", "poker slang", "poker terminologie", "poker vokabular", "poker wörter", "was bedeutet das im poker"],
  content: `
...
:::stripe
6 | Kategorien, gruppiert danach, wie du ihnen begegnest
80+ | Begriffe in einfachem Deutsch erklärt
...
![Eine visuelle Karte der sechs Poker-Begriffskategorien in diesem Glossar – Setzaktionen, Positionen, Hände, Spielertypen, Geld und Situationen](/images/holdem-glossary-categories.webp "Die sechs Gruppen, in die dieses Glossar geordnet ist – stöber nach der Situation, in der du bist, nicht bloß alphabetisch")

## Setzaktionen

Alles, was du an deinem Zug physisch tun kannst. Wenn du ganz neu bist, beginn mit der [Reihenfolge der Setzaktionen](/de/blog/holdem-betting-actions "thumb:/images/holdem-betting-actions-hero.webp").
...
Wo du sitzt, entscheidet, wann du handelst – und als Letzter zu handeln ist ein dauerhafter Vorteil. Wie du sie wirklich nutzt, zeigt das [Positionsspiel](/de/blog/holdem-position-play).
...
Die Karten selbst und was du daraus machst. Neu im Ablauf der Streets? Beginn mit der [Reihenfolge des Spiels](/de/blog/holdem-game-order).
...
Der Zoo an Spitznamen für die Leute am anderen Ende des Filzes. Die vollständige Aufschlüsselung findest du im [Fish-Guide](/de/blog/holdem-fish).
...
Chips, Stakes und die zwei Formate. Die große Gabelung ist [Cash Game vs. Turnier](/de/blog/holdem-tournament-vs-cash-game "thumb:/images/tournament-table-action.webp").
