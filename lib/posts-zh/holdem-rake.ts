...
A. 影响很大——最重的是低级别，那里封顶不随级别一起降下来。短台还多了一个跟封顶无关的因素：六人桌或单挑一小时打的手数多得多，交盲注也频繁得多，所以被抽水的次数本身就翻上去了。抽水能把一个小赢家变成输家：同一个 +8 bb/100 的牌手，仅仅换到一个抽水封顶更高的房，就可能变成小幅亏损。永远要在抽完水之后再来量你的赢率。
