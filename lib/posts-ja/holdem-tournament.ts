...
ディープスタックのトーナメントは、ブラインドに対してはるかに多いチップからスタートします——通常200ビッグブラインド以上——そしてたいていブラインドレベルも長めに設定されています。チップが多くクロックがゆっくりということは、ポストフロップのプレーが増え、ミスから立て直す余地も増え、そして1日が長くなるということです。
