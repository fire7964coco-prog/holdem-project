...
| 순위 | 할 일 | 왜 |
|---:|---|---|
| **1** | 다국어 글에 브레드크럼 소급 | 8/4 6종 중 한국어에만 넣었다(`intl-blog-post-client`) |
| **2** | 다국어 툴 페이지에 허브 셸 소급 | 지금은 한국어 13개 라우트만 적용됨 |
| 3 | `/holdem-practice` h1 0개 | 기존 결함. 셸 통일 검증 중 발견 |
| 4 | `tournaments-client.tsx:601` 하드코딩 | "2026년 7월 28일 기준 … 8월 3~5일"이 낡았다 |
| 5 | 데스크톱 네비 잔여 (handoff 0-★ B항목) | `blog-top-bar.tsx` 좌우 버튼이 아직 같은 href |
