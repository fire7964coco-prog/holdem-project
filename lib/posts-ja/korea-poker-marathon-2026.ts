...
**春川 → パラダイスシティのルート:** レース後、特急でソウルへ(約70分) → ソウル駅または弘大(ホンデ)からAREX → ターミナル1からパラダイスシティのシャトル。合計約3時間。レース当日の日曜の夕方でも十分こなせます。
...
A. はい——1週間の間隔です。春川はソウルから電車で90分。日曜に春川を走り、月〜土でリカバリーして、翌日曜にJTBCを走る。韓国のランナーには、こうして連続週で走る人が大勢います。ただしリカバリーの時間は多めに見ておくこと。春川のコースには坂があります。
