...
### ▶ 0-F. ★다음 세션 1순위 — `holdem-hand-rankings` 경화 (진단 완료, 편집만 하면 됨)

> 2026-08-02에 **진단까지 끝냈다.** 아래를 그대로 실행하면 된다. 다시 조사하지 말 것.
> 우선순위 근거: `npm run board` (GA4 랜딩 참여율 × GSC 노출·순위를 한 표로)
