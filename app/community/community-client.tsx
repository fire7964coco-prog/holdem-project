...
const KO_PAGE_TEASERS: FeedPost[] = [
  ...
  // ★2026-08-28 신설. 홈은 「홀덤사이트」(28일 2,970노출)·「온라인 홀덤사이트」(6,654노출)를 받는데
  //   링크 370개 중 /ranking이 0개였고 본문에 «홀덤사이트»가 0회였다(라이브 실측). 그 쿼리의 답은
  //   /ranking에 있는데 구글이 홈을 고르고 있었고 CTR이 홈 0.4% vs /ranking 1.5%로 갈렸다.
  //   → 홈에서 /ranking으로 가는 유일한 경로이자, 앵커에 「홀덤사이트」를 담는 자리다. 지우지 마라.
  //   ⚠ 문구는 «추천/TOP5»가 아니라 «고르는 법»이다 — 이 페이지 스스로 "정보 제공 목적, 순위·보증 아님"을
  //     JSON-LD에 명시한다(app/ranking/page.tsx). 앵커가 보증으로 읽히면 그 선언과 어긋난다.
  { id: "page:ranking", type: "admin", language: "ko", title: "홀덤사이트 안전하게 고르는 법", content: "라이센스·자금 분리·출금 실적 — 온라인 홀덤사이트를 고르기 전 확인할 기준과 먹튀 경고 신호를 정보 목적으로 정리했습니다.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-05T12:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/ranking", pageIcon: "🛡️" },
  { id: "page:hand-rankings", type: "admin", language: "ko", title: "홀덤 족보 완전 정리", content: "로열플러시부터 하이카드까지 — 10가지 핸드 랭킹을 한눈에 확인하세요.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-05T00:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/blog/holdem-hand-rankings", pageIcon: "🃏" },
