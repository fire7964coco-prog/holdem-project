...
export const POST: Post = {
  ...
  tldr: "টেক্সাস হোল্ডেমে 5টি betting action আছে: check (ফ্রি-তে পাস), bet (রাউন্ড শুরু), call (bet সমান করা), raise (বাড়ানো — minimum raise আগের bet বা raise-এর সমান), আর fold। check শুধু তখনই করা যায় যখন আপনার সামনে কোনো চালু bet নেই — preflop-এ সেটা কেবল big blind-এর ক্ষেত্রে ঘটে।",
  category: "rules",
  date: "2026-06-14",
  updated: "2026-07-13",
...
| Check | শুধু তখন, যখন আপনার সামনে কোনো চালু bet নেই (preflop: কেবল big blind হিসেবে) | ফ্রি — chips না দিয়ে পাস করেন |
...
সবচেয়ে গুরুত্বপূর্ণ যে নিয়মটা নতুনরা মিস করে: ==r:আপনার সামনে চালু bet থাকলে আপনি আর check করতে পারবেন না==। pot-এ এমন chips থাকামাত্র যা আপনি এখনো মেলাননি, আপনার অপশন সংকুচিত হয়ে fold, call বা raise-এ নেমে আসে।
...
| | Check | Call |
|-|-------|------|
| কখন থাকে | আপনার সামনে চালু bet নেই (preflop: কেবল big blind হিসেবে) | আপনার আগে কেউ bet করেছে |
...
হ্যাঁ — যখনই action আপনার ওপর থাকে আপনি fold করতে পারেন, কিছু bet করার আগেও, আর সেই fold বাধ্যতামূলক। তবে একেবারে নিখরচায় নয়: টুর্নামেন্টে, সামনে কোনো bet না থাকা অবস্থায় fold করাকে ==WSOP নিয়ম ৮৪== "non-standard fold" ধরে এবং তাতে সতর্কবার্তা আসতে পারে। আর এই ফাঁদটাও খেয়াল রাখুন: **যখন check ফ্রি-তে করা যেত তখন fold করা মানে বিনা কারণে একটা হ্যান্ড ফেলে দেওয়া**। কেউ bet না করলে শুধু check করুন।
...
1. **chips নাড়ার আগে "raise" বলুন।** "call" বলে তারপর আরও chips সামনে ঠেলে দেওয়া? আপনার ঘোষণাটাই তখন বাধ্যতামূলক হয়ে গেছে (==নিয়ম 90.d==) — বাড়তি অংশ গোনা হবে না। আসল ==string bet== অন্য জিনিস: আগে "raise" না বলে কয়েকটা মুভমেন্টে chips ঠেলে দেওয়া (==নিয়ম 103==)।
...
**Fixed-Limit** গেমে প্রতিটি রাউন্ডেই ক্যাপ থাকে ("capped" pot)। WSOP-এর টুর্নামেন্ট নিয়ম ক্যাপ ধরে ==এক bet আর চার raise==-এ (নিয়ম 100.b) — আর ব্যতিক্রমটা বেশিরভাগ মানুষের ধারণার ঠিক উল্টো: ==r:হ্যান্ডে মাত্র দুজন বাকি থাকলেও ক্যাপ বহাল থাকে==। ক্যাপ ওঠে কেবল যখন **গোটা টুর্নামেন্টেই** দুজন বাকি। cash game-এ house rules চলে, তাই ডিলারকে জিজ্ঞেস করে নিন।
...
flop-এ প্রথম action আপনার, কেউ bet করেনি, আর একজন নতুন খেলোয়াড় **চুপচাপ** chips ঠেলে দেয়, "call করতে"। এখানে call করার মতো কিছুই নেই: ==WSOP নিয়ম 90.a== অনুযায়ী bet হয় ঘোষণা দিয়ে *অথবা* chips ঠেলে দিয়ে — সে অনিচ্ছায় bet করেই ফেলল। যদি সে "call" *বলত*, তাহলে ==নিয়ম 90.b.1== অনুযায়ী সেটা হতো নিছক check। street খোলা না থাকলে check করুন আর কার্ড ফ্রি-তে দেখুন।
...
$10-এর bet-এর সামনে খেলোয়াড় চুপচাপ একটা $100 chip ফেলে দেয়, বদলে change *আর* একটা raise-এর আশায়। ==one-chip নিয়ম== WSOP-এর নিয়মে হুবহু এভাবেই আছে (==নিয়ম ৯৭==): না বলে ফেলা একটা বড় chip শুধুই call। raise করতে হলে "raise" শব্দটা **chip টেবিলে ঠেকার আগেই** বেরোতে হবে।
...
A. No-Limit-এ raise-এর সংখ্যায় কোনো cap নেই — যতক্ষণ প্রতিটা raise minimum increment-এ উতরায়, ততক্ষণ কেউ all-in না হওয়া পর্যন্ত re-raise চলতে পারে। Fixed-Limit-এ WSOP-এর টুর্নামেন্ট নিয়ম রাউন্ডের ক্যাপ ধরে এক bet আর চার raise-এ (নিয়ম 100.b), আর হ্যান্ডে দুজন বাকি থাকলেও সেই ক্যাপ বহাল থাকে।
