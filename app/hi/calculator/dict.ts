...
export const CALC_DICT_HI: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      A10s: { desc: "सबसे अच्छे suited aces में से एक", action: "Mid/late से raise; UTG से या तो raise या fold — limp कभी नहीं" },
      ...
      A3s: { desc: "Wheel card + nut flush draw, A2s से एक पायदान ऊपर", action: "सिर्फ़ LP" },
      A2s: { desc: "Wheel + nut flush, पर कमज़ोर", action: "सिर्फ़ LP" },
      ...
      K10o: { desc: "K-10 offsuit, कमज़ोर", action: "आपसे पहले सब fold करें तो CO/BTN से open-raise करें" },
      Q10o: { desc: "कम connectivity वाला offsuit", action: "सिर्फ़ BTN" },
      J10o: { desc: "ठीक-ठाक offsuit, पर असुरक्षित", action: "सिर्फ़ BTN" },
