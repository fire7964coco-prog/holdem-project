...
:::tip[如果公共牌通杀而有人在河牌下注，**反射性弃牌才是错的**。如果没有任何牌能盖过公共牌，平分就是确定的，跟注仍然会把底池里原有筹码中属于你的那份拿回来（单挑时是一半）——弃牌等于白白把这一份送人。如果公共牌还可能被盖过，就用频率来算：单挑时，面对满池下注，需要对手同样只有公共牌的概率达到约三分之二；面对半池下注，约一半就够（若还有三人以上在池里，你平分到的份额变小，门槛会更高）。这道门槛其实很高：面对满池下注，只要他握着真牌的比例**超过三分之一**，弃牌就是对的——而在公共牌仍有可能被盖过的河牌上，那才是常态。]:::
