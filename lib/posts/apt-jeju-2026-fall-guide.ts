...
export const POST: Post = {
  ...
  desc: "APT 제주 2026 가을(9월 25일~10월 4일, 제주 신화월드 LES A 카지노)에 참가하는 전 과정을 단계별로 정리했습니다. Natural8 계정 생성 → 위성 신청 → 현장 체크인까지 순서대로 설명합니다.",
  tldr: "APT 제주 2026 가을은 9/25~10/4 제주 신화월드 LES A 카지노에서 열립니다. Natural8에서 $3.50 위성으로 시트 도전 가능. 단, LES A 카지노는 외국인 전용 — 한국 국적자 입장 불가.",
  category: "토너먼트",
  date: "2026-06-17",
  updated: "2026-07-09",
  readTime: "12분",
...
<div style="font-size:13px;font-weight:700;color:#ff9600;margin-bottom:8px">📋 세부 이벤트 일정·바이인 미발표 (2026년 7월 기준)</div>
<div style="font-size:13px;color:var(--muted-foreground);line-height:1.7">APT 공식 발표로 <strong>대회 기간은 9월 25일~10월 4일로 확정</strong>됐습니다. 다만 메인이벤트 바이인과 세부 이벤트 일정은 아직 발표 전입니다. 아래 예상치는 올해 1월~2월에 열린 <strong>APT 제주 클래식 2026</strong>을 기준으로 작성했으며, 공식 발표 후 즉시 업데이트됩니다.<br/>→ 최신 일정 확인: <a href="https://www.theasianpokertour.com" target="_blank" rel="noopener" style="color:var(--primary)">theasianpokertour.com</a></div>
</div>
...
APT 인천은 8월 7~16일, APT 제주 가을은 9월 25일~10월 4일. 약 6주 간격으로 두 대회 모두 참가할 수 있습니다. 단, 두 대회는 장소가 다릅니다.

| | APT 인천 2026 | APT 제주 2026 가을 |
|--|-------------|-----------------|
| 카지노 | 파라다이스 시티 (인천 영종도) | LES A 카지노 (제주 신화월드) |
| 날짜 | 8월 7~16일 | 9월 25일~10월 4일 |
...
A. 2026년 7월 현재 세부 일정·바이인은 아직 발표 전입니다(대회 기간 9/25~10/4는 공식 확정). APT 제주 클래식 2026(1~2월) 메인이벤트 기준 **약 230만원(KRW 2.3M, ~$1,600)**이었으며, 가을 대회도 유사한 수준으로 예상됩니다. 공식 발표 후 즉시 업데이트합니다. → 공식 확인: [theasianpokertour.com](https://www.theasianpokertour.com)

**Q. APT 인천(8월)과 APT 제주(9월) 둘 다 참가할 수 있나요?**

A. 가능합니다. APT 인천(8/7~16)과 APT 제주(9/25~10/4)는 약 6주 간격입니다. APT 인천은 인천 영종도 파라다이스 시티, APT 제주는 제주 신화월드로 장소가 다릅니다. 자세한 내용은 [APT 인천 2026 가이드](/blog/apt-incheon-2026-guide)를 참고하세요.
