...
export const POST: Post = {
  ...
  tldr: "straddle 就是发牌前主动补的一个盲注——通常是大盲的 2 倍。它替抓的人买下翻前最后行动权和加注权，把赌注翻倍。绝大多数情况下这是一个 -EV 的打法，而且几乎总是只限现金局、按房规允许时才能抓。",
  category: "glossary",
  date: "2026-07-04",
  updated: "2026-09-09",
  ...
  content: `
第一次在我那张 $1/$2 的桌子上有人抓 straddle 时，我完全不明白枪口位那哥们儿为什么牌还没来就先扔出 $4——也不懂荷官怎么突然把行动的起点往后挪了一个座位。我管它叫「有钱人下的注」叫了差不多一个月，才搞清楚它到底干了什么：一次 straddle ==把赌注翻倍，还替一个人买下了最后说话的权利==，这一切都发生在谁都还没看牌之前。
...
> **快速回答**
> 对几乎所有人来说不赚，是 -EV：你在看牌之前就盲投了钱，位置优势被压缩（求解器在被 straddle 的池里反而开更少的牌），抽水也跟着变大。站得住脚的只有松-被动桌、人人都抓的局，或者纯为了乐子。
...
A. 对大多数玩家来说，不赚——这是个 -EV 的打法。你盲投了钱，你缩小了自己的位置优势（求解器在有 straddle 的底池里开的牌*更少*，不是更多），你还做大了抽水。它只有在松-被动的桌子上、在人人都已经抓的局里、或者纯为了乐子时才站得住脚——永远不能当作赚钱的手段。
