...
export const POST: Post = {
  ...
  tldr: "キャッシュゲームではチップが現金価値を持ち、ブラインドは固定で、いつでも席を立てます。トーナメントではチップは生き残るための持ち点で、ブラインドが上昇し、賞金は最終順位で決まります。勝ち方も別物で、キャッシュはbb/100や時給で測る積み上げ型、トーナメントはROIで測るスパイク型。初心者は基礎が速く身につくキャッシュゲームから始めるのが無難です。",
  category: "tournament",
  date: "2026-06-11",
  updated: "2026-08-26",
...
この記事では、==トーナメントとキャッシュゲームの違い==を初心者が本当に知りたい順に整理します。キャッシュゲームとは何か・どう回るか、チップの価値、ブラインド構造、戦略の変化、どちらが難しいか、どちらが稼げるか、バンクロール、ICM、いつ席を立つべきか、そして最初にどちらを選ぶべきかまで。トーナメントそのものの仕組みがまだ曖昧なら、先に[ポーカートーナメントの仕組み——バイイン・ブラインドレベル・Day1の流れ](/ja/blog/holdem-tournament)を読んでおくとスムーズです。この記事は構造の解説を繰り返すのではなく、2つの形式を「比較」します。
...
**ハウスはレイクを取ります。** ほとんどのキャッシュゲームでは、ハウスが各ポットから少額を抜く（または時間制のシート料を取る）仕組みです。これがどのステークスなら勝ち越せるかを静かに左右するので、ゲームを選ぶ前に[レイクの仕組み](/ja/blog/holdem-rake)を理解しておく価値があります。
...
> **先に結論**
> トーナメントのチップに現金価値がないのは、賞金が「持っているチップの量」ではなく「最終順位」で払われるからです。チップを倍にしても賞金の期待値は倍にならず、逆にゼロになれば期待値ごと消える。この非対称性があるため、キャッシュなら正しいコールがトーナメントでは間違いになる場面が生まれます。
...
> **先に結論**
> キャッシュゲームのブラインドは何時間打っても同じで、待つことに費用がかかりません。トーナメントはスケジュールどおりにブラインドが上がるので、1ハンドも負けなくてもスタックのBB換算は減り続け、やがて待つこと自体が損になります。この「時間の圧力」が、攻める頻度と取るリスクの量を決めます。
...
海外のカジノならほぼどこでも共通するハウスルールが2つあります:プレーを続けながらテーブルのチップをポケットにしまうこと(「ラットホーリング」)は禁止。そして、いったん席を立って同じゲームにすぐ戻る場合は、たいてい==退席時の額以上==で買い直さなければなりません。
...
> **先に結論**
> 座る前に聞くべきことは一つに集約されます——「これはどの形式で、構造はどうなっているか」。表の五つの質問は、チップの価値・スタック圧・総コスト・賞金圏の判断・時間の拘束という、この記事で扱った違いをそのまま現場で確かめるためのものです。答えられないうちはバイインしないでください。
...
**Q. キャッシュゲームとトーナメントでは、何BBから始めるのがいいですか？**

A. キャッシュゲームはテーブルの==上限までバイイン==するのが基本——海外のカジノの$1/$2なら上限はたいてい$200〜$300、つまり100〜150BBです(日本のアミューズメント店はチップを換金せず時間制の料金なので、この$表記は当てはまりません)。ディープスタックほどポストフロップの技術が活き、勝っているときに1スタック丸ごと取れます。トーナメントは深さを主催者が決め、たいてい開始100〜300BBほど。ただしブラインドが上がるので、放っておいても25BB→10BB→プッシュ/フォールド圏へと縮んでいきます。要するに、==キャッシュは深くバイインし、トーナメントは自分のBB数が減っていくのを見ながら調整する==、ということです。

**Q. ホームゲームのキャッシュには何枚のチップが要りますか？**

A. 標準的な300枚セットで余裕があるのは6人までです。7〜8人で全部配り切ると300 ÷ 8 = 40枚を切りますが、キャッシュゲームでは配り切るべきではありません:バイインを下限〜上限の幅で決め、3〜4種類のデノミ（額面）を使い、大半を最小額面のチップにして、残りは買い足し(追加バイイン)用にケースに残しておきます。だからこそ7〜8人には500枚セットのほうが向いています。正確な枚数より、最初のハンドの前に「どの色が現金でいくらか」を全員が合意しておくことのほうが大事です。
...
**Q. ポーカーのトーナメント賞金に税金はかかりますか？**

A. 日本では、ポーカーの賞金は原則として==一時所得==として課税対象になり得ます。一時所得は「(その賞金 − その賞金を得るために直接要した金額 − 特別控除50万円)× 1/2」で計算します(所得税法34条、22条2項2号)。ここで間違えやすいのが経費の範囲で、差し引けるのは「その収入を生じた行為をするため…直接要した金額に限る」(34条2項)ため、==入賞しなかった他の大会のバイインは含められません==。年間のバイイン総額を引いて計算すると、申告額を実際より小さく見積もることになります。==年間の利益が特別控除50万円以内なら確定申告は不要==です。会社員など給与所得者には、給与・退職以外の所得金額が年20万円以下なら申告不要という緩和規定があり(121条1項1号)、一時所得はいま見たとおり1/2を算入して判定します。たとえば利益70万円なら (70 − 50) ÷ 2 = 10万円で20万円以下なので、この規定では申告不要です。継続的・反復的に稼いでいる場合は雑所得と判定されることもあります。海外トーナメントの賞金も、日本の居住者なら申告の対象です。制度は状況で変わり得るので、大きな入賞の前に税務署か税理士に確認するのが安全——これは一般的な情報であり、税務アドバイスではありません。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/ja/blog/holdem-tournament" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">バイイン・ブラインドレベル・形式・Day1チェックリスト</div>
  </a>
  <a href="/ja/blog/holdem-game-order" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">ゲームの流れ</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">テキサスホールデムの進行順</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">プリフロップからショーダウンまで、ハンドの全流れ</div>
  </a>
  <a href="/ja/blog/holdem-hand-rankings" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">ポーカー役の強さ——最強から最弱まで</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">全10役を確率・例・ボードの読み解きつきで</div>
  </a>
  <a href="/ja/blog/holdem-blind-meaning" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">SB・BB・ブラインドスチール・オプションを全解説</div>
  </a>
</div>
`.trim(),
};
