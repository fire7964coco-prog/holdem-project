...
**cooler** 就是这样一种局面：你凑成一手极强的牌、输掉一个大底池，而==弃牌从来就不是一个真正的选项==——对手那手牌就是更大。下面讲清楚它到底是什么意思、cooler 和 **bad beat** 之间那个关键区别（大多数人都搞混）、经典的 cooler 对撞组合，以及没人爱听的诚实那一面：什么时候“这就是个 cooler 而已”其实只是给一个失误找的体面借口。它是整本 [扑克术语表](/zh/blog/holdem-glossary "thumb:/images/holdem-glossary-hero.webp") 里被误用得最多的词之一，所以我们先把“什么才算 cooler”钉死。
...
> **快速回答**
> cooler（华语牌桌上多叫“撞牌”，也有人说“冤家牌”）就是两手极强的牌相撞、输的那一方自始至终落后、却又没法正确弃牌的一手牌。它和 bad beat 相反：没有谁被翻盘，赢家从头领到尾，你只是拿着第二大的怪兽付了钱。
...
> **快速回答**
> 区别只有一个：筹码进池时你领先还是落后。领先着进池、被一张幸运牌反超，是 bad beat；落后着进池、只是牌太强弃不掉，是 cooler。KK 撞 AA 翻前是 cooler，AA 被 7-7 击中暗三条则是 bad beat。
...
这个区别决定了你到底有没有真正理解这个词——几乎每个休闲玩家都把它糊在一起。想从另一边看清楚，可以对照 [什么是 bad beat（爆冷输牌）](/zh/blog/holdem-bad-beat "thumb:/images/holdem-bad-beat-hero.webp")。两者都让人难受，但它们是相反的：
...
用同一对牌手把两边都演一遍，你就通透了。**bad beat：**你握着 A♠A♥，翻前对着 7♣7♦ 全下，然后一张 **7** 上了牌面——你的 AA 本是约 4:1 的热门（大约 80%），却被反超。**cooler：**反过来——你握着 **7♣7♦**，翻牌凑成一组暗三条 7，然后对着一手由更大对子凑成的暗三条把筹码全送了进去。你自始至终都是弱势的一方，只是没法弃掉一组翻牌暗三条。同样的牌，相反的故事。分清刚刚发生的是哪一种，就知道你该去 [复盘你的打法](/zh/blog/holdem-pot-odds "thumb:/images/holdem-pot-odds-hero.webp") 还是耸耸肩放下它。
...
> **快速回答**
> “cooler”是扑克里被滥用得最凶的一个借口。真假不靠感觉：换回当时手上的信息，你还会这样打，那就是 cooler，放下就行；你不会，那不是运气差，是一个要修的漏洞。
...
A. 是——它是所有 cooler 里最经典的一个。翻前 KK 面对 AA 处在大约 4.5:1 的下风，而几乎没有哪个讲道理的牌手会在翻牌前弃掉口袋 KK——只有当整条线在喊“我就是 AA”时才弃得掉，而翻前几乎碰不到那种线。于是筹码进了池，你自始至终落后，输掉一手你几乎躲不开的牌。
