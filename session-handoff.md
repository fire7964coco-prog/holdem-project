...
```bash
node scripts/gsc-query-pages.mjs "포커 족보" --days 7      # 18,100 ← 이 판 최대
node scripts/gsc-query-pages.mjs "홀덤족보" --days 7        # 8,100 (붙여쓰기)
node scripts/gsc-query-pages.mjs "홀덤 족보 순위" --days 7  # 390 (기준선 있는 쿼리)
```
