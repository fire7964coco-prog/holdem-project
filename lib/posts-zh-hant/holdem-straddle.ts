...
export const POST: Post = {
  ...
  desc: "Straddle 中文叫「盲抓」，也叫強抓——發牌前自願下的第三盲注，讓下注前就把底池加倍。規則、各種盲抓的差別、誰先誰後、到底划不划算，一次講清楚。",
  ...
  content: `
第一次在我坐的 $1/$2 桌上有人盲抓時，我完全搞不懂：那個槍口位的傢伙為什麼牌還沒發就丟出 $4，荷官又為什麼突然從再過去一個位子開始發動作。我把它叫做「有錢人的注」叫了大概一個月，才搞懂它真正在做什麼：盲抓==把底池加倍，還替某一位牌手買下最後發言權==——而這一切都發生在還沒有人看到任何一張牌之前。
...
> **快速解答**
> 盲抓買的不是底池，是翻前的最後發言權——而那份權利只值一條街。翻牌一發出來，順序就彈回正常，槍口位的盲抓者又坐回最早說話的位置，面前卻擺著一個被加倍的底池。這就是它多半不划算的機制。
...
> **快速解答**
> 答案是不划算，解算器和 GTO Wizard 都這麼說，原因是你在看牌之前就投錢、又撐大了要付抽水的底池。那人們為什麼還做？多半是為了好玩、或整桌都在抓——這些都是正當理由，只要老實承認它在花錢，別把「營造鬆散形象」當成回本的藉口。
...
💸 | 它撐大抽水 | 更大的底池代表被抽走更多[抽水（rake）](/zh-hant/blog/holdem-rake)，是被抽水現金桌裡每一手盲抓的隱形稅
:::
...
A. 盲抓是一注自願下的盲注，通常是大盲的兩倍，在發牌前就押出去——最常由槍口位的牌手下。它把那一手的底池加倍，並給盲抓者加注的權利和翻前最後行動，就像一個第三盲注。
...
A. 對多數牌手來說，不划算——它是一個 -EV 的打法。你盲投錢，你縮小了自己的位置優勢（解算器在有盲抓的底池裡開的牌*更少*，不是更多），又撐大了抽水。它只有在鬆弱桌、在所有人都已經盲抓的牌局、或純粹為了好玩時才站得住腳——絕不能拿來當賺錢的方法。

---

## 要記住的 3 件事

1. **盲抓是一注可選的第三盲注，通常是大盲的 2 倍**，在發牌前下——它把底池加倍，並買下翻前最後行動。
2. **決定位置的是座位，不是盲抓的名字。** 槍口位盲抓只在翻前最後行動。翻後也能最後行動的，只有==從按鈕位下的==盲抓——因為翻牌之後的順序永遠跟著按鈕位走。一切都看各家規則。
3. **對幾乎每個人都是 -EV。** 盲投、在不利位置撐大底池、餵養抽水，這些代價蓋過了樂趣。要盲抓，是為了桌上形象或娛樂，不是為了利潤。
