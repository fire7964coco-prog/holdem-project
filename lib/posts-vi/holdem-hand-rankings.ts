...
Không thể bị đánh bại hay hòa (hai Royal Flush chỉ có thể xảy ra ở chất khác nhau, nghĩa là chia pot). Nó xuất hiện khoảng một lần mỗi 31.000 tay, nên nhiều người chơi nhiều năm chưa từng có. Khi có, nhiệm vụ duy nhất của bạn là đẩy càng nhiều chip vào càng tốt.
...
A. Thùng Phá Sảnh Hoàng Gia (A-K-Q-J-10 cùng chất). Không thể bị đánh bại và chỉ hòa với một Royal Flush khác, nghĩa là chia pot.
