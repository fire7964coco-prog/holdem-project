...
export const CALC_DICT_PT: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "O número grande é o valor exato",
  ...
  starting: {
    ...
    summary: [
      ...
      { hands: "66–55 A8s–A2s KJo QJo suited connectors", action: "Jogue seletivo em posição tardia" },
    ...
    hands: {
      ...
      "88": { desc: "Par na mão com bom potencial de set", action: "Aumente em posição tardia; em posição inicial considere pagar um aumento — não dê open-limp" },
      ...
      "109s": { desc: "Suited connector forte", action: "Aumente/pague em posição tardia" },
      "77": { desc: "Mão de set mining, cuidado com overcards", action: "Aumente em posição tardia; em posição inicial pague um aumento — não dê open-limp" },
      ...
      "55": { desc: "Pouco valor sem acertar o set", action: "Pague um único aumento em posição tardia; se ninguém entrou, aumente de posição tardia" },
      ...
      "98s": { desc: "Suited connector forte", action: "Pague/aumente em posição tardia" },
      "87s": { desc: "Bom suited connector", action: "Pague um aumento em posição tardia" },
      ...
      "44": { desc: "Quase nenhum valor sem acertar o set", action: "Pague um aumento só se você e quem aumentou tiverem, cada um, pelo menos 15× o valor do call atrás" },
      "33": { desc: "Precisa acertar o set; especulativa", action: "Só pagando um aumento, em potes multiway com stacks profundos" },
      "22": { desc: "O menor par na mão", action: "Só pagando um aumento, em potes multiway com stacks profundos" },
      ...
      "65s": { desc: "Suited connector; quer potes multiway e odds implícitas", action: "Pague um aumento em posição tardia" },
      "54s": { desc: "Suited connector baixo; especulativo", action: "Pague um aumento em posição tardia, em potes multiway baratos" },
    },
  },
