...
export const POST: Post = {
  ...
  tldr: "短码（大约 15–20 个大盲以下）没法打正常的翻后扑克，所以要切到 push/fold：first-in 就直接 all in 来保住你的 fold equity，永远别开池平跟、也别 min-raise 之后又弃牌。后位推得更宽，跟注范围要比推注范围更紧，别为了「等一手好牌」把筹码盲到见底——fold equity 才是你的武器，一旦跌破约 8 个大盲它就开始消退。",
  category: "tournament",
  date: "2026-07-09",
  updated: "2026-08-11",
