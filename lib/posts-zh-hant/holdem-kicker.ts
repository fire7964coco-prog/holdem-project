...
export const POST: Post = {
  ...
  content: `
那把讓我終於搞懂踢腳牌是什麼的牌，賠掉了我整整一個買入。我拿的是 ==b:A♠ 9♣==，公牌配成了我的 A，我心想頂對穩了，直接梭下去。他一翻 ==b:A♥ K♦== —— 一樣是一對 A，但多出來給他的那張牌 —— 一張 K —— 定了勝負，底池就這樣滑到他那邊。我輸的不是更大的*牌型*，而是輸給了一張更大的 ==旁牌==。這張旁牌就是踢腳牌，它決定的底池比多數新手想像的還多。
...
> **快速解答**
> 只有那些用不到五張牌就湊成的牌型才有踢腳——凡是自己就填滿五張的，一張踢腳都沒有。所以順子、同花、葫蘆從頭到尾都不比踢腳，而一對、兩對、三條、四條才會比到旁牌。
...
> **快速解答**
> 如果五張公牌就是你最強的一手、你的底牌又無法讓它更好，那你就是在「用公牌打（playing the board）」——這時候你的踢腳就不再決定任何事，因為你的兩張底牌一張都沒進到最強五張裡。
