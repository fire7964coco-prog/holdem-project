...
export const CALC_DICT_HI: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "बड़े अंकों में दिख रहा आँकड़ा सटीक है",
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "अच्छी set संभावना वाला pocket pair", action: "LP में raise; EP में सामने raise हो तो call पर विचार करें — open limp नहीं" },
      ...
      KQo: { desc: "सबसे अच्छा offsuit connector", action: "LP में raise; EP में किसी की raise के सामने आम तौर पर fold — open limp नहीं" },
      ...
      "109s": { desc: "मज़बूत suited connector", action: "LP में raise, या raise पर call" },
      "77": { desc: "Set-mining हैंड, overcards से सावधान", action: "LP में raise; EP में सामने raise हो तो call — open limp नहीं" },
      ...
      // 🪶 EN은 55에만 셋마이닝 스택 조건이 없다(66·44는 «~15×»를 요구) — 작은 pair일수록 implied odds가 «더» 필요한데
      //    가운데만 느슨해 티어가 비단조가 된다. id가 같은 자리를 66에서 승계시켰고 hi도 따른다(EN 회灌 후보).
      "55": { desc: "Set के बिना कम कीमत", action: "LP में एक raise पर call तब, जब आप दोनों के पास call की रकम का ~15× पीछे बचा हो; first in हों तो LP से raise" },
      ...
      "98s": { desc: "मज़बूत suited connector", action: "LP में raise, या raise पर call" },
      // 🪶 EN은 87s에만 «raise first in»이 없어 **더 약한 76s보다 좁다**(티어 4 내부 역전). id가 98s와 동형으로 맞췄고 hi도 따른다.
      "87s": { desc: "अच्छा suited connector", action: "First in हों तो LP से raise; raise पर call भी" },
      "76s": { desc: "Suited connector", action: "First in हों तो LP से raise; raise पर call सिर्फ़ position और deep stacks के साथ" },
      "44": { desc: "Set के बिना लगभग कोई कीमत नहीं", action: "Raise पर call सिर्फ़ तब, जब आप दोनों के पास call की रकम का ~15× पीछे बचा हो" },
      "33": { desc: "Set-mine करना होगा; speculative", action: "सिर्फ़ deep stacks वाले multiway pots में" },
      "22": { desc: "सबसे छोटा pocket pair", action: "सिर्फ़ deep stacks वाले multiway pots में" },
      ...
      "65s": { desc: "Suited connector; multiway/implied odds चाहिए", action: "LP में raise पर call" },
      "54s": { desc: "छोटा suited connector; speculative", action: "LP में raise पर call, या सस्ते multiway pots में" },
    },
  },
