...
export const POST: Post = {
  ...
  title: "Odds implícitas no poker — quando um preço ruim é um bom call",
...
As odds cruas por trás de todo projeto vêm da [tabela de odds e probabilidade no poker](/pt/blog/holdem-probability "thumb:/images/holdem-probability-hero.webp"); este guia é como você decide quando essas odds — mais o dinheiro que ainda está por vir — tornam de fato um call lucrativo. Ele continua exatamente de onde as [pot odds](/pt/blog/holdem-pot-odds "thumb:/images/holdem-pot-odds-hero.webp") param.
...
:::steps
Encontre sua chance de acertar | Conte os outs, converta em porcentagem (a [regra do 2 e 4](/pt/blog/holdem-outs) te aproxima)
...
A fórmula em uma linha: ==b:x = (call ÷ hit%) − (pote atual + call).== Se o dinheiro extra que você realisticamente extrairia nas próximas streets for *maior* que x, pagar é lucrativo mesmo quando as pot odds imediatas mandam foldar.
...
**Você flopa um set (ou melhor) com um par na mão só 11,8% das vezes — cerca de 7,5 para 1 contra, ou 1 em 8,5 — então o set mining só lucra quando os stacks atrás cobrem todas as vezes que você erra.** Essa é a jogada de odds implícitas mais pura do poker: você paga um aumento com um par pequeno por um único motivo — flopar trinca e stackar alguém.
...
Dinheiro que você ==g:ganha== nas próximas streets quando acerta | Dinheiro que você ==r:perde== nas próximas streets quando acerta mas fica em segundo lugar
...
**Q. O que são odds implícitas no poker?**

A. Odds implícitas são as fichas extras que você espera ganhar nas próximas streets se o seu projeto completar — a parte de pagamento futuro de uma decisão de projeto. Um call que fica abaixo do preço atual pode recuperar a diferença depois que você acerta, mas só se um adversário ainda tiver fichas e estiver disposto a pagar. Trate esse pagamento como uma estimativa, não como dinheiro que já está no meio.
...
A. A diferença entre pot odds e odds implícitas é a certeza: o pote atual e o valor do call estão à vista; o pagamento posterior depende do que acontece a seguir. Confira primeiro o preço imediato e depois pergunte quanto um acerto precisa render a mais. Um stack profundo deixa esse dinheiro disponível, mas não garante que o adversário vá colocá-lo no pote.
...
A. As reverse implied odds são as fichas extras que um projeto completo te custa quando ele ainda é a segunda melhor mão: um flush baixo ou a ponta baixa de uma sequência pode te levar a investir mais enquanto outra mão continua na frente. Um projeto com esse risco pede uma estimativa de pagamento mais cautelosa do que um projeto para os nuts; ter o mesmo número de cartas que completam não torna essas cartas igualmente valiosas.
