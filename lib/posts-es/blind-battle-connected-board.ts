...
**Porque el rango con el que paga la ciega grande añade manos que la ciega pequeña nunca abre y que ligan 7-6-5 — 10-7, 9-7, 8-7 y 7-6 de distinto palo, 74s y 43s, entre otras — encima de las escaleras, los sets y las dobles parejas que tienen los dos rangos.** Las cinco primeras filas de abajo son las clases que de verdad ligan este board, y salvo los sobrepares (overpairs) la ciega pequeña no lidera ninguna.
...
El 9.6% se construye mezclando un poco de valor con unos cuantos proyectos. 88 encabeza la clasificación por clases porque **una sola mano hace los dos trabajos a la vez.** ⚠ Eso no es una regla general, eso sí — **ninguno de los mejores combos sueltos hace las dos cosas** (Q♥4♥ y Q♠4♠ con 54.7% son proyectos puros, A♣7♣ con 54.4% es valor fino con blocker, y le sigue 10♣9♣ con 52.2%, un gutshot). El mejor combo suelto de la mano que hace doble función, 8♦8♣, se queda *más abajo*, en 47.1%. **Ese 9.6% no lo seleccionó ningún criterio único.** **Y hacer check el 90.4% no es que la ciega pequeña se rinda en este board** — es que, con valor fino como A♣7♣ y K♣7♣, apostar y hacer check quedan a menos de 0.03bb el uno del otro, así que el check no regala casi nada. ⚠ Ojo, no busques la razón en el bote de 6bb, en el stack de 97bb ni en el SPR de 16.2 — esos tres son **exactamente las mismas constantes** en [⑪ K-10-6](/es/blog/blind-battle-cbet "thumb:/images/gto-sb-king-mid-oop-es.webp") y en [el board A-A-6](/es/blog/ace-paired-board-strategy "thumb:/images/gto-sb-paired-ace-oop-es.webp") más adelante en la serie, donde esa misma ciega pequeña apuesta 67.4% y 80.1%. Lo que produjo el 9.6% no es el stack; son **tres cartas del board**.
...
- **No confundas el A-high con fuerza.** Un cuarto del rango de la ciega pequeña es A-high, y en este board la mayor parte solo puede ligar pareja (A4 y A8 se llevan proyectos a dos puntas, y las manos A♦x♦ un proyecto de color). Los proyectos del rival, cuando entran, son sobre todo escaleras — lo que cambia no es la probabilidad de mejorar sino **cuánto vale esa mejora**. El 49.6% de equity es el resultado.
