...
export const POST: Post = {
  ...
  desc: "10〜11月の絶好の気候で春川マラソンやJTBCソウルマラソンを走り、そのままパラダイスシティでポーカー。2026年の全カレンダーと、外国人ランナー向けエントリー手順までまとめました。",
...
**レース:** 1946年創設——韓国で2番目に古いマラソン。==g:AIMS公認の国際コース==で、これはワールドマラソンメジャーズの一つ下にあたる世界標準です。フル42.195K + 10K。スタートは孔之川(コンジチョン)橋、午前9:00。コースは==**衣岩湖(ウィアムホ)**==(의암호)——10月下旬に山々が色づく貯水池——を一周します。レース当日の気温はたいてい8〜14°Cで、自己ベストが出やすいコンディションです。
...
==r:昨年は3分足らずで定員に達しました。受付開始前に、パスポート番号と決済手段を必ず用意しておくこと。==
...
**コース:** スタートは==上岩(サンアム)ワールドカップ競技場==(地下鉄6号線、上岩ワールドカップ競技場駅)。徳寿宮(トクスグン)、光化門(クァンファムン)広場、東大門(トンデムン)を抜け、ソウルの歴史と現代のアイデンティティを一気に巡ります。フルは==オリンピック公園==でフィニッシュ、10Kは==汝矣島(ヨイド)公園==でフィニッシュ。制限時間はフルで5時間。
...
- **保証(ギャランティ):** ==g:136のトロフィーイベントで総額$3.5M+ GTD==(メインイベントのバイインは未定)
...
すでにトーナメントのために韓国にいるプレイヤーなら——レースの朝は7時に起き、ソウル中心部を42K走り、正午までにオリンピック公園でフィニッシュ。午後2時までにパラダイスシティへ戻る。ポーカーのテーブルはまだ回っています。これは本当に実行可能——そして、この重なりについて書いている人はほぼ皆無です。
