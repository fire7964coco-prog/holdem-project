...
最經典的衝突，是*去跟*一手邊緣全下。在籌碼EV 裡，為一個大底池打一場五五開可以是不錯、甚至是好的——你贏到的籌碼跟你可能輸掉的一樣多。但在 ICM 裡，它可能是清清楚楚該==蓋==，因為爆掉賠掉的是你在「已經鎖住的那個名次之上」每一個名次的權益（保底那一份本身還是你的），而你贏到的那些籌碼，價值又低於面額。
...
A. 籌碼EV 用贏或輸多少籌碼衡量一個決策；ICM 用真實獎金衡量。兩者在錦標賽早期一致，接近錢圈就分岔，因為在那裡爆掉賠掉的是真實的獎金權益——在泡泡時間，賠掉的是你進錢圈的全部機會；一旦進了錢，賠掉的是「已鎖住的名次之上」的一切。一手在籌碼EV 沒問題的五五開全下，在 ICM 下可能是清楚的蓋牌。
