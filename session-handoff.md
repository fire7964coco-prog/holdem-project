...
2. **🟡 얇은 허브 채우기** (진행 중): ✅ **`holdem-blind-steal` 발행**(2026-07-11, 포지션 허브 2→3편, GSC 기회키워드, 팩트체크 7건 교정, ⏳이미지 2개 대기·미배포). **남음**: 포지션→`홀덤 포지션 종류`(단, 포지션 필라와 카니발 주의) / 확률(3)→`드로잉 오즈`·`임플라이드 오즈` KO편 신규(EN엔 이미 있음). (상세 WORKLOG 2026-07-11)
