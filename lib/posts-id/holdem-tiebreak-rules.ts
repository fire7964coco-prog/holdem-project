...
Pertanyaan ini terus muncul karena urutan jenis kartu memang ada di poker — hanya saja bukan di permainan ini. Stud dan razz memakainya untuk menentukan siapa yang membayar bring-in dan siapa yang menerima chip yang tak bisa dibagi. Hold'em tak memakainya untuk keduanya.

Bukti paling bersih justru ada pada satu chip yang *tak* bisa dibagi. Aturan turnamen WSOP 2026 menyebut ==g:*"In button games with 2 or more high or low hands, the odd chip goes to the first seat left of the button"*== (Aturan 73): chip sisa jatuh ke kursi pertama di kiri button. Bahkan saat sebuah pot secara fisik tak terbagi rata, aturan itu meraih **kursi**, bukan jenis kartu — dan metode berbasis jenis kartu di paruh kedua aturan yang sama ditulis khusus untuk stud dan razz.

Satu hal lagi yang layak diketahui: di Hold'em dua flush selalu berjenis *sama*, karena kelima kartu bersama dipakai bersama-sama dan satu meja tak mungkin memuat tiga hati dan tiga sekop sekaligus. Jadi "sekop saya mengalahkan hati Anda" bukan aturan yang membuat Anda kalah — itu tangan yang tak mungkin dibagikan.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-kicker" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Apa itu kicker di poker?</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kartu samping itu sendiri — tangan mana yang punya dan berapa banyak</div>
  </a>
  ...
  <a href="/id/blog/holdem-flush-vs-straight" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Matematika, spot meja, dan kasus seri untuk kebingungan #1</div>
  </a>
  <a href="/id/blog/holdem-split-pot-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">5 situasi chop dan 3 hal yang keliru dikira menang pemain</div>
  </a>
</div>
`.trim(),
};
