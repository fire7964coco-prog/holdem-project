...
export const CALC_DICT_FR: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "Paire servie avec un bon potentiel de brelan", action: "Relancer en LP ; en EP, payer une relance, et relancer ou se coucher si tu ouvres le coup — jamais d'open-limp" },
      ...
      A3s: { desc: "Carte de roue + tirage couleur max, un cran au-dessus de A2s", action: "BTN/SB uniquement" },
