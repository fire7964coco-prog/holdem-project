...
> 🧰 **queue 상태(09-11 (15))**: Q1 ✅ · Q2-a ✅(판정 · 브리프 `docs/harden-brief/queue-Q2-이미지.md`) · **Q2-b는 사장님 판단 2건 뒤에만 연다** — ① 실사 2장 생성(프롬프트 = 브리프 §4 ①·⑥ · 글자 없음 · `holdem-strategy-button-seat` · `holdem-cooler-stacks-collide`) ② ✅ 09-11 사장님 결정 = 기본안(언어 중립 1장) · ① ✅ 실사 2장 도착(`Holdem-queue/tmp/q2-src/`) → **Q2-b 열 수 있다**(「`HARDEN.md` 읽고 회차 Q2-b 시작해」). T2 3자리는 **Q2-c**로 분리(헤드 판정).
