...
export const POST: Post = {
  ...
  title: "德州扑克摊牌规则：谁先亮牌、盖牌规则与 Slow Roll",
  seoTitle: "摊牌时谁先亮牌？德州扑克摊牌与盖牌规则详解",
  desc: "摊牌时到底谁先亮牌？输了能不能不亮直接盖牌？一文讲清德州扑克摊牌规则——最后进攻者先亮、以牌为准（cards speak）、slow roll 和全押摊牌，10 分钟搞懂。",
  tldr: "摊牌时，河牌圈最后一个下注或加注的玩家先亮牌。如果河牌圈所有人都过牌，则从按钮位左边第一个仍在牌局中的玩家开始亮牌。输了可以不亮牌直接盖牌，但对手有权要求查看一手被跟注的牌。",
  category: "rules",
  date: "2026-06-15",
  updated: "2026-07-12",
  ...
  content: `
你跟注了河牌圈的下注。然后你们俩就这么互相盯着，都在等对方先亮牌。

谁也不动。

荷官来回看着你们，同桌其他玩家开始叹气。

==这种僵持几乎在每一张线下牌桌都会上演==——因为大多数新手从来没搞清楚到底该谁先亮牌。这篇指南覆盖所有摊牌场景：常规摊牌、河牌圈全过牌、全押摊牌，以及为什么 slow roll 会让你被全桌人瞪到散场。
...
真实场景：你拿着 J♥ T♥，公共牌是 Q♥ 9♥ 8♥ 2♣ 5♦。你有 Q 高同花顺（红心 Q-J-T-9-8）。对手亮出 K♣ Q♦（一对 Q）。你赢得毫无悬念。别因为看见对方那张 Q 就把牌盖了。
