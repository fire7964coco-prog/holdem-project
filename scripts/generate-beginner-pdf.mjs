...
const CONTENT = {
  ...
  zh: {
    ...
    brand: "holdemmaster.com",
    title: "德州扑克新手规则",
    subtitle: "一页速查: 牌型、流程、下注动作",
    page2Title: "玩牌、下注、赢底池 - 新手参考",
    footer1: "holdemmaster.com · 德州扑克新手规则",
    footer2: "完整指南: holdemmaster.com/zh/blog/texas-holdem-rules-for-beginners",
    pageLabel: (n, total) => `第 ${n} 页 / 共 ${total} 页`,
    howItWorks: {
      heading: "游戏怎么进行",
      paras: [
        "每位玩家拿到2张只有自己能看的底牌，桌面中央会亮出5张公共牌。",
        "用底牌和公共牌组成最强的5张牌 - 可以用2张底牌、1张底牌，甚至0张底牌。",
        "下注轮次共有4轮: 翻牌前、翻牌、转牌、河牌。摊牌时最强五张牌赢得底池。",
      ],
    },
    handRankings: {
      heading: "牌型大小",
      ...
      headers: ["", "牌型", "例子", "含义"],
      rows: [
        ["皇家同花顺", ["A", "K", "Q", "J", "10"], "spade", "最强牌型"],
        ["同花顺", ["9", "8", "7", "6", "5"], "heart", "同花色5张连续"],
        ["四条", ["Q", "Q", "Q", "Q"], null, "同点数4张"],
        ["葫芦", ["K", "K", "K", "7", "7"], null, "三条 + 一对"],
        ["同花", ["A", "J", "8", "5", "2"], "diamond", "同花色5张"],
        ["顺子", ["10", "9", "8", "7", "6"], null, "不同花色也可连续"],
        ["三条", ["8", "8", "8"], null, "同点数3张"],
        ["两对", ["A", "A", "9", "9"], null, "两组对子"],
        ["一对", ["J", "J"], null, "同点数2张"],
        ["高牌", ["A", "K", "7", "4", "2"], null, "没有成牌"],
      ],
      tiebreak:
        "同牌型时从高牌开始比较。最强5张完全一样时，底池平分。",
    },
    bettingRounds: {
      heading: "四个下注轮次",
      steps: [
      ...
      showdown:
        "摊牌: 河牌后若有2人以上留下，最强5张牌赢得底池。",
    },
    whoActsFirst: {
      heading: "谁先行动?",
      rows: [
        ["翻牌前:", "大盲注左边的玩家先行动。"],
        ["翻牌后:", "按钮左边仍在牌局中的第一位先行动。"],
      ],
      memory: "记忆法: 翻牌前看大盲左边，翻牌后看按钮左边。",
    },
    bettingActions: {
      heading: "下注动作",
      hint: "基础就是这4种",
    ...
    startingHands: {
      heading: "强起手牌",
      hint: "新手容易操作",
      line: "AA  KK  QQ  JJ   —   AK  AQ   —   TT-77   —   同花高张 (KQs, QJs, JTs)",
    },
    chipSetup: {
      heading: "家庭局简单筹码设置",
      hint: "总值200 = 盲注1/2时100BB",
      headers: ["筹码", "价值", "每人", "合计"],
      rows: [
        ["白色", "1", "20", "20"],
        ["红色", "5", "16", "80"],
    ...
    mistakes: {
      heading: "新手常见错误",
      items: [
        "以为两张底牌必须都用 - 标准永远是最强5张。",
        "忘记翻牌后行动顺序会改变。",
        "有一张A就玩太多 - 弱A很容易输给更好的A。",
        "所有听牌都追到底 - 只有价格合适才跟注。",
      ],
    },
