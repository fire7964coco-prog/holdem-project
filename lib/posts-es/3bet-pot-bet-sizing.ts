...
export const POST: Post = {
  ...
  desc: "El solver tenía dos tamaños en este flop two-tone y metió el 98.4% del rango en uno. Dos tercios del bote dejan sin precio a 38 de 40 proyectos, carta a carta.",
...
JJ y 99 son el caso contrario. **Ninguna de las dos tiene proyecto.** Las jotas, con la reina y el diez del board, todavía necesitan dos cartas más — un rey y un nueve, un as y un rey, o un nueve y un ocho — para hacer escalera. Tienen pareja, que se lee como fuerza, pero la mano que puede darle la vuelta a todo con una sola carta es A-K.

## ¿Qué tiene realmente el botón?

**Más de un tercio — el 36.1% — es un underpair, así que llega a un board con dos cartas broadway sosteniendo una pareja por debajo de la reina — por debajo de las dos cartas broadway en todos los underpairs salvo JJ, que queda entre ellas.** El resto se reparte entre manos que ligaron con la reina, manos que van a los corazones y una cola pequeña de nada. Una fila de la tabla de abajo no significa lo que parece, y vale la pena encontrarla antes de seguir leyendo.
...
- **★Desde el asiento del botón, planea dónde paran las parejas medias.** Aquí el 36.1% del rango que paga es un underpair. ⚠ No leas la **MDF de 60.2% como una cuota de call**, eso sí — sale de tratar la apuesta como un farol puro sin equity, y **el 45.1% del rango con el que apuesta la ciega grande ya está hecho** (8.2 de trío, 16.4 de sobrepares, 20.5 de top pair), así que si la defensa óptima real queda por encima o por debajo es una pregunta que **este solve no responde.** **El turn es adonde van esas parejas** — una segunda apuesta grande foldea a la mayoría, y pagar el flop sin haber decidido eso es por donde se escapan los stacks. (El nodo del turn no está en este solve, así que eso es un juicio, no una cifra.)
...
A. Para cobrarles a los proyectos. Dos tercios del bote le piden al que paga cerca de 28.5% de equity, y con odds de la siguiente carta solo dos de sus 40 combos con proyecto llegan — K♥J♥ y 9♥8♥, que tienen quince outs y 31.9%. Todo lo demás se queda corto con una carta, incluidos los proyectos combinados de doce outs con 25.5% — aunque con las dos cartas por venir la mayoría de esos proyectos sigue teniendo más del 28.5%, así que el precio les cobra en lugar de hacerlos foldear. Baja a un tercio del bote y el listón cae a 19.8%, lo que duplica a cuatro los combos que lo superan. Los proyectos no son la única ruta al tamaño grande, eso sí — cuando el rango se parte en fuerte y débil sin nada en medio, un [board seco como 8-5-2](/es/blog/3bet-pot-low-board) también llega al 97.8%.
