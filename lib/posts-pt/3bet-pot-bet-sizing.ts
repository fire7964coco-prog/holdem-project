...
⚠ "Ficar abaixo do preço" aqui se refere apenas à conta da próxima carta. Contra o range inteiro do big blind, com turn e river por vir, 30 desses 38 combos ainda têm mais de 28,5% de equity — os gutshots de A-K ficam entre 37,6% e 42,9%, porque as cartas altas também contam. Para a maioria dos draws, a aposta grande cobra caro para continuar, mas não os obriga a desistir.
...
JJ e 99 são o caso inverso. **Nenhuma das duas mãos tem draw imediato de sequência.** Os valetes, junto da dama e do dez do board, ainda precisam de duas cartas — rei e nove, ás e rei, ou nove e oito — para formar uma sequência. Elas têm par, uma força já feita; A-K é a mão que pode transformar tudo com uma única carta.
...
- **Em pote de 3-bet com dois tipos de draw no board, considere primeiro o tamanho grande.** Um terço do pote oferece um preço de 19,8%, e todos os quatro combos com flush draw do botão passam desse valor com folga (um flush draw simples, de nove outs, não passaria — ==9 ÷ 47 = 19,1%== —, mas aqui só o big blind tem esse tipo de mão). ⚠ Isso não vira uma regra de "tem draw, aposte grande": **este artigo traz seu próprio contraexemplo.** No [board 8-5-2](/pt/blog/3bet-pot-low-board), 78,3% do range não tem draw, mas o tamanho grande também recebe 97,8%. Ali, a explicação é o **range polarizado**, e não os draws. Leia a densidade de draws junto da distribuição de força do range. Em pote com um único aumento, a mesma textura exige outra análise, como mostra a nota anterior.
- **A-K não precisa dar check neste flop só por estar sem par.** Com dama e dez, é um gutshot para a sequência máxima — ⚠ mas não é por isso que aposta: no 8-5-2 citado acima, onde nada se conecta a ele, A-K ainda vai para o tamanho grande em 95,9–97,9% das vezes (aqui, 97,8–99,9%). Ter ou não ter draw não resolve sozinho a ação de A-K. A ideia prática é olhar primeiro a distribuição de força do range inteiro nesse board.
...
- **★No botão, planeje até onde os pares intermediários vão.** Underpairs representam 36,1% do range de call. ⚠ **A MDF de 60,2% não é uma cota de calls**: é uma referência calculada sob a hipótese de blefe puro sem equity, e **45,1% do range do big blind que aposta já tem mão feita** — 8,2 de trinca, 16,4 de overpair e 20,5 de top pair. Por isso, saber se a defesa ótima fica acima ou abaixo daquela referência exige uma resposta que **este resultado não fornece**. **O turn é o ponto de saída de muitos desses pares**: uma segunda aposta grande tende a expulsar a maioria deles, e pagar o flop sem pensar nisso pode custar caro. Como o nó de turn não está neste resultado, essa é uma leitura prática, não uma frequência calculada.
...
A. Para cobrar dos draws. Dois terços do pote exige cerca de 28,5% de equity e, pelas odds da próxima carta, apenas dois dos 40 combos de draw passam disso: K♥J♥ e 9♥8♥, com quinze outs e 31,9% na próxima carta. Os demais ficam abaixo na conta de uma carta, inclusive os combo draws de doze outs, com 25,5% — embora, com turn e river por vir, a maioria desses draws ainda tenha mais de 28,5%. O preço os cobra, mas não os expulsa. Um terço reduz a exigência para 19,8%, dobrando para quatro o número de combos que passam. Draws não são o único motivo para apostar grande: um range dividido entre mãos fortes e fracas, sem meio-termo, também chega a 97,8% em um [board seco como 8-5-2](/pt/blog/3bet-pot-low-board).
