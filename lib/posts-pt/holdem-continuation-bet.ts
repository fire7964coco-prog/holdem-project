...
export const POST: Post = {
  ...
  imageAlt: "Um jogador de poker apostando fichas sobre um flop recém-distribuído depois de dar raise no pré-flop, o clássico momento da continuation bet no feltro verde",
  tags: ["continuation bet", "c-bet poker", "sizing de c-bet", "frequência de c-bet", "quando dar c-bet", "c-bet fora de posição", "c-bet multiway", "delayed c-bet"],
  content: `
...
- **Triple barrel** — você aposta nas três streets: flop, turn e river. A linha mais agressiva, para valor forte ou um bluff bem escolhido com blockers.
...
|:---|:---|:---|:---|:---|
| **Alto, seco (dry), desconectado** | K‑7‑2, A‑8‑3 | **Você (raiser)** | Aposte **com frequência e pequeno** (⅓) | Você tem mais top pairs & overpairs; ele errou |
| **Baixo, conectado** | 7‑6‑5, 9‑8‑6 | **Quem pagou** | **Dê check mais**; aposte grande e seletivo quando apostar | Acerta os suited connectors e pares pequenos dele |
| **Paired baixo** | 8‑8‑3, 5‑5‑2 | **Você (levemente)** | Aposte **com frequência e pequeno** | Nenhum tem trinca com frequência; suas overcards/overpairs lideram |
| **Monotone** | K♠9♠4♠ | Misto — cautela | Aposte **menos, menor** | Um flush feito limita os dois ranges; vá barato |
| **Two-tone & wet** | Q♥J♥7♣ | Tende ao caller | **Polarize:** grande com valor e draws, check com nada | Montes de draws — cobre deles ou saia |
...
- **Pequeno — cerca de um terço do pote** — em boards secos (dry), estáticos, de range advantage, especialmente em posição. O range do seu adversário é fraco e não vai melhorar muito, então você não precisa cobrar dos draws; uma aposta pequena já coloca todo o lixo dele numa situação difícil enquanto mantém mãos piores dentro para te pagar. Uma aposta maior aqui só faz foldar as mãos que você *quer* que paguem.
- **Grande — dois terços do pote ou mais** — em boards wet, dinâmicos e sempre que o seu range estiver polarizado. Agora você precisa cobrar dos flushes e projetos de sequência (negar a equity deles) e construir o pote com as suas mãos fortes. Uma aposta pequena deixa os draws pagarem barato demais.
...
Dar check no flop não é o fim da mão. Uma **delayed c-bet** — dar check no flop como quem deu raise no pré-flop e depois apostar no turn — é uma das jogadas mais subutilizadas do poker. Ela brilha quando:
...
A. Uma delayed c-bet é quando quem deu raise no pré-flop dá check no flop e depois aposta no turn. É útil quando o flop favoreceu o seu adversário (então apostar era ruim) mas o turn melhora o seu equity, quando você deu check back com uma mão decente em posição, ou para pegar adversários que planejavam dar bluff-raise na sua aposta do flop. É uma das jogadas lucrativas mais subutilizadas do poker.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/holdem-strategy" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">O framework das 5 decisões</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Onde a c-bet se encaixa num jogo vencedor</div>
  </a>
  <a href="/pt/blog/holdem-3bet" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Estratégia</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">3-Bet explicado</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">A c-bet também começa em potes de 3-bet</div>
  </a>
  <a href="/pt/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Estratégia</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Jogando a sua posição</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por que as c-bets funcionam melhor em posição</div>
  </a>
  <a href="/pt/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por que uma c-bet grande cobra dos draws</div>
  </a>
</div>
`.trim(),
};
