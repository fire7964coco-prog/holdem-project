...
const SPEC: [string, string][] = [
  ...
  ["表示言語", "日本語（韓国語・英語・スペイン語・ポルトガル語・ドイツ語・フランス語・中国語に切替可）"],
...
const SPOT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { board: "A♦K♠2♥", name: "3ベッター優位のAハイボード", note: "3ベットレンジにとって最高のボード（AK・AA・KKが詰まっています）。小さなベットがレンジ全体に効くのは、スタックの浅さではなくレンジの形によるものです" },
      ...
      { board: "8♦5♣2♠", name: "ロー・ドライボード", note: "3ベットレンジがほぼ丸ごと外れるボード（トップペアは0%）。それでもオーバーペアが圧力をかけ続けます" },
    ],
  },
  {
    ...
    items: [
      ...
      //       **앱 소스에 `スリーカード` 0건**이다(실측). 그래서 괄호의 «앱 화면 표시»를
      ...
      { board: "A♠A♥6♦", name: "Aペアボード", note: "Aを持つトリップス（アプリの画面表示は「セット/トリップス」）はSBが88コンボ、BBが66コンボ。数でも質でも上回るSBが80.1%を仕掛けます" },
    ],
  },
];
