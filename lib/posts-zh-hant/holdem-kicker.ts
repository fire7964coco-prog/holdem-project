...
**如果五張公牌本身就湊成了最強的牌、你的底牌又無法讓它更好，那你就是在「用公牌打（playing the board）」—— 這時候根本沒有踢腳。** 同樣沒辦法讓它更好的人，都用同樣的五張牌——如果沒有任何人能，底池才平分。
...
A. 用公牌打指五張公牌就是你的最強牌、你的底牌無法讓它更好。如果沒有任何人能讓公牌更好，大家都用同樣的五張牌，底池平分。這時沒有踢腳，因為公牌本身已經湊成一副完整的五張牌。
