...
- `lib/gto-series.ts`의 ①–⑬을 HI index와 `/hi/solver`에 연결해 **09-15 공개 발행**했다. 독립 검수·정정 교열·운영 확인과 IndexNow 접수 근거는 [HI 발행 검수 기록](../hi-gto-publication-review-2026-09-15.md)을 따른다.
