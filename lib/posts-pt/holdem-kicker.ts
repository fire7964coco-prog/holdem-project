...
:::stripe
4 | Kickers em uma mão de carta alta
...
|:---|:---:|:---:|
| Carta alta | Sim — as cinco comparadas em ordem | 4 |
| Um par | ✅ Sim | 3 |
| Dois pares | ✅ Sim | 1 |
| Trinca | ✅ Sim | 2 |
...
**A carta alta usa quatro kickers, um par três, a trinca dois, e dois pares e a quadra só um.** Saber a contagem te diz exatamente até onde um desempate pode ir — e quais mãos não se separam por kicker de jeito nenhum.
...
A. Depende da mão: quatro para a carta alta (as cinco comparadas em ordem), três para um par, dois para a trinca e um para dois pares e a quadra. Sequências, flushes, full houses e straight flushes não têm kicker porque já preenchem as cinco cartas.
...
2. **Combinação + kickers = cinco.** A carta alta tem 4 kickers, um par 3, a trinca 2, dois pares e a quadra 1; sequências, flushes, full houses e straight flushes não têm nenhum.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  ...
  <a href="/pt/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Ranking de Mãos</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Como os Empates São Desfeitos</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Ordem completa de desempate de cada mão</div>
  </a>
  <a href="/pt/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por que ases de kicker fraco são foldados</div>
  </a>
  <a href="/pt/blog/holdem-reading-the-board" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Identifique quando você está jogando a mesa</div>
  </a>
</div>
`.trim(),
};
