...
- **face-down muck করতে পারে** যদি বুঝে যায় হেরে গেছে — নিজের কার্ড দেখানোর দরকার নেই। তবে এটা কেবল ততক্ষণই, যতক্ষণ কেউ all-in হয়নি: টুর্নামেন্টে কোনো খেলোয়াড় all-in হওয়ামাত্র TDA নিয়ম ১৬ ওই pot-এর প্রতিটি হ্যান্ড খোলা বাধ্যতামূলক করে দেয় এবং কেউই muck করতে পারে না (cash game-এ house rules প্রযোজ্য, আর বেশিরভাগ cardroom-এ caller muck করতে পারে)
...
| river-এ করা all-in bet call হয়ে যায় | all-in করা খেলোয়াড় last aggressor হিসেবে আগে দেখায় — কিন্তু টুর্নামেন্টে ==r:এখানে কেউই muck করতে পারে না==: TDA নিয়ম ১৬ অনুযায়ী caller-কেও হ্যান্ড খুলতে হয় |
