...
:::stripe
Fraco / perdedor | O que "fish" significa
Shark | O oposto — o jogador vencedor
40–70% | O VPIP típico de um fish (mãos jogadas)
"Não bata no vidro" | Nunca espante o fish
:::
...
A palavra não tem a ver com o quanto a pessoa é *simpática* ou o quanto ela curte o jogo — muitos fish são as pessoas mais divertidas da mesa. É puramente sobre resultados e decisões: um fish faz jogadas perdedoras de forma consistente e, com o tempo, entrega suas fichas para jogadores melhores. E o mais importante: um fish raramente sabe que é um fish. Esse ponto cego é a essência do termo, e é por isso que o conceito importa muito mais do que parece à primeira vista.
...
## Como identificar um fish: 8 sinais reveladores

Geralmente você não precisa de uma sessão inteira — um fish se entrega dentro de uma ou duas voltas de mesa. Fique de olho nestes:

:::stripe
Joga mãos demais | Vê flops com quaisquer duas cartas — um VPIP de 40–70% contra os 15–22% de um jogador sólido
Dá limp o tempo todo | Paga o big blind em vez de aumentar ou dar fold, de novo e de novo
Paga, raramente aumenta | Passivo — prefere "ver o que acontece" a tomar o controle
Não larga um par | Casa com o top pair ou um overpair até o river não importa a ação
Corre atrás de todo projeto | Paga qualquer preço por um flush ou sequência, ignorando as odds
Sizing de aposta esquisito | Aposta mínimo com mãos grandes, faz overbet com fracas — o sizing não te diz nada
Aparece fraco no showdown | Vira mãos que nunca deveriam ter chegado tão longe
...
| Termo | O que significa | Como joga | Como você bate |
|:---|:---|:---|:---|
...
## Sou eu o fish? Um autoexame honesto

Aqui vem a parte desconfortável. Se você leu até aqui torcendo baixinho para ser um shark, faça este teste primeiro. O autodiagnóstico mais rápido usa duas estatísticas que você pode acompanhar em qualquer tracker (ou estimar com honestidade):
...
- Você acha dar fold chato, então se convence a ficar?
- Depois de um bad beat, seus próximos 20 minutos ficam *piores*?

Se você está balançando a cabeça, isso não é uma sentença — é um presente. Cada um desses é um leak corrigível, e corrigi-los é a diferença entre financiar o jogo e vencê-lo.
...
5. **Jogue sua posição.** Agir por último é uma vantagem enorme que o fish joga fora. Jogar mais mãos [em posição](/pt/blog/holdem-position-play) e menos fora dela corrige automaticamente uma parte gigante dos leaks.
6. **Pare quando der tilt.** O hábito de fish mais caro de todos é continuar jogando depois de um bad beat. Reconheça e vá embora.

Faça essas seis coisas e você para de ser o dinheiro. Você não precisa virar um shark da noite para o dia — só precisa parar de ser a refeição.

---

:::readnext[Continue lendo]
/pt/blog/holdem-starting-hands-chart | Quais mãos valem a pena jogar | /images/holdem-starting-hands-chart-hero.webp
...
**Q. Qual a diferença entre um fish e um whale?**

A. Um whale é um tipo específico de fish — um que perde quantias *grandes* de dinheiro, geralmente um jogador rico apostando de forma frouxa em stakes altos. Todo whale é fish, mas nem todo fish é whale. A presença de um whale numa mesa é o que atrai os sharks habilidosos para o jogo, porque é ali que está o dinheiro grande.

**Q. Qual a diferença entre um fish e um donkey?**

A. São quase sinônimos, mas o tom difere. "Fish" enfatiza inexperiência e perda de dinheiro; "donkey" (ou "donk") enfatiza fazer jogadas especialmente ruins e ilógicas, e é mais abertamente insultuoso. Todo donkey é fish, mas "donkey" é o que você chama um fish que acabou de tomar uma decisão espetacularmente ruim.
...
**Q. Quem disse "se você não consegue achar o otário na mesa, o otário é você"?**

A. A famosa versão da tela é do filme de 1998 *Rounders*, dita pelo personagem de Matt Damon — e ela diz "otário" (sucker), não "fish". Mas a ideia é um provérbio de jogo mais antigo, sem um único autor verificável; Amarillo Slim usou uma versão e creditou Warren Buffett "e um milhão de outros sujeitos" antes dele. Atribua a frase a Rounders, mas trate o conceito como um ditado antigo.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Tabela de mãos iniciais</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">O jeito mais rápido de parar de ser o fish</div>
  </a>
  <a href="/pt/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Pare de correr atrás de projetos sem preço</div>
  </a>
  <a href="/pt/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Estratégia</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Jogando sua posição</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">A vantagem que o fish joga fora toda mão</div>
  </a>
  <a href="/pt/blog/holdem-straddle" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">A aposta que infla o pote para o fish</div>
  </a>
</div>
`.trim(),
};
