...
## ▶▶▶▶▶▶▶▶▶ 새 세션 START HERE (2026-08-01 — ★다음 작업 = GA4 참여율 개선)

### ▶ 다음 세션에 할 일 (사장님 지시 2026-07-31 밤)

> **"GA4에서 유독 참여율 떨어지는 페이지 몇 개를 좀 더 유저 친화적으로 업데이트하는 작업을 하자."**

**착수 전 필요한 것**: GA4의 **참여율(engagement rate) 낮은 페이지 목록**.
사장님께 데이터를 받아야 시작할 수 있다(GSC와 달리 GA4 CSV는 아직 레포에 없다).
받으면 `docs/gsc-tracking/`처럼 저장해 추세를 남길 것.
