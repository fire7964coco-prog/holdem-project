...
export const POST: Post = {
  ...
  emoji: "🃏",
  tags: [
    "reguli showdown poker",
    "cine arata cartile primul poker",
    "muck poker ce este",
    "slow roll poker",
    "showdown all in texas holdem",
  ],
  image: "/images/holdem-showdown-rules-hero.webp",
  imageAlt: "Infografic showdown la Texas Hold'em — pe un board 4♥ 7♣ Q♦ K♠ 2♥, A♠ K♥ câștigă cu o pereche de regi și kicker as",
  content: `
Ai plătit pariul de la river. Și acum stați amândoi și vă fixați cu privirea, fiecare așteptând ca celălalt să întoarcă primul cărțile.

Nimeni nu se mișcă.

Dealerul se uită când la unul, când la celălalt. Restul mesei oftează.

==Această încleștare se repetă la aproape fiecare masă live== — pentru că majoritatea începătorilor nu au învățat niciodată cine trebuie de fapt să arate primul. Ghidul ăsta acoperă toate situațiile de showdown: mâini normale, river-e închise în check, all-in-uri și de ce un slow roll o să te facă privit urât tot restul serii.

## Cine trebuie să arate cărțile primul la showdown?

Regula depinde de cum s-a încheiat ultima rundă de pariere (pentru secvența completă, stradă cu stradă, care te aduce până aici, vezi [ordinea de joc](/ro/blog/holdem-game-order "thumb:/images/blog-holdem-game-flow.webp")).
...
## Poți face muck fără să arăți la showdown?
...
## Ordinea showdown-ului când toată lumea a dat check la river

Dacă nimeni nu a pariat la river (toți au dat check), showdown-ul pornește de la **primul jucător activ din stânga butonului** și continuă în sensul acelor de ceasornic.

Exemplu: butonul, small blind-ul (SB) și big blind-ul (BB) ajung la river. SB dă check, BB dă check, butonul dă check. Showdown-ul pornește de la SB (primul jucător activ din stânga butonului). SB poate arăta sau face muck. Apoi BB. Și butonul ultimul.

==g:În acest caz butonul arată ultimul== — ceea ce e de fapt un avantaj. Butonul poate vedea dacă îl bate cineva înainte să decidă dacă își întoarce cărțile.
...
## Ce înseamnă regula „cards speak" (cărțile vorbesc)?

![Infografic cu regula cards speak — un board 8♠ 9♣ 10♥ J♦ Q♠ formează o chintă la damă, iar la showdown cărțile vorbesc singure](/images/holdem-showdown-cards-speak.webp)

„Cards speak" înseamnă că ==câștigă cea mai bună mână, indiferent ce spune fiecare jucător==.
...
==r:Slow roll-ul este cel mai rapid mod de a-ți face dușmani la o masă de poker.== Este interpretat ca o dorință de a-i freca celuilalt victoria pe la nas. Regula nescrisă: dacă ai cea mai bună mână posibilă, întoarce-o imediat. Slow roll-ul nu are niciun avantaj strategic. Singurul rezultat este tensiunea la masă.

Nu confunda asta cu **tanking-ul** — să-ți iei în mod legitim timp pentru o decizie dificilă. Aia e acceptată, ba chiar respectată. Un slow roll cu nuts-ul e cu totul altceva.

---

## Trebuie să-ți arăți cărțile dacă câștigi fără showdown?

Nu. ==g:Dacă toată lumea se retrage înainte de showdown, iei potul fără să arăți nici măcar o carte.==

Poți să le arăți dacă vrei — sunt jucători care arată un bluff ca să-l bage pe adversar în tilt, sau o mână puternică pentru a-și construi o imagine tight. Dar nu ești niciodată obligat să-ți arăți cărțile când câștigi pentru că toți ceilalți s-au retras.

Ăsta e unul dintre motivele pentru care pokerul e interesant. Nu câștigă mereu cea mai bună mână — câștigă ultimul rămas în picioare.

---

## Eticheta showdown-ului — ce greșesc începătorii

### Greșeala 1: să aștepți să arate primul cel care a plătit

Pariezi la river. Cineva te plătește. Rămâi nemișcat, așteptând să întoarcă el. E invers. ==Arăți tu primul — ai fost ultimul agresor.== A aștepta pare un slow roll chiar și când nu e.
...
/ro/blog/holdem-all-in-rules | Regulile all-in-ului și side pot-urile | /images/holdem-all-in-rules-hero.webp
:::
...
A. Nu. Dacă toți ceilalți se retrag înainte de showdown, câștigi potul pe loc și nu trebuie niciodată să-ți dezvălui cărțile. Să le arăți e opțional — unii jucători întorc un bluff ca să-l provoace pe adversar, dar nu ești niciodată obligat să arăți o mână care a câștigat fără opoziție.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/ro/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Regulile complete — de la blind-uri la showdown</div>
  </a>
</div>
`.trim(),
};
