...
import { clusterForSlug, EN_CLUSTERS, JA_CLUSTERS, ES_CLUSTERS, type PillarCluster } from "@/lib/pillar-clusters";
...
export default function IntlBlogPostClient({
  ...
  const localeClusters: PillarCluster[] | null =
    locale === "en" ? EN_CLUSTERS : locale === "ja" ? JA_CLUSTERS : locale === "es" ? ES_CLUSTERS : null;
