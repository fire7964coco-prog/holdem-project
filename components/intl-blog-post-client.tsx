...
const CALC_CTA_LABELS: Partial<Record<SecondaryLocale, { title: string; subtitle: string }>> = {
  ...
  // ★2026-09-19 (id 계산기 회차) 교체 — «Kalkulator Odds Poker»는 볼륨 null·자동완성 0이었다.
  //   «Kalkulator Poker» = 10(+41%↑) · 구글이 «poker calculator»를 그렇게 번역한다(뱅크 §4 · fr §3-J ⑤식 «교체»).
  id: { title: "Kalkulator Poker", subtitle: "Equity, outs & pot odds instan" },
