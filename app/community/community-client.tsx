...
const LABELS = {
  ...
  ar: {
    logout: "تسجيل الخروج", login: "تسجيل الدخول", loginArrow: "تسجيل الدخول →", loginSignup: "دخول / تسجيل →",
    feed: "الخلاصة", explore: "استكشاف", event: "الأحداث", profile: "الملف الشخصي", trendingExplore: "الرائج",
    writePost: "✏️ كتابة", searchPlaceholder: "ابحث عن استراتيجية، أوراق، لاعبين...", writePlaceholder: "شارك يدك أو استراتيجيتك أو نتيجتك...",
    postButton: "نشر", posting: "جاري النشر...", postNow: "نشر", writeModalTitle: "منشور جديد", draftPlaceholder: "ما الذي تفكر فيه؟", cancel: "إلغاء",
    multiLangBannerFull: "عرض المنشورات بجميع اللغات. المنشورات بلغات أخرى لها زر ترجمة.",
    strategyPosts: "✦ منشورات الاستراتيجية", communityTab: "🌏 المجتمع", communityPostsLong: "🌏 منشورات المجتمع",
    emptyFeedTitle: "لا توجد منشورات بعد", emptyFeedSub: "كن أول من ينشر!", emptyStrategyTitle: "لا توجد منشورات استراتيجية", emptyCommunityTitle: "لا توجد منشورات مجتمعية",
  ...
  hi: {
    logout: "लॉग आउट", login: "लॉग इन", loginArrow: "लॉग इन →", loginSignup: "लॉग इन / साइन अप →",
    feed: "फीड", explore: "एक्सप्लोर", event: "इवेंट", profile: "प्रोफ़ाइल", trendingExplore: "ट्रेंडिंग",
    writePost: "✏️ लिखें", searchPlaceholder: "रणनीति, हाथ, खिलाड़ी खोजें...", writePlaceholder: "अपना हाथ, रणनीति या परिणाम साझा करें...",
    postButton: "पोस्ट", posting: "पोस्ट हो रहा है...", postNow: "पोस्ट करें", writeModalTitle: "नई पोस्ट", draftPlaceholder: "आप क्या सोच रहे हैं?", cancel: "रद्द करें",
    multiLangBannerFull: "सभी भाषाओं की पोस्ट दिखा रहे हैं। अन्य भाषाओं की पोस्ट में अनुवाद बटन है।",
    strategyPosts: "✦ रणनीति पोस्ट", communityTab: "🌏 समुदाय", communityPostsLong: "🌏 समुदाय पोस्ट",
    emptyFeedTitle: "अभी कोई पोस्ट नहीं", emptyFeedSub: "पहली पोस्ट करें!", emptyStrategyTitle: "कोई रणनीति पोस्ट नहीं", emptyCommunityTitle: "कोई समुदाय पोस्ट नहीं",
    comingSoon: "जल्द आ रहा है", eventComing: "इवेंट जल्द आ रहा है", eventComingSub: "लॉटरी शैली के इवेंट जल्द खुलेंगे",
    loginRequired: "लॉग इन आवश्यक है", loginRequiredSub: "अपनी पोस्ट और गतिविधि देखने के लिए लॉग इन करें",
    myPostsStat: "पोस्ट", likesStat: "लाइक", commentsStat: "टिप्पणियाँ", myPostsSection: "मेरी पोस्ट", noPostsTitle: "कोई पोस्ट नहीं", noPostsSub: "अपनी पहली पोस्ट लिखें!",
    trendingTitle: "🔥 इस सप्ताह ट्रेंडिंग", eventBadge: "🎰 इवेंट · जल्द आ रहा है", eventTitle: "6 नंबर चुनें\nगिफ्ट कार्ड जीतें!", eventDesc: "3 मेल → ₩5,000 · 4 → ₩10,000\n5–6 → ₩50,000",
    eventButton: "इवेंट देखें →", communityLang: "🌐 समुदाय भाषाएँ",
    badge_winner: "🏆 विजेता", badge_hot: "🔥 लोकप्रिय", badge_top: "⭐ शीर्ष उपयोगकर्ता", badge_participant: "🎟️ प्रतिभागी",
  },
  tr: {
