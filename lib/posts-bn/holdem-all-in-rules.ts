...
A. যে শেষ all-in একটা bet বা raise ছিল, সেটাই শেষ আগ্রাসী action, আর সে-ই আগে দেখায়। যে all-in শুধু কম টাকায় call করে, সেটা আগ্রাসী নয় — তখনও মূল bet করা খেলোয়াড়ই আগে দেখায়। Cash game-এ, যদি সেটা আর কোনো action ছাড়া call করা all-in হয়, তাহলে call করা খেলোয়াড় all-in খেলোয়াড়ের হ্যান্ড দেখার পর হারলে muck করতে পারে (টুর্নামেন্টে জড়িত সব হ্যান্ড face-up থাকে)।
