...
export function generateMetadata(): Metadata {
  ...
  const ongoingText = running.length
    ? `Läuft gerade: ${running.map((t) => localizedName(t, LOCALE)).join(", ")}.`
    : "";
  ...
  return {
    ...
    twitter: {
      ...
      description:
        "Live-Pokerturniere weltweit: Termine, Buy-in und die offizielle Quelle zu jedem Turnier.",
    },
    openGraph: {
      title: `${title} | HoldemMaster`,
      description:
...
export default function Page() {
  ...
  return (
    <>
      ...
      <HubPage title="Turniere" locale="de">
