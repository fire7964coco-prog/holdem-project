...
> - ⚠️ **소급(retrofit) 잔여**: 이미 완료한 나머지 12편(odds 6 + strategy positions·position-play·starting-hands-chart·limping·3bet·continuation-bet)도 ラッコ 롱테일 재마이닝해 진짜 gap 있으면 신규 H2 보강(없으면 그대로 OK). 남은 22편(rules·tournament·glossary)은 처음부터 이 워크플로우로.
