...
- **Do not carry "check 0%" to every three-bet pot.** What changes it is the board more than the range: the same three-bet range on [8-5-2](/en/blog/3bet-pot-low-board) checks 2.0%, and on a board that runs against the three-bettor a check appears for real. **"An ace and a king together" is what produced this zero in this example — not a condition every three-bet pot has to meet.** How to build the three-bet range in the first place is in [3-bet strategy](/en/blog/holdem-3bet).
