...
/**
 * 베트남어(vi) 블로그 포스트.
 * 기계 번역이 아닌 베트남 포커 커뮤니티 용어(Cù Lũ, Tứ Quý, Sảnh, Thùng, Sám Cô 등)로 현지화한 글만 등록한다.
 * 슬러그는 다른 언어 글과 동일하게 맞춰 hreflang 상호 링크가 성립하도록 한다.
 */
export const VI_POSTS: Post[] = [holdemHandRankings, holdemGameOrder, holdemTournamentVsCashGame];
