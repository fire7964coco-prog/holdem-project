...
- **87조 Button in Heads-Up Play**: 「In heads-up play, the small blind is on the button and acts first pre-flop and last on all other betting rounds. The last card is dealt to the button.」 (= B 157조)
