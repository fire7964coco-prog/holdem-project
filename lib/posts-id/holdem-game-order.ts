...
Begitu blinds terpasang, dealer memberi setiap pemain dua **kartu tertutup** menghadap ke bawah. Hanya Anda yang bisa melihatnya, dan taruhan **preflop** pun dimulai.

Aksi dimulai dari kiri big blind dan bergerak searah jarum jam. Di giliran Anda, Anda memilih salah satu dari ini:

- **Fold** — menyerah dan membuang kartu Anda. Anda tidak kehilangan apa-apa lagi, tapi juga tidak bisa menang.
...
Sekarang Anda sudah bisa membaca kombinasi lima kartu sungguhan: dua kartu tertutup Anda plus tiga kartu di board. Perhatikan dua hal sekaligus:

- **Apa yang Anda pegang sekarang** — pair, two pair, atau belum jadi apa-apa.
- **Apa yang masih bisa Anda bentuk** — **draw** Flush atau Straight yang bisa jadi di ronde-ronde berikutnya.
...
- Apakah draw Straight atau Flush Anda sudah jadi?
...
- **Preflop** = awal (memutuskan hanya dengan dua kartu Anda)
- **Flop** = perubahan (tiga kartu membuka kemungkinan)
- **Turn** = keputusan (kesempatan nyata terakhir Anda merencanakan river)
...
Makin dekat Anda ke button, makin bagus — bertindak terakhir membuat Anda bisa melihat apa yang dilakukan semua orang sebelum Anda memutuskan. Main tight di posisi awal dan lebih agresif di posisi akhir. Untuk peta kursi lengkap dan range pembukaan tiap posisi, lihat [penjelasan posisi poker: UTG sampai button](/id/blog/holdem-positions).
...
Hafalkan urutannya sampai mendarah daging, asah lewat permainan gratis, dan Anda tidak akan pernah lagi bengong menebak giliran siapa. Anda siap duduk di meja.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Aturan lengkap, chip, peringkat kartu + PDF siap cetak</div>
  </a>
  <a href="/id/blog/holdem-hand-rankings" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Peringkat Kartu Poker — dari Terbaik ke Terburuk</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kesepuluh kombinasi dengan peluang, contoh, dan teka-teki board</div>
  </a>
  <a href="/id/blog/holdem-positions" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Peta kursi, opening range, dan kenapa posisi menang</div>
  </a>
</div>
`.trim(),
};
