...
export const CALC_DICT_ID: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "Pocket pair dengan potensi set yang bagus", action: "Raise di posisi akhir; di posisi awal call raise, dan kalau first in raise atau fold — jangan open-limp" },
      ...
      "55": { desc: "Nilainya kecil tanpa set", action: "Raise first in dari posisi akhir; di posisi akhir call satu raise kalau tersisa ~15× jumlah call di belakang" },
      ...
      A3s: { desc: "Kartu wheel + nut flush draw, setingkat di atas A2s", action: "Hanya BTN/SB" },
      ...
      "44": { desc: "Hampir tanpa nilai tanpa set", action: "Raise first in dari posisi akhir; di posisi akhir call satu raise kalau tersisa ~15× jumlah call di belakang" },
