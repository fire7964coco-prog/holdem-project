...
export const CALC_DICT_EN: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      "55": { desc: "Little value without a set", action: "Raise first in from LP; call a single raise in LP with ~15× the call behind" },
      ...
      "44": { desc: "Almost no value without a set", action: "Raise first in from LP; call a single raise in LP with ~15× the call behind" },
