...
> **快速解答**
> 只有那些用不到五張牌就湊成的牌型才有踢腳——凡是自己就填滿五張的，一張踢腳都沒有。所以順子、同花、葫蘆、同花順從頭到尾都不比踢腳，而一對、兩對、三條、四條才會比到旁牌。
...
> **快速解答**
> 一對用三張踢腳、三條用兩張、兩對和四條各只用一張。知道張數，你就清楚一場破平手最深能比到哪裡——一對可以一路比到第三張旁牌，兩對卻只有一張可以吵。
...
2. **組合牌 ＋ 踢腳 ＝ 五張。** 一對有 3 張踢腳、三條 2 張、兩對和四條 1 張；順子、同花、葫蘆、同花順都沒有。
