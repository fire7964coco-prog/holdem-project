...
export const CALC_DICT_ID: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "Angka yang ditampilkan dalam ukuran besar itu nilai persisnya",
  ...
  starting: {
    ...
    //    ✅ EN KQo는 2026-09-20에, EN 88·77은 2026-09-21(회차 Q10)에 정정됐다 — 이제 EN이 정본이다.
    ...
    hands: {
      ...
      A10s: { desc: "Salah satu suited ace teratas", action: "Raise di posisi tengah/akhir; dari UTG raise atau fold — jangan open-limp" },
      ...
      A3s: { desc: "Kartu wheel + nut flush draw, setingkat di atas A2s", action: "Hanya di posisi akhir" },
      A2s: { desc: "Wheel + nut flush, tapi lemah", action: "Hanya di posisi akhir" },
      ...
      "98s": { desc: "Suited connector yang solid", action: "Raise first in dari posisi akhir; call raise kalau in position" },
      ...
      "44": { desc: "Hampir tanpa nilai tanpa set", action: "Raise first in dari posisi akhir; di posisi akhir call satu raise kalau Anda dan pemain yang raise sama-sama punya sisa minimal ~15× jumlah call di belakang" },
      "33": { desc: "Harus set mining; spekulatif", action: "Raise first in dari posisi akhir; selebihnya hanya pot multiway dengan stack deep" },
      "22": { desc: "Pocket pair terendah", action: "Raise first in dari posisi akhir; selebihnya hanya pot multiway dengan stack deep" },
      ...
      J10o: { desc: "Offsuit yang lumayan tapi rentan", action: "Hanya BTN" },
      ...
      "65s": { desc: "Suited connector; butuh multiway/implied odds", action: "Raise first in dari posisi akhir; call raise hanya kalau in position dan stack deep" },
      "54s": { desc: "Suited connector rendah; spekulatif", action: "Raise first in dari posisi akhir; call raise hanya kalau in position dan di pot multiway yang murah" },
    },
  },
