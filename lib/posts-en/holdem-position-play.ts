...
> **Quick answer**
> **In position (IP)** means you act last; **out of position (OOP)** means you act first. Position usually improves equity realization because acting last supplies more information, but neither seat is mechanically locked above or below 100%: ranges, board, and action can reverse the usual pattern. It's why UTG opens ~13% of hands, the button ~43%, and why every c-bet, bluff, and pot-control decision changes with your seat.
...
|:---|:---:|:---|
| **In position** | ==g:**Usually higher — spot-dependent**== | Act last → see everything → value-bet and bluff at the right moments |
| **Out of position** | ==r:**Usually lower — can exceed 100%**== | Act first → fold winners, pay off losers, surrender free cards |

Those labels are a rule of thumb, not a law. Position creates an average edge, but ranges, board, and action determine whether either seat over- or under-realizes in a particular spot.

![IP vs OOP comparison — Button (IP) acts last, while ranges, board, and action determine each seat's exact equity realization](/images/holdem-position-play-ip-vs-oop.webp)
...
A. Because acting last converts the same cards into more money. It usually improves equity realization, but it does not force the in-position seat above 100% or the out-of-position seat below it; ranges, board, and action can reverse that pattern. The in-position player still sees every opponent decision before making their own, so they value-bet, bluff, and fold at better moments with identical holdings.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/en/blog/holdem-positions" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Poker Seat Names & Table Map</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">UTG, Lojack, Hijack, Cutoff, Button — every seat explained</div>
  </a>
  <a href="/en/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Which hands to play from each seat — printable reference chart</div>
  </a>
  <a href="/en/blog/holdem-blind-meaning" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Small Blind & Big Blind Strategy</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Why the discounted seats are the hardest to profit from</div>
  </a>
  <a href="/en/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Tournament vs Cash Game Strategy</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">How position decisions change when ICM applies</div>
  </a>
</div>
`.trim(),
};
