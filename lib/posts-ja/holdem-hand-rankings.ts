...
→ A♥ がボードの A♠ とペアになり、**KKK + AA のフルハウス**。ただし相手も*エースを持っていれば*同じフルハウスで引き分け。相手がエースを持たず小さいペアだけなら、あなたのボートが勝ちます。教訓:ボードが仕事の大半をしているとき、あなたの手はカード1枚分しか強くないことが多い。
...
A. ありません。ポーカーの手は常に5枚なので、含められるペアは最大2組まで。7枚の中で手札とボードから3組のペアができても、手の役に数えるのはベストの2組だけ——3組目の高いほうのカードはキッカーとして働くことはあっても、「スリーペア」という役にはなりません。
