...
export const POST: Post = {
  ...
  imageAlt: "Vista de cima de uma mesa profissional de poker mostrando 9 posições de jogador com stacks de fichas e um dealer button dourado",
  tags: [
    "posições no poker",
...
![Mesa de poker com nove jogadores, stacks de fichas em cada assento e o dealer button marcado com D na frente de um jogador](/images/holdem-button-position-hero.webp "O dealer button define a posição de cada assento e a ordem de jogo")

| Posição | Abrev | Zona | Pré-flop | Pós-flop |
|:---|:---|:---|:---:|:---:|
...
|:---|:---|:---|:---|
| **UTG** | Under the Gun | Early (EP) | Primeiro a agir no pré-flop, logo à esquerda do big blind |
...
| **BTN** | Button (Dealer) | Late (LP) | O assento com o disco de dealer — último a agir no pós-flop |
...
Isso pega quase todo jogador ao vivo de primeira viagem: quando o floor chama **"Mesa 12, Assento 5"**, esse número não tem ==nada a ver com as posições do poker==.
...
Então "o que é o Assento 1 no poker?" tem uma resposta chata — é uma cadeira — e é exatamente esse o ponto. ==Um número de assento é um endereço; uma posição é uma função==, e a função é reatribuída toda mão.

---

## O que é UTG no poker?

**UTG significa "Under the Gun"** — o assento imediatamente à esquerda do big blind, e o ==primeiro jogador a agir no pré-flop==. O nome evoca a pressão do lugar: você precisa comprometer fichas antes de ver o que um único adversário faz, como se agisse sob a mira de uma arma.
...
Os nomes não têm origem oficial documentada — a gíria do poker raramente tem — mas a história mais contada é assim:
...
**O cutoff (CO)** é o assento ==um à direita do button== — a última posição antes do dealer. Duas histórias de origem circulam: uma diz que o assento "corta" (cuts off) a chance do button de roubar os blinds aumentando primeiro; uma mais antiga diz que em jogos caseiros em que os próprios jogadores davam as cartas, o jogador à direita do dealer ==cortava o baralho== depois do embaralhamento. De qualquer forma, o nome pegou, e o cutoff é universalmente contado como late position.

**O button (BTN)** — também chamado de **posição de dealer** — é o assento marcado pelo disco físico de dealer. Em jogos de cassino um dealer profissional cuida das cartas, então o button simplesmente marca ==quem *estaria* dando as cartas==, que é o que ancora a ordem de aposta: o button age ==por último em toda street pós-flop==, e todo o resto na mesa é nomeado pela distância até esse disco.

Essa última ação garantida é o motivo pelo qual o button é considerado o assento mais lucrativo do poker — o argumento completo, com os números por trás, está no [guia de estratégia de posição](/pt/blog/holdem-position-play).
...
Como posições, elas são definidas pela inversão na ordem de ação: os blinds agem ==por último no pré-flop== (já pagaram, então todo mundo precisa responder às apostas deles primeiro) mas ==primeiro no pós-flop==, à frente da mesa inteira, no flop, no turn e no river.
...
## Quem age primeiro no poker — pré-flop vs pós-flop (os blinds vão primeiro?)
...
E entre os dois blinds: ==o small blind age antes do big blind em toda street==, tanto no pré-flop quanto no pós-flop — com uma exceção, heads-up, coberta abaixo.
...
**Q. O que significa UTG no poker?**

A. UTG significa "Under the Gun" — o assento imediatamente à esquerda do big blind, e o primeiro jogador a agir no pré-flop. O nome evoca a pressão de comprometer fichas antes de ver a decisão de qualquer adversário. Em jogos full ring os dois próximos assentos se chamam UTG+1 e UTG+2.

**Q. O que é o hijack no poker?**

A. O hijack (HJ) é o assento dois à direita do dealer button, logo antes do cutoff. É o mais tardio dos dois assentos de middle position num jogo 9-max e o segundo assento a agir no pré-flop em 6-max. A história mais contada por trás do nome: um aumento desse assento "sequestra" o roubo de blind que o cutoff e o button estavam posicionados para fazer.

**Q. O que é o lojack no poker?**
...
A. O Assento 1 é uma cadeira física, não uma posição — na maioria dos card rooms é o primeiro assento à esquerda imediata do dealer, com os números correndo no sentido horário até o Assento 9 ou 10. A equipe usa os números de assento para acomodação e logística. As posições do poker (UTG, button, blinds) giram de forma independente a cada mão, então o Assento 1 pode ser qualquer posição.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Guia para iniciantes</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Regras do Texas Hold'em para iniciantes</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Como uma mão inteira funciona do deal ao showdown</div>
  </a>
  <a href="/pt/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Estratégia de posição</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Estratégia dentro vs fora de posição</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Ranges de abertura e o que fazer de cada assento</div>
  </a>
  <a href="/pt/blog/holdem-game-order" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Ordem de jogo</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Ordem de jogo no Texas Hold'em</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Sequência de ação pré-flop → flop → turn → river</div>
  </a>
  <a href="/pt/blog/holdem-blind-meaning" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Small blind e big blind explicados</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por que existem e como jogá-los corretamente</div>
  </a>
</div>
`.trim(),
};
