...
> 🧰 **queue 상태(09-12 (17))**: Q1 ✅ · Q2-a ✅ · **Q2-b ✅**(이미지 10장 · EN 10자리 + 썸네일 3 + 7로케일 · `check:image-reuse` 🔴 40→0 · 머지 ff `311f6497`). 남은 회차 = **Q2-c**(T2 3자리 · 소) · **Q4-a**(EN-먼저 묶음 I · K1~K4·L1·L2·J#8·X-1·결재 15 문구 — 가장 쌓여 있다) · Q4-b · Q5-a/b · Q6 · Q7-a/b · Q8-a/b. 다음 권장 = **Q4-a**(「`HARDEN.md` 읽고 회차 Q4-a 시작해」).
...
| 발신 | 무엇 | 상태 |
|---|---|---|
| **MB-033~043** | 🆕 09-11~12 발신 11건 회신 대기 — MB-043 queue Q2-b(EN 7편 이미지 10자리 + 캡션 4 · 새 파일명 10 앵커 · F유형 2 정정) · MB-042 ja 회차 14(앵커 · 🔴 소급 회차 종료 결재 §1-D · EN 변경 0 · 예고 2) · MB-041 queue Q1(EN shc 변경 통지 · 요청 1 = M-102 §6 「€30+6」 0-감시 앵커를 capt-graz 카드로 좁혀 달라 · 「1,326」·「58」 신규 앵커) · MB-040 ja 회차 13(앵커 · EN 변경 0 · 예고 4 · 형제 개수 «결함 아님» 통지) · MB-033 EN-먼저 18건 배포(앵커 갱신 · 요청 1 = ar 원장 11건 «EN 완료·ar 미전파» 표시) · MB-034 ja 회차 11(앵커) · MB-035 회귀 🔴 2 재실행(재앵커 요청) · MB-036 S-013 ACK(솔버 · 라이브 대조 후 닫힘) · MB-037 MA-130·131 이행(앵커 · X-1 미결) · MB-038 MA-136 이행 · MB-039 ja 회차 12(앵커 · 훅 결함 통지). 전문 = `mailbox/out-본체.md` | 검수장 · 솔버 |
...
- 결재 7 잔여 = **T2 3자리**(`limping:64`·`limping:116`·`drawing-odds:58` — 이미지에 박힌 영어가 캡션과 무관) → queue **Q2-c**. `holdem-button-dealer-board`·`holdem-pub-players-table` 잔여 사용은 Q2-c 뒤 `check:image-reuse --all`로 재실측
