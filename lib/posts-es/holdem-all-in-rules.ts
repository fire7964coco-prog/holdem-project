...
**2. Empujar todas las fichas** — Desliza todo tu stack hacia el centro en un solo movimiento limpio. Mover las fichas en varias tandas puede parecer un string bet, así que muévelo todo de una vez. ==r:Empujar solo no siempre basta: si tienes una apuesta por delante y necesitas hasta la última ficha para igualarla, empujar sin decir nada se juzga como call, no como all-in (regla 45-A de la TDA 2024, regla 92 del reglamento de torneo de las WSOP).== En cualquier otro caso, empujar tus últimas fichas **sí** es un all-in (regla 45-B de la TDA 2024) — la única excepción es una sola ficha sobredimensionada, la última, empujada sin decir nada ante una apuesta: eso es solo un call (regla 44 de la TDA 2024).
...
Esta es la versión que hace tropezar hasta a los regulares. Varios all-ins cortos pueden **sumar** una subida completa — y si sus incrementos combinados alcanzan el umbral, la apuesta se reabre para un jugador que ya actuó. ==r:La prueba se hace jugador por jugador, no una sola vez para toda la mesa:== solo se reabre para quien, **cuando la acción vuelve a él, tiene delante al menos una subida completa por encima de lo que ya había puesto** (==regla 47 de la TDA 2024==).
...
**Resultado: la apuesta SE REABRE para el Jugador A.** A puso $10 y ahora tiene delante $21 — $11 más, al menos una subida completa —, así que puede retirarse, pagar o resubir, aunque ni B ni C hicieran una subida completa por separado. Un jugador que hubiera pagado los $14 de B en medio solo tendría $7 más delante cuando le volviera el turno, y para él no se reabre nada: pagar o retirarse.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/es/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Guía pilar</div>
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Todas las reglas, de las ciegas al showdown</div>
  </a>
  <a href="/es/blog/holdem-split-pot-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Reglas del bote dividido y del reparto</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Cuándo se reparte el bote y por qué</div>
  </a>
  <a href="/es/blog/holdem-showdown-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Reglas del showdown</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Quién enseña primero y cuándo puedes tirar tus cartas</div>
  </a>
</div>
`.trim(),
};
