...
### 2. 公共牌通杀
五张公共牌本身对场上剩下的所有人来说已经是最强牌——就是我故事里那个 8-8-8-A-K 的底池。这是最常见的平分之一，所以下面单独给它开一节。
...
公共牌通杀甚至不需要两手怪物牌。那就是我的 8-8-8-A-K：我的 J♠ 10♥ 和他的 5♣ 2♦ 都在打牌面带 A-K 踢脚的三条 8——五张完全相同，两手牌一亮出来就是 chop。极端情况是像 A♠ K♠ Q♠ J♠ 10♠（皇家同花顺）这样的牌面：任何底牌都改进不了它，所以 ==g:剩下的所有人一起 chop==。
