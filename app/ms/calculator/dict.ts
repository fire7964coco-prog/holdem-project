...
export const CALC_DICT_MS: CalcDict = {
  ...
  //    1010 «do not open-limp» · AJs·KJs «raise or fold» · A10s·Q10s «fold from EP».
    hands: {
      ...
      "55": { desc: "Kurang nilai tanpa set", action: "Raise first in dari posisi lewat; call satu raise di posisi lewat apabila ada sekurang-kurangnya ~15× saiz call itu di belakang" },
      ...
      "44": { desc: "Hampir tiada nilai tanpa set", action: "Raise first in dari posisi lewat; call satu raise di posisi lewat apabila ada sekurang-kurangnya ~15× saiz call itu di belakang" },
