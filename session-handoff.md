...
### ▶ 0-◔. 2026-08-05 (5) — 실전 모드 검수: 결함 3건 ✅ (여기서 멈춤)
...
| 순위 | 할 일 | 메모 |
|---:|---|---|
| ~~1~~ ✅ | ~~`apt-incheon` 미러 8종~~ | **2026-08-05 완료** (`6ab3bf0`) — 위 `0-◑` 참조 |
| ~~2~~ ✅ | ~~`tournaments-client.tsx:601` 하드코딩 날짜~~ | **2026-08-05 완료** (`6e442c3`) — 위 `0-◐` 참조 |
| **2-A** | **`/win-rate-quiz` 본문 0줄** | 6인 테이블(`5e82a54`)·실전 모드(`1e153fd`) 완료. **남은 건 본문·FAQ 스키마** — 위 `0-◓`의 ⚠ 참조 |
