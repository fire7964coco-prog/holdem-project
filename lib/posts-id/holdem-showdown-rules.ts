...
Aturan praktisnya: ==kalau Anda gertak (bluff) dan di-call, muck cepat-cepat. Kalau Anda bet for value dan di-call, buka kartu Anda.==
...
Ini berlaku dua arah. Kalau Anda merasa kalah lalu muck tanpa membuka kartu, padahal hand Anda sebenarnya pemenangnya — ==r:pot itu hilang==. Hand Anda mati begitu menyentuh tumpukan muck. Kalau Anda tidak 100% yakin kalah, selalu biarkan dealer membaca hand Anda sebelum muck.
...
Anda cukup yakin kalah. Anda menggeser kartu menghadap ke bawah ke arah muck. Dealer menariknya. Ternyata hand Anda pemenangnya. Hand sudah mati — pot hilang. ==Jangan pernah muck sebelum benar-benar yakin.== Biarkan dealer membaca kedua hand.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  ...
  <a href="/id/blog/holdem-split-pot-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:var(--foreground);line-height:1.4">Aturan Split Pot dan Side Pot</div>
    <div style="font-size:12px;color:var(--muted-foreground);margin-top:4px">Kapan pot dibagi rata dan cara kerja side pot</div>
  </a>
  <a href="/id/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:var(--muted-foreground);margin-top:4px">Hand sama — siapa yang menang saat showdown?</div>
  </a>
</div>
`.trim(),
};
