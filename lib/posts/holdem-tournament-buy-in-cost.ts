...
export const POST: Post = {
  ...
  desc: "홀덤 대회 참가비가 3만원인지 300만원인지 헷갈리죠. 홀덤펍·APT·APPT·WSOP 바이인과 리엔트리·새틀라이트까지 총비용 기준으로 정리했습니다.",
  tldr: "홀덤 대회 바이인은 홀덤펍 소규모는 보통 1만~20만원대, 국내 대형 APT·APPT 메인은 약 180만~250만원, WSOP 메인은 $10,000입니다. 초보자는 무료·소액 대회나 새틀라이트로 시작하는 것이 안전합니다.",
  category: "토너먼트",
  date: "2026-06-12",
  updated: "2026-06-12",
...
- 홀덤펍 소규모 대회는 보통 **1만~20만원대**로 접근성이 높지만, 매장·시상 구조에 따라 차이가 크다
...
| 입문 | 홀덤펍 소규모 대회 | 1만~20만원대 | 첫 오프라인 |
| 초급 | 지역 리그·위성 | 5만~50만원대 | 대회 구조를 아는 사람 |
| 중급 | 국내 대형 사이드·메인 | 70만~250만원대 | 본격 토너먼트 도전 |
| 고급 | 해외 메이저 메인 | $5,300~$10,000 | 경험자·위성 통과자 |
| 하이롤러 | 슈퍼 하이롤러 | $25,000~$250,000 | 프로·하이롤러 |

첫 대회라면 **참가비가 싸다고 무조건 좋은 것도 아니고, 비싸다고 무조건 좋은 것도 아닙니다.** 중요한 건 내 bankroll(대회용 예산)에서 한 번 탈락해도 멘탈이 흔들리지 않는 금액이어야 한다는 점입니다.
...
단, 새틀라이트는 "싸게 들어가는 확정권"이 아닙니다. 입상해야 시트가 나오기 때문에 여러 번 도전할 예산과 시간이 필요합니다. 그래도 초보 입장에서는 직접 250만 원을 내는 것보다, 35만~50만 원대 위성에서 경험을 쌓으며 시트를 노리는 편이 훨씬 현실적입니다.
