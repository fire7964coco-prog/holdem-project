...
export const SOLVER_FAQ_JA: FaqItem[] = [
  ...
  {
    q: "画面は日本語に対応していますか?",
    a: "対応しています。メニュー、5つの入力ステップ、結果画面の項目名、学習スポットの解説文、GTOトレーナーの採点表示まで日本語です。ソルバーは用語が多く、英語のままだと「Equity Realization」や「Exploitability」で手が止まりがちですが、日本語表示ならそこでつまずきません。画面右上の言語切り替えから韓国語・英語・スペイン語・ポルトガル語・ドイツ語・中国語にも変更できます。",
  },
  {
