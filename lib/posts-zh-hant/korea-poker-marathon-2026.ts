...
export const POST: Post = {
  ...
  desc: "JTBC 首爾（11/1）是 2026 年唯一可能還對外國跑者開放的馬拉松——春川與 Garmin 已額滿。賽程表、報名費，加上仁川機場十分鐘就到的 Paradise City，一趟全串起來。",
...
> **快速解答**
> 五場比賽的外國人報名管道各不相同：有的走官網的 Foreigner 分頁、有的走 worldsmarathons、有的走韓國本地平台抽籤，2026 年只剩 JTBC 對外國人開放，春川與 Garmin 已額滿——截止日依你走的管道而定，這張表也是 2027 年的模板。
...
> **快速解答**
> JTBC 是這幾場裡唯一能「跑完直接去玩牌」的：終點就在奧林匹克公園旁的地鐵站，轉 AREX 到仁川約兩小時。外國人走 worldsmarathons 報名，而且改成抽籤，早報名不等於卡到位子——2027 年一開放就要登記。
...
**如何報名（外國人）：**
居住在韓國以外的外國跑者，透過 ==**[worldsmarathons.com](https://worldsmarathons.com/marathon/international-seoul-marathon)**== 報名。==r:名額有限、很快就滿==——==r:**截止日依你走的管道而定**==：日本 RUNNET 管道到 2026 年 9 月 4 日為止、已經關閉，而 worldsmarathons.com 是另一個管道，可能仍顯示有名額，所以請先到那裡確認再做打算。不論走哪個管道，取消／退費的截止時間都落在該管道關閉當天的 23:59（KST）；2027 年的開放時間請上官方頁面確認。持韓國護照者不適用此管道。
...
> **快速解答**
> 2026 年的 YTN 已在 9 月 6 日跑完，而且 6 月 26 日就提前額滿——它是先到先得，不是抽籤。留著這一節是因為它的位置特別：起點在市政廳前的首爾廣場，是五場裡最靠近市中心的起點；九月仍偏暖，這一場適合跑半馬而不是全馬。
...
> **快速解答**
> 對這篇的讀者，賭場最重要的一項不是錦標賽而是現金桌：全年、每天、24 小時開，不必等系列賽也能玩。門檻是護照、19 歲、非韓國公民（有海外永居除外）；跑完馬拉松想去的話，園區裡的 Spa 和三溫暖比牌桌更該先去。
...
- 園區內有 Spa 與三溫暖——剛跑完 42K 的話，這點很有用
...
> **快速解答**
> 七天是最短的可行單位，卡點是博覽會：JTBC 的賽事包只能本人在賽前三天到 SETEC 領，所以週六一定要在首爾。行程因此被倒過來排——先把週六釘在首爾，再往前後補上落地、比賽和牌局的日子。
...
:::note[本文的美元數字是在不同時間換算的粗估——上面的 APT 濟州主賽事買入用的是約 ₩1,500/$，這張表用的是約 ₩1,350/$。做預算前先查一下當下匯率。]:::
...
A. 開。Paradise City 賭場 24 小時營運。週日賽後入住對國際旅客是常態。現場的 Spa 與三溫暖特別受馬拉松跑者歡迎，很適合在傍晚牌局前先恢復一下。
