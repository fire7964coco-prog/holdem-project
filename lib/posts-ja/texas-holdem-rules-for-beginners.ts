...
> **先に結論**
> やってはいけない振る舞いは教わらないまま席に着く人がほとんどです。TDAルール70が「エチケット違反」として挙げ、ルール71で罰則対象にするのは8つ——遅延、他人の体・カード・チップに触る、順番無視、カードやチップを見えにくくする、ディーラーに届かない場所へのベット、暴言、身だしなみ、過度なおしゃべり。避ければ初めての卓でも浮きません。
