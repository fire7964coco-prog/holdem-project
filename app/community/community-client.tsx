...
export default function CommunityClient({
  ...
  useEffect(() => {
    ...
    const PAGE_TEASERS: FeedPost[] = !pageLocale ? [
      ...
      { id: "page:tournaments", type: "admin", language: "ko", title: "2026 홀덤 대회 일정", content: "WSOP 진행 중 · APT 인천(8/7)·APPT 코리아(9/3) 예정. 국내외 대회 일정 한눈에.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-07T00:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/tournaments", pageIcon: "🏆" },
      { id: "page:rules", type: "admin", language: "ko", title: "홀덤 규칙 완전 정리", content: "딜링부터 쇼다운까지 — 텍사스 홀덤 기본 규칙을 순서대로 정리했습니다.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-08T00:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/rules", pageIcon: "📋" },
      { id: "page:strategy", type: "admin", language: "ko", title: "홀덤 전략 가이드", content: "포지션·핸드 선택·3-bet·버블 전략까지. 실전에서 바로 쓰는 전략 모음.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-09T00:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/strategy", pageIcon: "⚡" },
      { id: "page:holdem-practice", type: "admin", language: "ko", title: "홀덤 연습장 🎮", content: "실제 핸드 상황을 시뮬레이션하며 폴드·콜·레이즈 판단력을 키워보세요.", imageUrl: null, likeCount: 0, commentCount: 0, createdAt: "2026-01-10T00:00:00Z", authorNickname: "HoldemMaster", authorAvatar: null, authorBadge: null, liked: false, pageHref: "/holdem-practice", pageIcon: "🎮" },
    ] : [];
