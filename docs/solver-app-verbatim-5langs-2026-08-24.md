...
> ⚠ **정정 2026-08-24 (M-053 지적 수용)**: 초판 §0·§2가 ①을 🟢로 적고 §7 통지 표에서 뺐는데,
> **랜딩(de·zh·zh-hant) 헤더 스스로는 ①을 «앱이 틀린 자리»로 넣고 정정본(체크 98.2%)으로
> 신설했다 — 랜딩 판단이 옳다**(교육 예제는 BB 첫 액션에서 멈추므로 «체크 다음»은 화면 밖 주장).
> 검수장이 **RP-20**으로 등재했다. 아래 표·§7에 ①을 추가하고 §2 ①의 🟢를 철회한다.
> ja·es 전수 축어(`docs/solver-app-verbatim-ja-es-2026-08-24.md`)로 **① = 8/8 전 언어** 확정.

| 자리 | 상태 | 언어 |
|---|---|---|
| **① `A♥7♦2♣` 「BB 체크 다음 BTN의 넓은 작은 C벳을 관찰」** | 🔴 **RP-20 — 8/8 전 언어**(정정 2026-08-24) | ko 원본 · 화면은 BB 첫 액션(체크 98.2%)에서 멈춘다 |
...
| 결함 | 언어 확인 | 정본 |
|---|---|---|
| ① 「BB 체크 다음 BTN 넓은 C벳 관찰」(RP-20 · 정정 2026-08-24 추가) | **8/8 전 언어**(ja·es는 `-ja-es-` 문서 실측) | 화면은 BB 첫 액션에서 멈춘다 — §4-B ① 체크 98.2% |
