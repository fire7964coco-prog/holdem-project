...
> **快速回答**
> 21 点的一靴牌会跨很多手连续发下去，出过的牌会改变剩下的分布，所以记牌有用；德扑每一手结束就重新洗，牌堆里没有任何东西可以累积。德扑里值得数的不是牌堆，而是眼前这一手：补牌、阻挡牌，以及你的底牌从对手范围里删掉了什么。
...
> **快速回答**
> 德扑里真正的算牌是三门活：数 outs——能把你这手牌变成赢牌的、尚未现身的牌，同花听牌有 9 张；用阻挡牌——你手里的牌减少了对手能拿到的组合，握着 A♠ 对手就凑不出坚果同花；追踪已死的牌——已经躺在牌面上的 out 不再算数。全在脑子里完成，全都合法。
...
大家容易搞混的是这一点：算牌在*21 点*里其实也不违法——它不是犯罪，只是心算而已。但在多数司法管辖区，赌场是私人生意，可以把疑似算牌的人赶走或拒之门外，因为算牌手让*庄家*亏钱。德扑把这套彻底反了过来：你打的是==别的牌手==，而不管谁赢，牌房只抽水（rake）。没有任何人有理由拦着你去数自己的 outs——所以"被赶出场"这个问题在这儿根本不存在。
...
> **快速回答**
> 不需要什么系统，三个习惯就够：每次听牌都数 outs，两张牌都会发出来时乘 4、否则只算下一张乘 2，胜率高过价格就跟；诈唬前问一问自己这手牌阻挡了什么；把已经明摆在牌面上的 out 减掉。这三件事全在脑子里完成，也全都合法。
