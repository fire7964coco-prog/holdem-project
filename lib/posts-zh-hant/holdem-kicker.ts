...
> **快速解答**
> 踢腳牌不是「你手上剩下的那張」，而是==最強五張裡、成牌以外剩下的那幾個位子==（一對有三個，兩對和四條只有一個）。誰坐得進去，是把七張牌全部排開之後才算出來的：公牌上只要有一張比你的底牌大，它就先卡位，你的底牌往後排 —— 排到五張以外，你的踢腳等於沒上場。
...
> **快速解答**
> 有——四條有一張踢腳，但在德州裡它幾乎從不決定勝負：那要兩位玩家湊到同一副四條，也就是四張全攤在公牌上，這種牌面很少見。
