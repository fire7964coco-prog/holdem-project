...
| 순위 | 할 일 | 왜 |
|---:|---|---|
| **1** | `apt-incheon-2026-guide` | **8/7 개막** — 남은 시간이 가장 짧다 |
| **2** | `holdem-masters-7th-guide` | 8/3 제8회 개막이 이미 지났다 → 결과 아카이브로 전환 |
| **3** | 대회·이벤트 가이드 나머지 8편 | [[event-guide-consistency-review]] fact-instance 전수 diff |
| 4 | `docs/update-calendar.md` | 8/5 WSOP 결과 6개 언어 |
| 5 | 다국어 글에 브레드크럼·태그 링크 소급 | 이번 6종의 한국어 전용분 |
