...
A. ブラインドを払う → ホールカード2枚 → プリフロップのベット → コミュニティカード3枚（フロップ）＋ベット → 1枚（ターン）＋ベット → 1枚（リバー）＋ベット → 最強の役が勝ち。合計でベットラウンド4回、コミュニティカード5枚、勝者は1人です。
...
A. 1ハンドは通常10〜60秒程度です。難しい判断が絡むマルチウェイの大きなポットでは数分かかることもあります。数時間のカジュアルなセッションで数十ハンドは回るので、1回の配りに一晩付き合う必要はありません。
