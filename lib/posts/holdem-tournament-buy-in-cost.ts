...
첫 대회라면 **참가비가 싸다고 무조건 좋은 것도 아니고, 비싸다고 무조건 좋은 것도 아닙니다.** 중요한 건 내 뱅크롤(대회용 예산)에서 한 번 탈락해도 멘탈이 흔들리지 않는 금액이어야 한다는 점입니다.
...
단, 새틀라이트는 "싸게 들어가는 확정 티켓"이 아닙니다. 입상해야 시트가 나오기 때문에 여러 번 도전할 예산과 시간이 필요합니다. 그래도 초보 입장에서는 직접 250만 원을 내는 것보다, 35만~50만 원대 위성에서 경험을 쌓으며 시트를 노리는 편이 훨씬 현실적입니다.
