...
> **快速解答**
> 韓國撲克錦標賽：==**APT 仁川 8/7–16**==、==**APT 濟州 9/25–10/7**==（都在僅限外國人的賭場）。韓國馬拉松：==**春川 10/25**==、==**JTBC 首爾 11/1**==、==**Garmin Run 11/15**==。APT 濟州 10/7 結束 → 春川馬拉松 10/25 開跑——==g:中間隔 18 天，一趟行程全吃。== ==r:2026 年馬拉松報名只有 JTBC，截止 9/4——春川與 Garmin 都已額滿。==
...
| ==**JTBC 首爾馬拉松**== | ==**11/1**== | 全馬、10K | 首爾（上岩） | [worldsmarathons.com](https://worldsmarathons.com/marathon/international-seoul-marathon) | ==r:外國人報名到 **2026 年 9 月 4 日**== ——名額有限，抽籤分配 |
...
馬拉松集中在 10–11 月，但 ==**Paradise City 賭場**== 是全年營運的。它不是只辦錦標賽的場館——現金桌每天都為國際牌手開著。
...
要記下的日期：==**春川 10/25**==、==**JTBC 首爾 11/1**==、Garmin Run 11/15——2026 年唯一的報名管道是 JTBC，截止 9/4。Paradise City 全年開放。
