...
**Q. 补牌超过 9 张时，二四法则为什么会高估？怎么修正？**

A. 因为 ×4 把"在翻牌和转牌两条街都击中"的那点小概率重复算了一遍，一旦补牌超过 8 张就会往上冲。看差距：12 张补牌，法则说 48%、真值只有 45%；15 张补牌，法则说 60%、真值 54.1%。修正法很简单——翻牌圈补牌超过 8 张时，乘 4 之后再减去 *(补牌 − 8)*。15 张补牌：(15 × 4) − 7 = 53%，几乎分毫不差。8 张或更少的日常听牌，直接 ×4、×2 就够。
