...
> **快速回答**
> 重要。只要两手牌的前四张一样，第五张牌就是整个底池——一对的第三张踢脚牌、同花最小的那张、牌面四条旁边的那张单张，都是这种情况。它只在公共牌本身大过你的底牌时才不再重要。
...
A. 重要——而且这是玩家把一个自以为稳赢的底池输掉的最常见方式。三种情形把整个底池压在最后一张牌上：一对的第三张踢脚牌、同花最小的那张、以及牌面四条旁边的那张单张。只有当公共牌本身大过你手里的牌，它才不再重要——那时你的底牌整个掉出这手牌，你在打公牌。
