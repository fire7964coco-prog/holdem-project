...
| ==**JTBC 首爾馬拉松**== | ==**11/1**== | 全馬、10K | 首爾（上岩） | [worldsmarathons.com](https://worldsmarathons.com/marathon/international-seoul-marathon) | 開放外國人報名（很快額滿——請查詢） |
...
A. 帶好非韓國護照（韓國國民不得進入，這條沒有例外）、年滿 19 歲。從仁川機場第一航廈搭免費接駁約 10 分鐘就到，落地不必先進市區。想先熟悉錦標賽的買入、盲注結構與衛星賽怎麼運作，可以先看[德州撲克錦標賽入門指南](/zh-hant/blog/holdem-tournament)。
