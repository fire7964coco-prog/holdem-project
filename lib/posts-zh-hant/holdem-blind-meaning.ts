...
> **快速解答**
> 盲注不是固定在某兩個人身上，而是跟著莊家鈕走：每打完一手，鈕往左移一個座位，盲注也跟著移。所以每個人每一圈都會各付一次小盲和一次大盲，誰都跳不過自己那一輪。
...
> **快速解答**
> 分兩種情況：新坐下的人通常要補一個大盲才能立刻開打，或乾脆等盲注輪到自己；而中途離桌漏掉盲注的人回座要補，其中漏掉的小盲會變成一枚死籌碼，直接收進底池、不算你的注。
