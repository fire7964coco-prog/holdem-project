    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-serif font-black text-xl text-gold-gradient">HoldemMaster</span>
            </div>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Clear, practical Texas Hold&apos;em strategy.
              <br className="hidden md:block" />
              Guides that explain not just what beats what, but why.
            </p>
          </div>
          ...
          <nav aria-label="Content menu">
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                { href: "/en/blog", label: "Strategy Blog" },
                { href: "/en/blog/holdem-hand-rankings", label: "Poker Hand Rankings" },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
        ...
        <div className="border-t border-primary/12 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground leading-relaxed">
          <p>&copy; {new Date().getFullYear()} HoldemMaster. All rights reserved.</p>
