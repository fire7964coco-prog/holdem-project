...
export const POST: Post = {
  ...
  content: `
APPT(Asia Pacific Poker Tour)가 6년 만에 한국으로 돌아옵니다. 2026년 9월, 인천 파라다이스 시티에서 열리는 APPT 코리아 2026 — 초보자도 어떻게 참가하는지 처음부터 끝까지 설명합니다.
...
APPT는 PokerStars가 주관하는 아시아 태평양 최고 권위의 포커 투어입니다. 한국에서 마지막으로 열린 건 2020년 — **6년 만의 귀환**입니다.
...
APT 인천은 8월 7~16일, APPT 코리아는 9월 3~14일입니다. 한 달 간격으로 같은 장소에서 열립니다. 두 대회 모두 파라다이스 시티 카지노이므로, **미리 파라다이스 시티 멤버십 카드를 만들어두면 두 번째 방문부터는 입장이 훨씬 빠릅니다.**
...
② <strong style="color:var(--foreground)">Security</strong> → <strong style="color:var(--foreground)">Identity Verification</strong><br/>
③ 여권 또는 운전면허증 앞면 사진 업로드<br/>
...
A. 가능합니다. 두 대회 모두 인천 파라다이스 시티에서 열리고, 각각 8월과 9월로 한 달 간격입니다. APT에서 이미 Paradise Card를 발급받았다면 APPT에서 재사용할 수 있습니다. 단, 양쪽 모두 바이인이 필요하므로 충분한 뱅크롤을 준비해야 합니다.
