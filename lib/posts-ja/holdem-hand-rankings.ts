...
→ A♥ がボードの A♠ とペアになり、**KKK + AA のフルハウス**。ただし相手も*エースを1枚持っていて、しかも最後のKでなければ*、同じフルハウスで引き分け(スプリット)。上を行かれるのは2パターンだけ——相手がポケットA-Aならエースフルの大きいボート、エースと最後のK1枚ならKのフォーカードです。相手がエースを持たず小さいペアだけなら、あなたのボートが勝ちます。教訓:ボードが仕事の大半をしているとき、あなたの手はカード1枚分しか強くないことが多い。
