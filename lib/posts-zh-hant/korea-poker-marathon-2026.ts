...
export const POST: Post = {
  ...
  desc: "十月到十一月飛韓國：APT 仁川、濟州錦標賽接軌春川、JTBC 首爾馬拉松，仁川機場十分鐘就有 Paradise City 賭場。附完整賽程與外國人報名攻略。",
...
| ==**YTN 首爾旅遊馬拉松**== | ==**9/6**== | 半馬、11K | 首爾廣場 | [run.ytn.co.kr](http://run.ytn.co.kr) | 7/10 已截止 |
...
**賽事本身：** 創辦於 1946 年——韓國第二古老的馬拉松。==g:AIMS 認證的國際賽道==——僅次於世界馬拉松大滿貫的全球標準。全馬 42.195K ＋ 10K。起點在孔之川橋，早上 9:00 起跑。賽道繞行 ==**衣岩湖**==（의암호）——一座被群山環抱的水庫，在十月底層林盡染。比賽日氣溫通常落在 8–14°C，是能跑出個人最佳的條件。
...
==r:去年名額不到 3 分鐘就售罄。開放的當下，護照號碼和付款方式都要先準備好。==
...
**賽道：** 起點在 ==上岩世界盃體育場==（地鐵 6 號線，上岩世界盃體育場站）。路線穿過德壽宮、光化門廣場與東大門——把首爾的歷史與現代身分一次掃過。全馬終點在 ==奧林匹克公園==；10K 終點在 ==汝矣島公園==。全馬關門時間：5 小時。
...
**如何報名（外國人）：**
居住在韓國以外的外國跑者，一律透過 ==**[worldsmarathons.com](https://worldsmarathons.com/marathon/international-seoul-marathon)**== 報名。==r:名額有限、很快就滿==，請上官方頁面查詢最新剩餘名額——注意 2026 年 9 月 4 日是取消／退費的截止日，而非報名截止日。持韓國護照者不適用此管道。

==g:JTBC 的外國人名額有限——趁滿之前早點報名。==

**賽後 → 玩牌：** JTBC 賽道結束在首爾市中心。從首爾站（或弘大）搭 AREX 各站停 → 在第一航廈轉 Paradise City 接駁車，全程約 1 小時。多數跑者中午前就完賽——下午安排一場現金桌是很實際的。
...
- **保證獎池：** ==g:136 場獎盃賽事、總保證獎池 $3.5M+==（主賽事買入待公布）
...
對一個已經在韓國打錦標賽的牌手來說：比賽早晨是 7 點的鬧鐘、42K 穿過首爾市中心、中午前在奧林匹克公園完賽。下午 2 點回到 Paradise City，牌桌還在開。這是真的做得到——而且幾乎沒人在寫這個重疊。
