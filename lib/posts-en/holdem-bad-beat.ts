...
Some cardrooms turn the pain into a prize. A **bad beat jackpot** is a progressive pot — built from a small extra drop taken out of pots as they're played — that pays out when a very strong hand loses at showdown. The idea is to reward the player who suffers a spectacular beat, and the payout is often life-changing.
...
*By the bar above, this technically isn't even a bad beat — Phillips was already ahead on the turn, and the chips only went in after the last card fell, so nobody sucked out. But poker remembers it as the most famous bad beat ever dealt, and the name stuck.*
...
A. No — in almost every case they're opposites. A bad beat means your money went in as the favorite — usually because you made the *correct* decision — and then luck beat you. Being the favorite isn't proof on its own that the decision was right: a bad sizing, or an ICM spot where the pot wasn't worth contesting, can still make getting those chips in a mistake. Losing because *you* made a bad call or a loose play isn't a bad beat, it's a mistake. Honest players are careful not to file their own errors under "bad beat," because that's how leaks go unfixed.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/en/blog/holdem-cooler" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">What Is a Cooler?</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">The loss with no suckout — in the strict sense, no bad beat</div>
  </a>
  <a href="/en/blog/holdem-fish" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Glossary</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">What Is a Fish?</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">The player whose suckouts pay your bills</div>
  </a>
  <a href="/en/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Know when you're the favorite in the first place</div>
  </a>
  <a href="/en/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Who Wins at Showdown</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">How the winning hand is actually decided</div>
  </a>
</div>
`.trim(),
};
