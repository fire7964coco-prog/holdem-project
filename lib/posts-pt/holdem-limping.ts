...
export const POST: Post = {
  ...
  imageAlt: "Um jogador de poker deslizando fichas em silêncio para só pagar o big blind no pré-flop enquanto os outros esperam, ilustrando um limp passivo",
...
## O que "limpar" significa no poker?
...
O mais útil disso no dia a dia é **over-limpar pares baixos de bolso.** Um par de dois até, digamos, setes flopa um set ou melhor só cerca de **11,8% das vezes** (aproximadamente 1 em 8,5), então sozinhos eles não valem a pena para montar um pote grande. Mas limpar *atrás* de outros limpers por um preço barato, num pote multiway onde você vai ser pago quando acertar, joga as [implied odds](/pt/blog/holdem-pot-odds) a seu favor. Você está fazendo set-mining — e essa é uma razão legítima para limpar junto. Só note que o chão está se mexendo debaixo do mantra "nunca limpe": o trabalho recente com solvers reabilitou o limp em silêncio num punhado de spots rasos e multiway. É nuance, não uma licença para open-limpar o seu range inteiro.
...
Em **jogos ao vivo de stakes muito baixas e passivos**, é um mundo diferente. Se a mesa rotineiramente deixa limpers verem flops baratos e ninguém os pune, limpar mãos especulativas custa bem menos — você não está sendo isolado, e consegue realizar equity com mãos que preferem não encarar um aumento. Ainda não é *ótimo* (e o open-limp de posição inicial segue sendo a pior versão da jogada), mas a penalidade é pequena, e set-mining num family pot pode imprimir dinheiro. Leia a sua mesa: quanto mais soft e passivo o jogo, mais dá pra limpar impunemente; quanto mais difícil o jogo, mais estritamente você deve aumentar ou foldar.
...
**Q. O que significa limpar no poker?**
...
**Q. Por que limpar é ruim no poker?**
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/pt/blog/holdem-position-play" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Por que limpar fora de posição machuca mais</div>
  </a>
  <a href="/pt/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">O que vale mesmo a pena aumentar</div>
  </a>
  <a href="/pt/blog/holdem-fish" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">O que é um peixe?</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Os hábitos passivos que marcam um jogador fraco</div>
  </a>
  <a href="/pt/blog/holdem-glossary" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Glossário</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Termos de poker de A a Z</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Cada pedaço do vocabulário da mesa, explicado</div>
  </a>
</div>
`.trim(),
};
