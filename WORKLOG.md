...
- **빌드 ✅ "54 blog posts"**(53→54). 포지션 허브 2→3편.
- **⏳ 남은 것(이미지 [E])**: 히어로 `holdem-blind-steal-hero.webp` + 본문 `holdem-blind-steal-action.webp` 2개 생성 대기 → 빌드·커밋·푸시·GSC 색인 `/blog/holdem-blind-steal`. **아직 미배포**(이미지 대기).
