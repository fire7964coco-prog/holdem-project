...
⚠ **No leas esto como "mientras mejor el kicker, más grande la apuesta" — la tabla va al revés.** La frecuencia de apuesta grande va K♠6♠ 7.8% < Q♥6♥ 7.9% < **J♥6♥ 9.0%**: el kicker más débil es el que más apuesta. Tampoco lo explican los blockers de trips. El seis que tengas le quita al botón los trips de su propio palo — con K♠6♠, Q♥6♥ o J♥6♥ al botón le quedan exactamente 10 de sus 20 — y el kicker no le quita nada más, porque el botón abre K6 y Q6 solo suited y tu seis ya se llevó ese palo. La tabla muestra la mezcla calculada; no aísla la causa de una diferencia tan pequeña.
