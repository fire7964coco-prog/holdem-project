...
Angenommen, du hältst A-K und dein Gegner hält A-Q, und das Board pairt ein Ass. Ihr habt beide „ein Paar Asse“ – identischer Rang. Jetzt entscheiden die Beikarten, und dein König schlägt seine Dame. Niemand hat die bessere Hand gemacht; der Kicker hat einfach seinen stillen Job erledigt.
...
A. Ja – ein Drilling nutzt zwei Kicker. Machen zwei Spieler denselben Drilling, entscheiden die nächsten beiden Karten von oben: Auf einem Board 9♠ 9♥ 9♦ A♣ 3♦ schlägt 9-9-9-A-K das 9-9-9-A-Q, weil der zweite Kicker – der König – die Dame schlägt. Ein echtes *Set* aus einem Pocket-Paar landet dagegen selten im Gleichstand, weil nur ein Spieler genau dieses Paar halten kann.
...
A. Eine Menge. Weil alle die Gemeinschaftskarten teilen, machen Spieler häufig dasselbe Paar oder denselben Drilling, und der Kicker entscheidet diese Pots. Hände mit starken Kickern zu wählen (und dominierte zu folden) ist ein Kernbestandteil eines gewinnbringenden Spiels.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/de/blog/holdem-hand-rankings" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Pokerhände-Reihenfolge</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Die komplette Ordnung, unter der ein Kicker sitzt</div>
  </a>
  <a href="/de/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Hand-Rankings</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Wie Gleichstände gebrochen werden</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Komplette Tiebreaker-Reihenfolge für jede Hand</div>
  </a>
  <a href="/de/blog/holdem-starting-hands-chart" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Warum Asse mit schwachem Kicker gefoldet werden</div>
  </a>
  <a href="/de/blog/holdem-reading-the-board" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Wie man das Board liest</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Erkenne, wann du das Board spielst</div>
  </a>
</div>
`.trim(),
};
