...
export const CALC_DICT_ES: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "Par servido con buen potencial de set", action: "Subir en tardía; en temprana paga una subida y, si nadie ha entrado, sube o foldea — no hagas open-limp" },
      ...
      "55": { desc: "Poco valor sin ligar set", action: "Si nadie ha entrado, sube desde tardía; paga una sola subida en tardía si quedan detrás unas 15 veces lo que pagas" },
      ...
      A3s: { desc: "Carta de rueda + proyecto de color al nuts, un escalón por encima de A2s", action: "Solo BTN/SB" },
      ...
      "44": { desc: "Casi sin valor si no liga set", action: "Si nadie ha entrado, sube desde tardía; paga una sola subida en tardía si quedan detrás unas 15 veces lo que pagas" },
