...
export const POST: Post = {
  ...
  tldr: "盲抓（Straddle）是發牌前自願下的一注盲注——通常是大盲的兩倍。它替盲抓者買到翻前最後行動、以及加注的權利，把整場的底池加倍。但幾乎所有情況下它都是 -EV，而且幾乎都只限現金桌、按各家撲克室規則才允許。",
  category: "glossary",
  date: "2026-07-23",
  updated: "2026-09-09",
...
就算在現金桌，它也是可選的、看各家規則：有些撲克室只允許槍口位盲抓，有些允許密西西比和按鈕位盲抓，有些限制大小，有些禁止再盲抓。線上盲抓很少見，有提供的地方通常也只是一個簡單的槍口位盲抓開關。像這樣的現金桌下注、跟僵硬的錦標賽賽制之間，位置怎麼運作也差很多——延伸閱讀[位置怎麼打](/zh-hant/blog/holdem-position-play)。
