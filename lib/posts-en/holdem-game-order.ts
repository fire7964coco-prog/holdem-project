...
![A full Texas Hold'em hand example — from preflop to showdown](/images/holdem-game-example-fullhand.webp "Following one complete hand through every street to showdown")
...
A raises to **6,000** with Big Slick. B calls with pocket nines.
**Pot: 12,000**
...
B checks, A bets **15,000** (about half pot), B calls.
**Pot: 58,000**
...
| 2 | Straight Flush | 5♥ 6♥ 7♥ 8♥ 9♥ | Very rare |
| 3 | Four of a Kind | A♠ A♥ A♦ A♣ K♠ | Rare |
| 4 | Full House | K♠ K♥ K♦ A♠ A♥ | Uncommon |
| 5 | Flush | A♠ K♠ 8♠ 5♠ 2♠ | Uncommon |
| 6 | Straight | 5♥ 6♠ 7♦ 8♣ 9♥ | Occasional |
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/en/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Full rules, chips, hand rankings + printable PDF</div>
  </a>
  ...
  <a href="/en/blog/holdem-positions" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Seat map, opening ranges, and why position wins</div>
  </a>
</div>
`.trim(),
};
