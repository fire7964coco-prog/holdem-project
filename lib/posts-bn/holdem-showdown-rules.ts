...
- **face-down muck করতে পারে** যদি বুঝে যায় হেরে গেছে — নিজের কার্ড দেখানোর দরকার নেই। তবে এটা কেবল ততক্ষণই, যতক্ষণ কেউ all-in হয়নি: কোনো খেলোয়াড় all-in হওয়ামাত্র TDA নিয়ম ১৬ ওই pot-এর প্রতিটি হ্যান্ড খোলা বাধ্যতামূলক করে দেয় এবং কেউই muck করতে পারে না

==r:কিন্তু একটা গুরুত্বপূর্ণ ব্যতিক্রম আছে:== আপনার river bet যদি call হয়ে থাকে, তাহলে call করা লোকটা আপনার হ্যান্ড দেখার পুরো দাম দিয়েছে। dealer-কে বলা যে muck হয়ে যাওয়া হ্যান্ডটা উল্টে দেখানো হোক — এটাই **"I want to see that hand"** নিয়ম। টুর্নামেন্টে ==TDA নিয়ম ১৮== এর গণ্ডি খুব সংকীর্ণ করে টানে: showdown-এর সময় যার হাতে আর কার্ড নেই, কিংবা যে মুখ নিচে muck করে দিয়েছে, সে চাওয়ার অধিকার হারায়। এই অধিকার অলঙ্ঘনীয় কেবল তার, যে river-এর bet call করেছে এবং নিজের কার্ড খুলেছে বা ধরে রেখেছে — আর তাও কেবল ==last aggressor==-এর হ্যান্ডের উপরে, যে হ্যান্ড দেখার দাম সে দিয়েছে। বাকি সব টুর্নামেন্ট ডিরেক্টরের বিবেচনা; cash game-এ অনেক cardroom এটা আরও উদারভাবে প্রয়োগ করে। (এটাকে "show one, show all"-এর সাথে গুলিয়ে ফেলবেন না, যার মানে হলো আপনি যদি নিজের কার্ড স্বেচ্ছায় কোনো একজন খেলোয়াড়কে দেখান, তাহলে টেবিলের সবাই সেটা দেখার অধিকার পায়।)

ব্যবহারিক নিয়ম: ==last aggressor হিসেবে আপনিই কার্ড উল্টাবেন — call হয়ে যাওয়া bluff-ও।== মুখ নিচে muck করাটা caller-এর বিকল্প, bettor-এর হ্যান্ড দেখার পরে। bet করে দ্রুত muck করলে দুবার ঠকবেন: caller তবুও আপনার হ্যান্ড দেখতে চাইতে পারে, আর cards speak বলে অনেক pot এমন খেলোয়াড়ই ফেলে দিয়েছেন যাঁর ace-high আসলে এগিয়ে ছিল।
...
| river-এ করা all-in bet call হয়ে যায় | all-in করা খেলোয়াড় last aggressor হিসেবে আগে দেখায় — কিন্তু ==r:এখানে কেউই muck করতে পারে না==: TDA নিয়ম ১৬ অনুযায়ী caller-কেও হ্যান্ড খুলতে হয় |
| একাধিক all-in যা থেকে একাধিক side pot তৈরি হয় | প্রতিটা pot আলাদা করে মীমাংসা হয়; জড়িত সব হ্যান্ড দেখানো হয় |

</div>

একটা সূক্ষ্মতা: যদি কোনো **side pot** থাকে (বাকি খেলোয়াড়দের কাছে এখনো chips আছে আর তারা betting চালিয়ে যায়), তাহলে side pot আগে দেওয়া হয়, তারপর main pot। এটা **টাকা দেওয়ার ক্রম**, কার্ড কখন খোলা হবে তার সঙ্গে এর সম্পর্ক নেই: all-in খেলোয়াড়ের হ্যান্ড তো তখনই খোলা পড়ে থাকে যখন আর কোনো betting সম্ভব নয়। TDA-র নিয়ম ১৬-এর উদাহরণে সরাসরি লেখা আছে — all-in-এর হ্যান্ড উল্টানোর জন্য side pot ভাগ হওয়া পর্যন্ত অপেক্ষা করবেন না।
...
এটা দুই দিকেই কাজ করে। আপনার যদি মনে হয় আপনি হেরে গেছেন আর না দেখিয়ে muck করে দেন, অথচ আপনার হ্যান্ডই জেতার কথা ছিল — ==r:তাহলে pot গেল==। dealer যখন হ্যান্ডটি muck-এ ঠেলে দেন আর সেটি আর স্পষ্টভাবে চেনা যায় না, তখনই কেবল হ্যান্ড মরে — মুখ নিচে রাখা কার্ড আপনাআপনি মরে যায় না (TDA নিয়ম ১৪)। তবু কখনও এর উপর ভরসা করবেন না। আপনি 100% নিশ্চিত না হলে muck করার আগে সবসময় dealer-কে আপনার হ্যান্ড পড়তে দিন।
...
showdown-এ — অর্থাৎ সব betting শেষ হয়ে যাওয়ার পরে — আনুষ্ঠানিকভাবে নিজের পালা আসার আগে হ্যান্ড উল্টানোর বিরুদ্ধে কোনো নিয়ম নেই। কিন্তু হ্যান্ড যতক্ষণ চালু আছে আর কোথাও action বাকি আছে, ততক্ষণ উল্টোটাই সত্য: কার্ড দেখালে ==WSOP নিয়ম ১১৭== অনুযায়ী শাস্তি হয়। ==g:আপনার কাছে nuts বা কোনো খুব শক্তিশালী হ্যান্ড থাকলে, সাথে সাথে দেখিয়ে দিন।== বাকি খেলোয়াড়রা এটার কদর করে। এতে খেলা দ্রুত হয়। আর এটা slow rolling-এর ঠিক উল্টো।
...
A. হ্যাঁ — আপনি যদি river-এ সবার শেষে bet বা raise করা খেলোয়াড় হন, তাহলে call পেলে আপনাকে আগে দেখাতে হবে। আপনি যদি অন্য কারো bet call করে থাকেন, তাহলে তার হ্যান্ড দেখার পর, হারলে আপনি face-down muck করতে পারেন। ব্যতিক্রম হলো all-in: TDA নিয়ম ১৬ অনুযায়ী caller-কেও হ্যান্ড খুলতে হয়। আর টুর্নামেন্টে হ্যান্ড দেখতে চাইতে পারে কেবল সে-ই, যার হাতে এখনো কার্ড আছে বা যে কার্ড খুলে দিয়েছে — অলঙ্ঘনীয়ভাবে, শুধু last aggressor-এর হ্যান্ডের ক্ষেত্রে।
