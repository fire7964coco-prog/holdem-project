...
| **Cooler vs Bad Beat** | Cooler（冷牌）＝你一路落後又蓋不掉；Bad Beat（爆冷）＝你本來領先卻被對手超車。 |
...
| **抽水（Rake）** | 牌房從每個底池抽的一小份。 |
| **抽水返還（Rakeback）** | 把你付過的抽水退一部分回來的回饋。 |
| **盲抓／抓頭（Straddle）** | 一個可選的額外盲注（通常 2× BB），買下翻牌前最後的行動權。 |
