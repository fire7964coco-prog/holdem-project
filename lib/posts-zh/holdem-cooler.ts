...
| Cooler | 对撞 | 为什么你弃不掉 |
|:---|:---|:---|
| **KK 对 AA** | KK 翻前全下对上 AA | KK 面对 AA 处在约 4.5:1 的下风，但翻前你绝不会弃掉 KK |
...
> **快速回答**
> 三种说法说的是同一场灾难：setup 是 cooler 的非正式近义词，强调「被摆了一局」的感觉；「被 cooler 了」是站在输家那一端，等于承认你打得对却还是输了；cold deck 是更老的说法，随口用时就是指牌运狠狠跟你作对，历史上还指过一种换牌作弊手法。
...
A. 是——它是所有 cooler 里最经典的一个。翻前 KK 面对 AA 处在大约 4.5:1 的下风，但没有哪个讲道理的牌手会在翻牌前弃掉口袋 KK。于是筹码进了池，你自始至终落后，输掉一手你本就不可能躲开的牌。
