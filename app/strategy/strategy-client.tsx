    ...
    <>
      <SEO
        /* 🔴 2026-08-29 — page.tsx의 서버 metadata와 **같아야 한다**(seo.tsx가 런타임에 덮어쓴다).
           🪶 구 클라이언트 훅 「온라인홀덤 이기는 법」은 §17상 좋은 카피였지만, 서버 메타가 이미
              §17로 경화된 정본이라 그쪽을 택했다. 훅을 되살리려면 **서버를 고치고 여기를 맞춰라**
              (반대로 하면 원시 HTML과 렌더 후 DOM이 갈린다). 정본 = settled-decisions §6. */
        title="홀덤 전략 주제별 모아보기 — TAG·포지션·레인지·팟오즈"
        description="타이트 어그레시브부터 포지션·스타팅 핸드·레인지 리딩·세미 블러핑·팟오즈까지, 홀덤 전략 주제를 한 화면에 모았습니다. 각 주제의 상세 가이드로 바로 이동하세요."
