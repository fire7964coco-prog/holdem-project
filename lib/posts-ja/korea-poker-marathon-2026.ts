...
> **先に結論**
> 韓国のポーカートーナメント: ==**APT仁川 8/7〜16**==、==**APT済州 9/25〜10/7**==(どちらも外国人専用カジノ)。韓国のマラソン: ==**春川 10/25**==、==**JTBCソウル 11/1**==、==**ガーミンラン 11/15**==。APT済州は10/7に終了 → 春川は10/25スタート。==g:間は18日間、一度の旅で両方カバーできる。==
...
**カジノの立地:** パラダイスシティ・カジノは、==g:仁川国際空港に物理的に隣接した==リゾート複合施設の中にあります。ターミナル1からの無料シャトルが30分ごとに運行。カジノは通年でキャッシュゲームのテーブルを開いており、トーナメントに参加する必要はありません。海外のプレイヤーにとって、アジアで最もアクセスしやすいカジノです——仁川に着いて、チェックインして、プレー。
...
**基本情報:**
- 場所: 仁川、仁川国際空港のすぐ隣
- 無料シャトル: ターミナル1(ゲート3C・14C)、30分ごと、乗車約10分
- ホテル: ホテルパラダイス、5つ星、施設内
- 外国人専用のカジノです — ==g:日本のパスポートを見せればそのまま入場できます==
- 年齢: 19歳以上、有効な韓国以外のパスポート
...
一番きれいな「二毛作」ルートはこう: APT仁川(8/7〜16) → ソウルで休養 → 春川マラソン(10/25)またはJTBC(11/1)。あるいは: APT済州(9/25〜10/7) → 韓国で18日間 → 春川(10/25)。
...
A. はい——1週間の間隔です。春川はソウルから電車で約80分。日曜に春川を走り、月〜土でリカバリーして、翌日曜にJTBCを走る。韓国のランナーには、こうして連続週で走る人が大勢います。ただしリカバリーの時間は多めに見ておくこと。春川のコースには坂があります。
...
A. はい。chuncheonmarathon.comの外国人エントリータブは、海外からの参加者向けに設計されています。必要なのはパスポート番号、メール、決済手段です。レースキットはレース前に会場で配布されます。
...
ブックマークしておくべき日付: ==**春川 10/25**==、==**JTBCソウル 11/1**==、ガーミンラン 11/15。パラダイスシティは通年営業。
