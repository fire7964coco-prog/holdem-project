...
**Ketika uang sudah dekat, turnamen beralih ke "hand-for-hand" — setiap meja memainkan persis satu hand pada waktu yang sama, lalu menunggu — khusus untuk menghentikan pemain melakukan stall ke dalam uang.** Tanpa itu, pemain di meja lambat bisa fold hand demi hand sementara meja lebih cepat membakar bubble. Hand-for-hand meratakan medan:

- **Cara kerjanya:** tournament director menjeda jam, dan sejak itu setiap hand memotong ==2 menit== tetap dari level, tak peduli berapa lama hand itu sebenarnya berlangsung (WSOP Tournament Rule 126.a dan 126.c; TDA RP-8-C dan RP-8-D) — jadi blind tetap naik sepanjang bubble, hanya saja per hand, bukan per menit nyata. Semua meja membagikan satu hand, dan tidak ada meja yang memulai hand berikutnya sampai setiap meja selesai. Jika dua pemain bust pada hand-for-hand yang sama di **meja yang sama**, yang chip-nya lebih sedikit di awal hand mendapat finis lebih rendah (bubble); kalau mereka bust di **meja berbeda**, keduanya dianggap seri untuk posisi itu (WSOP Tournament Rule 126.b) dan pada praktiknya membagi dua hadiah yang terlibat. Satu kasus ditulis sama di kedua rulebook: untuk satu hand yang masih berjalan saat hand-for-hand diumumkan, WSOP 126.c maupun TDA RP-8-A sama-sama membuat semua yang bust di hand itu berbagi posisi (atau posisi-posisi) yang dibayar. Pastikan house rule-nya sebelum Anda mengandalkan naik satu tingkat pembayaran.
- **Stalling:** memakai seluruh time bank pada setiap keputusan dengan harapan melihat lebih sedikit hand sebelum masuk uang. Selama hand-for-hand harapan itu keliru: stalling tidak mengurangi jumlah hand yang harus dimainkan meja Anda — setiap meja menjalankan jumlah hand yang sama dan tiap hand memotong 2 menit dari jam (WSOP Tournament Rule 126.a, 126.c), mau Anda fold seketika atau menghabiskan seluruh time bank. Big stack tidak punya alasan untuk stall — mereka ingin lebih banyak hand untuk menyerang. Short dan medium stack tetap saja stall karena kebiasaan, ==tapi stalling berlebihan bisa mengundang clock call atau penalti== — tank sewajarnya, tanpa sengaja membakar time bank Anda.
...
- **Begitu kursi Anda secara matematis aman** (Anda cukup jauh di dalam bubble sehingga tak bisa terkejar), fold setiap hand — ya, bahkan AA dan KK — dan biarkan short stack bertarung sendiri. Hitung ulang matematika itu setiap kali blind naik: "zona aman" menyusut begitu ante mulai berlaku.
- **Jangan mengandalkan stalling di live.** Online, memakai seluruh clock Anda tidak membawa penalti; di live, sengaja membakar time bank demi naik tangga hadiah secara eksplisit bisa kena penalti: WSOP Tournament Rule 80 menyebut langsung tindakan sengaja menghabiskan time bank demi naik tangga hadiah, dan mengarahkannya ke clock yang dipangkas atau penalti menurut Rule 40, 113, dan 114 — fold dengan tempo normal dan biarkan short stack bertarung.
...
A. Di dekat money bubble, semua meja memainkan persis satu hand secara bersamaan lalu menunggu setiap meja selesai sebelum hand berikutnya. Ini ada untuk mencegah stalling — tanpanya, pemain bisa fold pelan-pelan di satu meja untuk menyelinap ke dalam uang sementara meja lain memecahkan bubble lebih cepat.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-icm" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Matematika di balik kenapa bubble penting</div>
  </a>
  <a href="/id/blog/holdem-tournament" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Turnamen</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Strategi Turnamen</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Pilar tempat bubble bernaung</div>
  </a>
