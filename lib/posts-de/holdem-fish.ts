...
export const POST: Post = {
  ...
  seoTitle: "Was ist ein Fish beim Poker – und bist du es selbst?",
  ...
  imageAlt: "Ein entspannter Freizeitspieler am Pokertisch schiebt einen großen Stack Chips in den Pot, während schärfere Gegner ihn still beobachten",
  tags: ["fish", "was ist ein fish beim poker", "fish poker bedeutung", "fish beim poker erkennen", "fish vs shark", "bin ich der fish", "poker spielertypen", "wie man aufhört ein fish zu sein"],
  content: `
...
:::stripe
Schwach / verlierend | Was „Fish“ bedeutet
Shark | Das Gegenteil – der gewinnende Spieler
40–70% | Der typische VPIP eines Fish (gespielte Hände)
„Don't tap the glass“ | Verschreck den Fish niemals
:::
...
Limpt ständig | Callt den Big Blind, statt zu raisen oder zu folden, immer und immer wieder
...
/de/blog/holdem-starting-hands-chart | Welche Hände es wert sind, gespielt zu werden | /images/holdem-starting-hands-chart-hero.webp
/de/blog/holdem-pot-odds | So berechnest du Pot Odds | /images/holdem-pot-odds-hero.webp
:::
...
A. Ein Whale ist ein bestimmter Typ Fish – einer, der *große* Geldbeträge verliert, meist ein wohlhabender Spieler, der bei hohen Stakes loose zockt. Alle Whales sind Fische, aber nicht alle Fische sind Whales. Die Anwesenheit eines Whale an einem Tisch ist das, was die geübten Sharks ins Spiel zieht, denn dort liegt das große Geld.

**Q. Was ist der Unterschied zwischen einem Fish und einem Donkey?**
