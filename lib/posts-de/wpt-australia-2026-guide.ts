...
**Warum 2026 größer ist**: Das Dual-Championship-Format bedeutet zwei getrennte Chancen auf den WPT Champions Cup. Internationale Spieler mit einer Bankroll auf $1.500-Level haben jetzt einen realistischen Weg zur Trophäe, ohne $5.000 committen zu müssen.
...
| WPT Champions Cup | ✅ Ja | ✅ Ja + WC-Seat |
...
### On-Site-Satellite-Wege (basierend auf der 2024/2025-Struktur)

<div style="background:rgba(255,248,210,0.08);border:1px solid rgba(255,240,180,0.25);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| Weg | Format | Buy-in | Gewinn |
|:---:|---|---|---|
| **Step 1 → Step 2** | zweistufiger Qualifier | ==g:AUD ~$255 gesamt== | WPT-Championship-Seat |
| **Direct Qualifier** | 1-in-8-Satellite | AUD ~$1.075 | WPT-Championship-Seat |
| **On-Site während des Festivals** | tägliche Satellites, 10.–22. Sep | verschieden (AUD $200–600) | Prime- oder Championship-Seat |
...
> **36 Events insgesamt.** GTD-Prize-Pools werden unter NSW-Regulierung nicht ausgeschrieben, aber das gesamte Festival wird auf Basis historischer Zahlen auf AUD $10M+ geschätzt. Allein die 2025er-Championship generierte AUD $3.000.000.
...
Geh mit deinem Reisepass zum Guest Service Desk. Bestätige, dass dein Wire-Transfer geclearet ist und die Gelder deinem Konto zugewiesen sind, bevor du versuchst, dich zu registrieren.
...
> **Hinweis**: Das Budget-Szenario setzt voraus, dass du deinen Prime-Satellite über einen On-Site-Step-Qualifier (~AUD $255) gewonnen hast. Das Standard- und das Full-Experience-Szenario beinhalten das direkte Buy-in. Flüge aus Ostasien/Südostasien liegen typischerweise bei AUD $700–1.500 hin und zurück.
...
A. ==g:Die Registrierung öffnet 1 Stunde vor dem Start jedes Events.== Für stark besuchte Championship-Starting-Flights solltest du mindestens 90 Minuten früher da sein, um Warteschlangen zu vermeiden.

**Q. Kann ich im The Star Sydney Cashgames spielen, wenn ich früh ausscheide?**

A. Ja. Der Star-Poker-Raum bietet täglich Cashgames ==g:von 10 AM – 4 AM==, Stakes ab $2/$3 NLH (AUD $200–500 Buy-in) bis $25/$50 NLH. Nutze das SMS-Waitlist-System: schick **Game [Code] [Initiale + letzte 3 Ziffern der Mitgliedsnummer]** an **0480 049 257** ab 9 AM.
