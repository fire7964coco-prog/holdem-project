...
> **先に結論**
> 形式を分ける主な軸は二つです。「チップをなくしたら終わりか、買い直せるか」(フリーズアウト/リバイ・リエントリー)と、「賞金が順位だけで決まるか、脱落させた相手にも付くか、そもそも現金ではなく席か」(通常/バウンティ・PKO/サテライト)。この二軸で表の大半は読み解けます(ディープスタックやMTT/SNGはスタックの深さ・テーブル数で分ける別の種類で、重なることもあります)。
