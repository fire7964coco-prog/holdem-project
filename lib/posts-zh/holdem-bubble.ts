...
**泡沫期最常见的对决，是大筹码往你身上推、而你是短筹码或中等筹码——理解这场博弈里双方各占什么理，你就知道该跟还是该弃。** 这不是新规则，而是把上面几节的道理放到同一手牌里看：
...
- **站在中等筹码一侧（最难受）：** 大筹码正是冲着你来的。你没有短筹码那份「反正快死了」的自由，输掉筹码在真金白银上的代价又最大。所以除非牌力强到 ==胜率够 60%== 以上（见下面泡沫系数表），否则面对大筹码的推牌就弃——然后转身去偷你下方那些更短的码，把损失补回来。
...
- **一旦你的席位在数学上安全了**（你进 bubble 进得够深，追不上你了），就每手都弃——是的，连 AA 和 KK 都弃——让更短的码去互相厮杀。盲注每升一级就把这笔账重新算一遍：前注一进场，「安全区」就会缩小。
...
**Q. 「吃泡 / 泡沫破裂」（pay / burst the bubble）是什么意思？**

A. 「泡沫（bubble）」就是进钱前的最后一个名次，所以在那里出局的人——也就是 bubble boy——什么都拿不到，而其余还在场的人全部进钱；这就是人们说的「吃泡」（pay the bubble）。「泡沫破裂」（burst the bubble）指的则是那最后一次淘汰：它一发生，剩下的每个玩家就都进了钱，紧张的求生压力也随之松开。有些比赛会给 bubble boy 一份小小的安慰奖，但传统上泡沫圈就是发零奖。
