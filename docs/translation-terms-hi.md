...
> **2026-09-14 갱신:** 신규 포스팅은 [힌디어 포스팅 참고 정본](keyword-bank/hi-posting-reference.md)을 먼저 읽는다. 아래의 검증된 하우스 스타일·과거 실측은 보존하며, 최신 Google 인도 조사·출처 한계·앱 라벨·저장 범위·랜딩 배포 상태는 새 정본에 모았다. 이전 HI 랜딩 미착수 메모는 이번 사용자 요청 이전의 이력이다.
