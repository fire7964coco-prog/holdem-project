...
这就是所有数字兑现的时刻——但**你付的是哪一条街的钱，就用哪一条街的数字**。如果两张牌都会发出来（你已经 all in，或者转牌后面没有下注），你的 **35%** 就压过 **25%** 的价钱，长期来看跟注是赚钱的，尽管这一把你输的时候会比赢的时候多。可要是对手在转牌还会再下一注，这次跟注只买到转牌那一张：==9 ÷ 47 = 19.1%==，*低于*价钱——这时听牌就得靠 [隐含赔率](/zh/blog/holdem-implied-odds "thumb:/images/holdem-implied-odds-hero.webp")，也就是你成牌之后那几条街能多赢到的钱，来补上这道缺口。只买到一张牌却搬出 ×4 的数字，是新手高估听牌最常见的方式。完整方法和下注尺度速查表，看 [如何计算底池赔率](/zh/blog/holdem-pot-odds)。
