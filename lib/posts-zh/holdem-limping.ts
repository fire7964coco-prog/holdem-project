...
有一点老实的提醒，因为环境能改变一切。在**线上和更硬的牌局**里，上面那三招是默认配置，不是偶尔遇上：桌上几乎每个人都在等着惩罚 limp，所以 ==g:一个正常的 100BB 牌局里，open-limp 基本上没有站得住的理由==。上文那四种情形里，只有补齐小盲能原样搬到这种牌局——那里你再补半个大盲就能看翻牌，身后又只剩大盲一个人有加注权，被隔离的代价小得多。
