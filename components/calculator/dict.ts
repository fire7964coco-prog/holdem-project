...
export const CALC_DICT_EN: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      "88": { desc: "Pocket pair with good set potential", action: "Raise LP; in EP consider calling a raise — never open-limp" },
      ...
      "77": { desc: "Set-mining hand, watch overcards", action: "Raise LP; in EP call a raise — never open-limp" },
