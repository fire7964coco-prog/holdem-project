...
**레인 상태(여기만 유지)**: zh **42/42 완주** · zh-hant **42/42 완주**(회차 7 소급까지) · ja **회차 1~11 머지 완료**(회차 11 = ff `0b7ea301` · 레인 `9fbe7b6e`) · **ja 회차 12 진행 중**(미커밋 · lane:sync BLOCKED) · zh·zh-hant 회차 없음.
