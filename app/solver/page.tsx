...
const DESCRIPTION =
  "설치도 회원가입도 없는 100% 무료 GTO 솔버. 한국어로 된 홀덤 GTO 프로그램으로 13×13 GTO 표와 EV·에퀴티를 브라우저에서 바로 계산합니다. 교육 예제 13개와 EV 손실 채점 트레이너까지 무료입니다.";
  ...
  "@graph": [
    {
      ...
      featureList: [
        ...
        "GTO 트레이너 — 33개 결정 노드에서 EV 손실(bb)로 채점",
