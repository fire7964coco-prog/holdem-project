...
export const POST: Post = {
  ...
  tldr: "bad beat（爆冷输牌／走背运）就是你作为大热门——通常 80% 或以上——把钱推进去，却因对手摸到一张幸运牌“suck out”逆袭你而输掉。跟 cooler 不同，钱推进去时你是领先的；只是这副牌在最后一刻背叛了你。它很扎心，但 bad beat 其实是个信号：说明你正在一个有利可图的牌局里。",
  category: "glossary",
  date: "2026-07-05",
  updated: "2026-09-21",
