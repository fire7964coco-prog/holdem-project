...
export const CALC_DICT_PT: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      A10s: { desc: "Um dos melhores ases suited", action: "Aumente de posição média/tardia; do UTG aumente ou folde — nunca dê limp" },
      ...
      A3s: { desc: "Carta de wheel + draw de nut flush, um degrau acima de A2s", action: "Só em posição tardia" },
      A2s: { desc: "Wheel + nut flush, mas fraca", action: "Só em posição tardia" },
      ...
      K10o: { desc: "K-10 offsuit, fraca", action: "Abra com um aumento do CO/BTN se todos antes de você foldaram" },
      Q10o: { desc: "Offsuit de pouca conectividade", action: "Só no BTN" },
      J10o: { desc: "Offsuit razoável, mas vulnerável", action: "Só no BTN" },
