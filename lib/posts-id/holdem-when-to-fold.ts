...
export const POST: Post = {
  ...
  imageAlt: "Seorang pemain poker mendorong kartunya tertutup ke dalam muck di bawah lampu meja, memilih fold daripada membayar sebuah taruhan",
  tags: ["kapan fold di poker", "kapan fold preflop", "kapan fold tangan bagus", "disiplin fold", "sunk cost poker", "melepas tangan besar", "fold ke river raise", "fold pot odds"],
  content: `
...
### Kenapa fold membuat Anda menang

:::stripe
75–85% | Tangan yang di-fold pemain solid sebelum flop
0 | Hal terburuk yang bisa dibebankan sebuah fold (ke depannya)
25% | Equity yang Anda butuhkan untuk call taruhan setengah pot
Matematika > rasa takut | Satu-satunya alasan untuk fold, atau tidak
:::
...
Satu tangan yang pada dasarnya *tidak pernah* Anda fold preflop di cash game adalah pocket ace — ia favorit atas setiap holding lain. (Pengecualian langka ada di spot bubble turnamen dan satelit, di mana bertahan hidup bisa melebihi edge kecil. Di cash game: tidak pernah.)

---

## Kapan Fold Setelah Flop — Street demi Street

Fold postflop adalah tempat uang sebenarnya diselamatkan, dan setiap street mengajukan pertanyaan berbeda.

![Board lima kartu penuh di atas felt hijau di samping tumpukan besar chip saat seorang pemain memegang dua kartu tertutup, menimbang apakah harus fold di street selanjutnya](/images/holdem-fold-board.webp "Setiap street mengubah pertanyaannya: di flop Anda bertanya apakah Anda nyambung, di river Anda hanya bertanya apakah Anda bisa mengalahkan taruhan value")

**Flop — "Apakah board ini membantu saya, atau mereka?"** Saat Anda meleset dan menghadapi taruhan di board yang cocok dengan range lawan, lepaskan. Ace-high tanpa draw di board yang terkoordinasi tak layak call "untuk melihat turn." Fold draw lemah juga — sebuah gutshot tanpa equity lain dan dengan harga buruk adalah fold, bukan chase.

**Turn — street menyerah.** Ini adalah fold terpenting di poker dan yang paling sering dilewatkan pemain. Di turn, range terpolarisasi ke arah "sangat kuat atau busted," dan ukuran taruhan membengkak. Float flop Anda yang tak membaik, second pair Anda yang kini menghadapi barrel kedua, draw Anda yang baru saja meleset dengan satu kartu tersisa dan harga buruk — inilah turn untuk dilepaskan, bukan untuk membujuk diri ke satu call lagi. Jika Anda "float flop untuk bluff turn," dan turn tak memberi Anda alasan, menyerahlah.

**River — murni bluff-catching.** Anda tak lagi mengejar apa pun; satu-satunya pertanyaan adalah *"bisakah tangan saya mengalahkan tangan yang mereka taruhkan untuk value di sini?"* Jika pemain pasif melepas taruhan besar ke board yang menakutkan, jawaban jujurnya biasanya tidak. Fold tangan yang hanya mengalahkan bluff saat lawan Anda jarang bluff. Yang membawa kita ke matematika.
...
| Ukuran taruhan (ke dalam pot) | Pot odds yang Anda dapat | Equity yang dibutuhkan untuk call | Fold jika Anda punya kurang |
|:---|:---:|:---:|:---:|
| **Setengah pot** | 3:1 | **25%** | di bawah 25% |
| **Dua pertiga pot** | 2,5:1 | **~29%** | di bawah 29% |
| **Sebesar pot** | 2:1 | **~33%** | di bawah 33% |
| **Overbet (1,5× pot)** | ~1,7:1 | **~37,5%** | di bawah 37,5% |
...
Tangan yang sama, keputusan berlawanan — karena *harga* berubah, bukan kartunya. Itulah pot odds, dan itulah bedanya antara chase dan call. (Implied odds — uang yang akan Anda menangkan *nanti* saat Anda kena — bisa membenarkan sebagian call yang lebih tipis, tapi jangan pernah mengasumsikannya melawan short stack atau board yang mematikan aksi Anda.)

---

## Fold Tersulit: Melepas Tangan Bagus

Fold sampah itu mudah. Fold tangan yang *bagus* — top pair, overpair, bahkan set — itulah yang memisahkan pemain pemenang dari yang lain. Jebakan mentalnya adalah berpikir "ini tangan kuat," padahal satu-satunya pertanyaan yang penting adalah "apakah ia kuat *saat ini, melawan line ini*?"

**Top pair bukanlah puncak range Anda.** Di pot yang di-raise atau di-re-raise, top pair dan overpair adalah tangan kekuatan menengah. Melawan agresi berat multi-street — terutama raise di river yang menakutkan — mereka sering kalah, dan disiplin untuk melepasnya adalah **laydown yang bagus**, bukan kelemahan. Berikut tangan yang dinikahi pemain padahal seharusnya mengajukan gugatan cerai:
...
## Psikologi Fold: Sunk Cost, Ego, dan Rasa Takut

Inilah rahasia yang tak diberitahukan chart strategi: **kebanyakan call buruk bukanlah kesalahan membaca — melainkan kesalahan emosional.** Tiga biang keladi melakukan kerusakan.
...
Di antara dua ekstrem itu duduk dua profil pecundang: **calling station** yang tak pernah fold dan membayar setiap taruhan value, dan **nit** yang fold begitu banyak sehingga pemain bagus cukup bertaruh setiap pot dan melindas mereka. Fold yang menang tinggal di tengah yang disiplin: ketat, tapi tak takut.
...
## Sebuah Laydown Nyata, Tangan demi Tangan

Berikut sebuah fold yang saya banggakan, dijabarkan agar Anda bisa memeriksanya sendiri. Cash $1/$2, 100bb deep.

- **Tangan saya:** ==A♥K♣.== Saya raise, big blind — pemain ketat, pasif — call.
- **Flop:** ==K♦ 9♠ 4♥.== Saya dapat top pair, top kicker. Saya bet, ia call. Standar.
...
## 7 Kesalahan Fold Paling Umum

<div style="background:rgba(255,248,210,0.10);border:1px solid rgba(255,240,180,0.35);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| Kesalahannya | Kenapa ia membebani Anda | Perbaikannya |
|:---|:---|:---|
| **Call terlalu banyak (station)** | Anda membayar setiap taruhan value di ruangan | Default ke fold saat Anda hanya mengalahkan bluff |
| **Membayar taruhan value yang jelas** | Taruhan besar pasif hampir tak pernah bluff | Percayai ceritanya; fold |
| **Menikahi top pair / overpair** | Mereka tangan menengah di pot besar | Fold ke agresi berat multi-street |
...
/id/blog/holdem-pot-odds | Matematika yang Menentukan Call Ketat | /images/holdem-pot-odds-hero.webp
:::
...
A. Fold tangan kuat saat aksi memberi tahu Anda ia kalah: top pair atau overpair menghadapi agresi berat multi-street, terutama raise dari pemain pasif atau river menakutkan yang melengkapi draw jelas. Top pair bukanlah puncak range Anda di pot besar. Laydown disiplin atas tangan kuat yang kalah adalah permainan yang menang, bukan yang lemah.

**Q. Haruskah Anda pernah fold pocket ace?**

A. Di cash game, pada dasarnya tak pernah sebelum flop — ace adalah favorit matematis atas setiap starting hand lain. Setelah flop, overpair ace kadang-kadang bisa di-fold ke agresi ekstrem di board berbahaya. Pengecualian preflop yang langka adalah spot bubble turnamen dan satelit, di mana bertahan hidup bisa melebihi edge kecil.

**Q. Kapan Anda harus fold top pair?**

A. Fold top pair saat kicker Anda lemah dan Anda menghadapi taruhan besar turn dan river, saat board berkembang menjadi flush atau straight yang jelas dan lawan Anda bertaruh ke sana, atau saat pemain pasif me-raise. Top pair mengalahkan bluff dan pair lebih buruk, tapi melawan line value-heavy ia sering tertinggal — dan call tiga street untuk menangkap satu bluff kehilangan uang.
...
A. Tidak — fold yang disiplin adalah tanda skill. Pemain terbaik di dunia fold sebagian besar tangan mereka dan melepas tangan kuat saat situasi menuntutnya. Apa yang tampak seperti kelemahan sebenarnya adalah menolak menyumbangkan chip ke spot kalah. Kelemahan sejati adalah ketidakmampuan melepas, yang akan dieksploitasi setiap lawan kuat.
...
## Playbook Fold, Singkatnya

1. **Hasil terburuk sebuah fold adalah nol** — saat Anda kalah, itu mengalahkan setiap alternatif negatif.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-strategy" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Kerangka 5 Keputusan</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Di mana fold cocok dalam permainan yang menang</div>
  </a>
  <a href="/id/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Peluang</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Cara Menghitung Pot Odds</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Ambang di balik setiap fold</div>
  </a>
  <a href="/id/blog/holdem-3bet" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Strategi</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">3-Betting Dijelaskan</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kapan fold ke re-raise</div>
  </a>
  <a href="/id/blog/holdem-continuation-bet" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">Strategi</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">Continuation Bet</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kapan fold ke c-bet</div>
  </a>
</div>
`.trim(),
};
