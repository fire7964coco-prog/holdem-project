...
export const POST: Post = {
  ...
  tldr: "bad beat（爆冷输牌／背运输）就是你作为大热门——通常 80% 或以上——把钱推进去，却因对手摸到一张幸运牌「suck out」逆袭你而输掉。跟 cooler 不同，你是全程领先的；只是牌河在最后一刻背叛了你。它很扎心，但 bad beat 其实是个信号：说明你正在一个有利可图的牌局里。",
  category: "glossary",
  date: "2026-07-05",
  updated: "2026-08-30",
...
**bad beat** 就是你作为统计上的大热门把筹码推进去，却还是输了，因为你的对手摸到一张幸运牌对你 ==g:suck out（逆袭）== 了。关键词是*热门*——钱推进去时你是领先的，只有一张几乎不可能出现的牌才翻转了结果。下面就讲清楚到底什么才算 bad beat、它跟 [cooler](/zh/blog/holdem-cooler "thumb:/images/holdem-cooler-hero.webp") 有什么区别、「bad beat jackpot」赔多少，以及每个赢家最终都会学到的那个反直觉的真相：bad beat 其实对你是*好事*。它是整个 [扑克术语表](/zh/blog/holdem-glossary "thumb:/images/holdem-glossary-hero.webp") 里被滥用得最厉害的词之一，所以下面就说清楚：到底怎样才真正算数。
...
| **超对 vs 同花听牌（边界案例）** | 翻牌面的超对 | ~65%（2:1） | 他们 9 张 outs 的同花听牌在河牌成牌 |
| **runner-runner（连摸两张）** | 翻牌时领先的一手成牌 | ~90%+ | 两张完美的牌（turn *和* river）把一个听牌补成成牌 |
| **one-outer（只剩一张）** | 一手近乎锁死的牌 | ~96% | 这副牌里仅剩的那唯一一张牌击败你 |

</div>

*按上一节的标准，超对 vs 同花听牌是这个家族的边界案例：~65% 的优势更接近普通的方差，算不上「货真价实」的 bad beat——但牌桌上大家就是这么叫它。*

最标志性的是**一对 A 被暗三条击碎。**你拿着一对 A 翻前全下对上一对 7——你大约是 80% 的热门，一个 4-to-1 稳赢的局面。可这副牌里还有另外两张 7，只要一张出现在牌面上——而且没有 A 跟着来——他们的三条就击败了你的对子。五次里有四次你收下底池；第五次，你就有了一个没人想听的 bad beat 故事。数学从来没错——你只是落在了它错误的那一边，这也正是为什么单独一手牌根本 [说明不了你打得好不好](/zh/blog/holdem-cooler)。

---

## 什么是 bad beat jackpot？

有些牌室把这份痛苦变成了奖金。**bad beat jackpot（官方就叫这名，中文辅助说「爆冷大奖」）** 是一个累积奖池——由每一手符合条件的牌里抽取一小笔组成——当一手非常强的牌在摊牌时输掉时就会派彩。它的用意是奖励那个遭遇惊天大败的玩家，而奖金往往能改变人生。
...
如果你想让自己心里好受点，记住：最惨的 bad beat 都发生在最大的舞台上。最传奇的那一次发生在 **2008 年世界扑克大赛（WSOP）主赛事**上，**Motoyuki Mabuchi** 把他的一对 A 打成了 **four of a kind——四条 A**，一手全扑克里只有一副牌能击败的牌——却*还是输了*。river 河牌那张 **A♦** 凑成了他的四条，而与此同时，同一张牌又给了 **Justin Phillips**（手握 K♦ J♦）一个 **同花大顺**——方块的 10‑J‑Q‑K‑A。钱是在那之后才进池的：Mabuchi 过牌，Phillips 下注，Mabuchi 全下，Phillips 立刻跟注。让他凑成四条 A 的那唯一一张牌，正是唯一能击败它的那张牌。

*按同一条标准，这严格来说甚至算不上 bad beat——钱是在最后一张牌落下之后才进去的，所以并没有发生 suckout。但扑克把它记成了史上最著名的 bad beat，这个叫法也就留了下来。*
...
1. **大声接受它。**一句简单的「我领先着推进去的，我啥也做不了」胜过默默生闷气（粤语常说「黑仔」「手風差」，讲的就是这种运气差）。把它命名为 variance，就等于结了案。
...
A. 大多数牌室要卡住四个硬条件，缺一条就领不到：**①牌力够大**——最低门槛通常是「葫芦 A 带 J 或更大，被四条或更大击败」（有些房间要求输的必须是四条以上）；**②必须走到摊牌**——牌得真正亮出来比大小，中途有人弃牌、还没摊牌就结束的这手不算；**③输赢双方的两张底牌都要参与成牌**——你不能靠一手完全由公共牌凑成的牌来领，暗三条那种「两张底牌都用上」的更稳；**④通常只限现金局**（锦标赛一般没有 jackpot）。我见过有人凑齐了葫芦 A 输给四条、兴奋地喊 jackpot，结果因为只有一张底牌参与成牌而没资格——**具体以你所在房间张贴的规则为准**，坐下前先看清门槛和抽水。

**Q. 扑克史上最惨的 bad beat 是什么？**

A. 最著名的来自 2008 年 WSOP 主赛事：Motoyuki Mabuchi 凑成了四条 A——一手只有同花顺能击败的牌——却还是输了。他翻牌击中暗三条 A，然后 river 河牌那张 case ace（仅剩的那张 A）凑成了他的四条，而在同一张牌上，又给了 Justin Phillips 一个方块同花大顺。凑成扑克里最大的四条，却撞上唯一能压过它的同花顺，这差不多就是 bad beat 惨到极点的样子了。
