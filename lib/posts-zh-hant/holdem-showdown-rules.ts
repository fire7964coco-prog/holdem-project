...
| 前面的街全下（河牌沒有下注） | 錦標賽：所有下注動作一結束，所有手牌立即攤開（TDA 第 16 條）。現金桌：全下的人先翻牌——有邊池時邊池玩家先亮（現金桌規則第 149 條） |
...
> **快速解答**
> 蓋牌不亮是「跟注方」的權利，不是下注方的。你付錢跟到了、看完對手的牌發現自己輸，可以直接蓋掉；但如果是你下注被跟，這個選項一開始就不屬於你。錦標賽裡只要有人全下，連跟注方的這個權利也一併收回。
...
==r:但有一個重要例外：== 如果你在河牌的下注被跟到了，跟注的人是付了全額才有資格看你的牌。要求荷官把蓋掉的牌翻開來看，這就是 **「我要看那手牌」（I want to see that hand）** 的規則。錦標賽裡 ==TDA 第 18 條== 把界線劃得很窄：攤牌時手上已經沒牌、或已經蓋牌不亮的人，就沒有資格提出要求。不可剝奪的權利只屬於跟了河牌下注、而且攤出或仍握著自己牌的人，並且只針對他花錢買來看的 **最後主動下注者** 那手牌。其餘一律由賽事總監裁量；現金桌上不少撲克室執行得比較寬鬆。（別跟「秀一給一，秀一給全（show one, show all）」搞混，那條說的是：你只要自願把牌秀給其中一個人看，全桌的人都有權看到。）
...
> **快速解答**
> 河牌上的全下被跟到，還是照最後主動下注者的規則走——全下的人先亮。如果全下發生在更早的街、後面不可能再有下注，錦標賽裡牌會在發完剩下的公牌前全部翻開，「誰先亮」不成立；現金桌則依 WSOP 現金桌規則第 149 條，全下的人先翻，有邊池時邊池玩家先亮。

在**錦標賽**裡，當一名玩家全下、後面已經不可能再有下注時，剩下的公牌會 **在所有手牌都正面朝上的狀態下** 發完（==TDA 第 16 條==）。這是為了保護這手牌的完整性——在全下的局面裡，沒有人應該還能靠策略性蓋牌來藏資訊。**現金桌看各撲克室的規則**，而 WSOP 的現金桌（Live Action）規則剛好反過來：如果下注在河牌前就結束了，全下的人有責任先翻牌；如果有邊池，爭邊池的玩家要在只爭主池的全下者之前亮牌（==現金桌規則第 149 條==）。

<div style="background:rgba(255,248,210,0.10);border:1px solid rgba(255,240,180,0.35);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| 全下情境 | 攤牌規則 |
|----------------|---------------|
| 有人在前面的街全下、其他人跟注、後面不可能再下注 | 錦標賽：所有下注動作一結束，所有手牌立即攤開。現金桌：全下者先翻牌——有邊池時邊池玩家先亮（現金桌規則第 149 條） |
| 河牌上的全下被跟到 | 全下的人作為最後主動下注者先亮牌——但在錦標賽裡，==r:誰都不能蓋牌==：依 TDA 第 16 條，跟注方同樣必須攤牌 |
...
在多數撲克室，你可以要求荷官把一手蓋掉的牌翻開——但僅限那手 **被跟到、而且進到攤牌** 的牌。棄牌一旦進了蓋牌堆就是死牌，只有仍能清楚辨識的牌才可能被撿回來（WSOP 錦標賽規則第 109 條）。這條「要求看牌」的規則，是用來防串通作弊的，不是用來滿足好奇心的，濫用它會被當成失禮。要省著用。
...
A. 要——如果你是河牌圈最後一個下注或加注的人，被跟到時你必須先亮。如果是你跟了別人的注，你可以在看到對方的牌、確認自己輸了之後，正面朝下蓋牌。例外是錦標賽中的全下：依 TDA 第 16 條，跟注方同樣必須攤牌。而在錦標賽裡，有保障的要牌權屬於**跟了河牌下注的人**——前提是他已攤牌或手上還有牌——而且僅限最後主動下注者那一手，也就是他花錢買來看的那一手（==TDA 第 18 條==）。正面朝下蓋掉的人無權再要求看任何牌，其他要求都由賽事總監裁量。
...
A. 在錦標賽裡，當一名玩家全下、後面不可能再有下注時，涉及那個池的所有手牌會在所有下注動作一結束就立即攤開——在剩下的公牌發出之前（TDA 第 16 條）。如果有邊池，先結算邊池、再結算主池——但全下玩家的牌早在那之前就已經翻開了。現金桌上，WSOP 現金桌規則讓全下的人先翻牌，邊池參與者要在只爭主池的全下者之前亮牌（第 149 條）。至於其他還有籌碼、還能下注的玩家，在下注走完之前，他們的牌都還蓋著。
