...
**第一張踢腳大的贏。一對用三張踢腳，從最大那張開始一次比一張 —— 第一個不一樣的地方決定底池。** 實際上大多數底池在==第一張就結束了==，第二、第三張踢腳連上場的機會都沒有。
...
**先比大對，再比小對，最後比那張單一踢腳 —— 就照這個順序。** 兩對剛好帶一張踢腳，所以比完兩組對子之後，只剩一張牌可以吵。新手真正會賠錢的地方不在順序，而在==公牌自己成對==的時候：那一對會同時算給桌上每個人，你翻牌時領先的兩對可能就這樣被公牌疊掉，變成別人的兩對 —— 下面那個例子就是。
