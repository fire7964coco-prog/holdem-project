...
>
> 🔴 **다음 세션의 가장 값어치 있는 후보 둘**:
> ① 🔷 **`德州撲克規則` 4,400 필라 재조준**(카드 #3이 발굴 — zh-hant만 놓쳤던 자리. 조건 둘 있음)
...
| ~~**3**~~ | ~~태그 317종 재측정~~ | ✅ **종결 (2026-08-31 · `fc0487e1`)** — **85종이 볼륨 보유**(미반환 232·0확정 1). 🔷 **후속 1순위 = `德州撲克規則` 4,400 무주공산**(순수 포커 의도 확인 완료). 다른 4개 언어가 08-27에 필라 제목으로 편입한 것과 같은 계급인데 zh-hant만 놓쳤던 자리다. 🔴 **착수 조건 둘**: ①본문에서 쓰는 글이 **10편**이라 «주인 글»을 먼저 정할 것(안 그러면 카니발) ②§17 «훅 살리고 키워드만». 정본 = `docs/keyword-bank/zh-hant-tag-volumes.md` |
