  ...
  return (
    <div className="sticky top-20 flex flex-col gap-5">
      {/*
        ...
        🔴 랜딩이 있는 로케일에서만 — 마크업·문구는 `components/solver-promo.tsx` 한 곳에 있고
           홈의 <aside>도 같은 것을 쓴다(양쪽에 복사하면 갈라진다).
        ★2026-08-19 — `/en/solver` 신설로 en이 합류했다. **조건을 손으로 적지 않는다** —
           지원 로케일 판정은 컴포넌트가 내보내는 집합에 맡긴다(랜딩이 늘면 거기만 고친다).
      */}
      {SOLVER_PROMO_LOCALES.has(current) && <SolverPromo locale={current as SolverPromoLocale} />}
