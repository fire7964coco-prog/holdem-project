...
export const POST: Post = {
  ...
  desc: "국내 홀덤 대회, 어디서 어떻게 등록하죠? 온라인 무료 대회 → 홀덤펍 → 위성 → 국내 대형(KPC·APT) → WSOP까지 5단계로 참가 방법·준비물·현장 절차를 초보 기준으로 정리했습니다.",
...
홀덤펍과 위성으로 자신감이 붙었다면 한국에서 열리는 **세계급 대회**에 직접 도전할 수 있습니다. 다만 여기서 반드시 알고 가야 할 것이 하나 있습니다.
