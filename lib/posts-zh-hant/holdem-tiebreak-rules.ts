...
A. 先比大對，再比小對，最後比那張單一踢腳 —— 所以 A 和 3 的兩對贏 K 和 Q 的兩對，就算第二對小很多也一樣。會讓人栽跟頭的是公牌本身就有兩對的牌面，像 K-K-9-9-5：除非有人手上有 K、有 9、口袋 5-5，或是口袋對比 9 大，否則每個人都是同樣的兩對，整手牌就縮成比那一張踢腳，全桌最大的底牌拿走底池 —— 而如果沒有任何人的底牌大過公牌的第五張，大家一起打公牌，底池平分。兩對就只有一張踢腳，從來不會是兩張。
...
A. 不會 —— 但德州撲克的牌桌上確實有一個地方會用到花色，只是跟底池無關。現金桌、以及大多數撲克室的館規，開局時每人抽一張牌決定按鈕從哪裡開始，兩張抽到同點數就用花色順序決定。（WSOP 錦標賽不抽牌：==錦標賽規則第 85 條== 規定按鈕從荷官右手邊第一位開始，只在剩三桌、兩桌、一桌時重抽 —— 完全不看花色。）不管哪一種，決定的都是*座位*，從來不是牌。錦標賽規則裡唯一的花色順序屬於梭哈和 Razz。兩手最強五張一張一張都對上，不管花色如何都平分底池。
