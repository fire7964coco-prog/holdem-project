...
有两个词大家常混在一起，值得分清。**limper（爱平跟的人）** 是指用跟大盲的方式进入未加注底池的人。**calling station（跟注站）** 是指翻后在翻牌、转牌、河牌上跟太多*下注*的人。它们常常指同一个松被动的玩家，却是两种不同的习惯——一个说的是你怎么*进*池，另一个说的是你怎么*继续*打。如果这些词里有哪个把你绕晕了，一份[扑克术语词汇表](/zh/blog/holdem-glossary)能帮你理清剩下的行话。
...
> **快速回答**
> open-limp 让你放弃四样东西：翻前赢下底池的机会（limp 时是零）、下注主动权、对底池大小和位置的控制，以及不被看穿——习惯性 limp 的范围又封顶又透明，高手一眼就知道该怎么攻击。
...
> **快速回答**
> 加注能当场赢下底池；limp 永远不能。开池加注给你两条赢路——所有人翻前弃牌，或带着主动权往后拿下；limp 只留下第二条、更难走的那条，还让大盲花很少就能拿着随手的牌来看翻牌。
...
A. 通常叫“鱼（fish）”——对弱的、长期输钱的玩家的统称——或者叫“菜鸟（donk）”，意思是打得差。（“跟注站”常被扣在同一个人头上，但那个词说的是翻后跟太多下注，跟他怎么进池无关。）习惯性 open-limp 是新手最明显的破绽之一，这也正是强手会用隔离加注专门盯着 limper 打的原因。不想被贴上这个标签，就默认加注或弃牌。
