...
| **$10K 豪客赛直接资格赛** | 9 月 22 日，==g:十选一（每 10 人产生 1 个席位）== | $1,050 | $10K 豪客赛席位 |
...
| WPT World Champs Prime Warm Up | 9 月 29–30 日 | $1,150 | 12 月 WC 热身赛 |
| Australian PLO Championship | 9 月 29–30 日 | $5,000 | Pot Limit Omaha |
| The Ultimate Freeze | 9 月 30 日 | $1,500 | Freezeout |
| Sydney Finale | 9 月 30 日 | $680 | 收官赛事 |
...
| 门票 | 赛事（决赛日） | 买入（AUD） | 日期 |
|:---|:---|:---:|:---:|
| ==g:**WPT World Championship**== | **#24 Championship Event** | $5,000 | 9 月 30 日 |
| ==g:**WPT World Championship**== | **#22 $10K High Roller** | $10,000 | 9 月 24 日 |
| WPT World Championship Prime | #14 Prime Championship Event | $1,500 | 9 月 22 日 |
| WPT World Championship Prime | #1 Australian Poker Cup | $1,150 | 9 月 14 日 |
| WPT World Championship Prime | #6 Aussie Monster Stack | $1,250 | 9 月 14 日 |
| WPT World Championship Prime | #20 Mystery Bounty | $1,350 | 9 月 22 日 |
| WPT World Championship Prime | #30 Mini-Championship | $2,000 | 9 月 28 日 |
| WPT World Championship Prime | #33 WPT World Champs Prime Warm Up | $1,150 | 9 月 30 日 |
| WPT Ladies Championship | #11 Ladies Australian Championship | $500 | 9 月 16 日 |
...
![The Star Sydney 的 WPT Australia 扑克桌，可俯瞰达令港——牌手在 2026 冠军赛中对决](/images/wpt-australia-2026-tournament-floor.webp)

*The Star Sydney 的扑克室俯瞰达令港。九月的悉尼：白天最高 19–22°C，夜晚凉爽约 11–13°C——为深夜的现金局打上一件轻便外套。*
...
**怎么加入：**
1. 在线预注册 ==g:[thestarclub.com.au/sign-up](https://www.thestarclub.com.au/sign-up)==（节省到场时间）
2. 抵达 The Star Sydney 后 → 主赌场大厅的 Guest Service Desk（客服台）
3. 出示你的 ==r:护照原件==（国际驾照不被接受）
4. 领取会员卡 → 你就可以进场了
...
### 2. Smart-Casual 着装要求——严格执行

The Star Sydney 严格执行 **smart-casual 着装要求**。在门口被拦下，就意味着错过你的锦标赛报名时间窗口。

==r:不允许：背心、人字拖/拖鞋、破洞牛仔裤、沙滩装或任何运动服。== 得体的牛仔裤、有领衬衫和运动鞋可以。

### 3. 怎么去

The Star Sydney 位于 **80 Pyrmont Street, Pyrmont NSW 2009**——就在达令港边。

<div style="background:rgba(255,248,210,0.08);border:1px solid rgba(255,240,180,0.25);border-radius:14px;padding:4px 20px 20px;margin:24px 0">

| 出发地 | 方式 | 时间 | 花费（约） |
|:---|:---|:---:|:---|
| 悉尼机场（T1/T2） | Airport Link 火车 → Central → 轻轨 | 约 40 分钟 | AUD $20–25 |
| 悉尼机场 | 出租车 / 网约车 | 约 25–35 分钟 | AUD $50–70 |
| 悉尼 CBD（George St） | 步行 | 约 15 分钟 | 免费 |
| Circular Quay | 渡轮到 Pyrmont Bay | 约 20 分钟 | AUD $5 |

</div>

**最近的酒店**：The Star Grand Hotel（与赌场相连，尽早预订——九月很快订满）、Sofitel Sydney Darling Harbour（步行 5 分钟）、Novotel Sydney on Darling Harbour（步行 5 分钟）。
...
对于超过 AUD $5,000 的买入（或想避免每日提现的麻烦），==g:最简单的办法是在出发前做一笔银行电汇==。
...
==r:在订机票之前先申请。== eVisitor/ETA 通常即时，但至少提前 1 周申请。在 [homeaffairs.gov.au/visa-subclass-601](https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/electronic-travel-authority-601) 查你护照的具体要求。
...
/zh/blog/ept-barcelona-2026-guide | EPT Barcelona 2026 指南 | /images/ept-barcelona-2026-guide-hero.webp
:::
...
A. 你可以在 thestarclub.com.au/sign-up 在线预注册以节省时间，但 ==g:你必须在抵达后带护照原件到 Guest Service Desk 完成本人身份核验==。一到就去办——赶在锦标赛报名截止之前。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  ...
  <a href="/zh/blog/ept-barcelona-2026-guide" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">欧洲最大的夏季扑克赛事</div>
  </a>
  <a href="/zh/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">从这开始</div>
