...
export const POST: Post = {
  ...
  desc: "Rake adalah biaya yang diambil house dari sebagian besar pot cash game. Pahami pot rake, time charge, biaya turnamen, biaya per sesi, dan rakeback.",
...
Bukan jenis pot — tapi Anda tetap membayar biaya, dan ia bersembunyi di depan mata. Harga masuk dapat menampilkan kontribusi prize pool dan biaya secara terpisah dengan **tanda "+"**. Beberapa seri, termasuk WSOP, mencantumkan satu total buy-in yang sudah termasuk biaya. Contoh notasi terpisah:
...
A. Rake adalah biaya yang diambil cardroom dari sebuah cash game karena menyelenggarakannya — normalnya persentase kecil dari pot yang dikenai rake (2,5–10%) hingga maksimum ter-cap. Karena house tak bermain, rake adalah sumber pendapatan utamanya. Turnamen mengenakan biaya setara yang dibangun ke dalam buy-in.
...
A. Ya, tapi bukan dari pot. Harga masuk dapat memisahkan kontribusi prize pool dan biaya dengan "+" — turnamen $100 + $9 mengirim $100 ke prize pool dan $9 ke house. Beberapa seri, termasuk WSOP, mencantumkan satu total buy-in yang sudah termasuk biaya. Biaya itu (si "juice" atau "vig") biasanya 5–20% dari buy-in dan dibayar terlepas dari bagaimana Anda finis.
...
1. **Rake adalah potongan house untuk menyelenggarakan permainan** — biasanya 2,5–10% dari pot yang dikenai rake hingga cap kecil, dan terpisah dari apa yang Anda menangkan atau kalahkan ke lawan.
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/id/blog/holdem-tournament-vs-cash-game" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Kenapa keduanya membebani Anda dengan cara yang sama sekali berbeda</div>
  </a>
  <a href="/id/blog/holdem-straddle" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Blind ekstra yang menggelembungkan pot — dan rake</div>
  </a>
  <a href="/id/blog/holdem-pot-odds" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Baca pot Anda setelah house mengambil potongannya</div>
  </a>
  <a href="/id/blog/holdem-tournament" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">Ke mana biaya buy-in sebenarnya pergi</div>
  </a>
</div>
`.trim(),
};
