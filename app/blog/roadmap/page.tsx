...
const TITLE = "홀덤 학습 로드맵 — 뭐부터 읽어야 하나";
const DESCRIPTION =
...
export const metadata: Metadata = {
  ...
  // ★2026-09-20: og를 안 적어 **부모 `app/blog/layout.tsx`의 블로그 카드**를 그대로 물려받고 있었다
  //   (실측: og:title이 「⚡ 홀덤 블로그 — 기초·전략 가이드」였다). 루트가 아니라 부모 layout이 샌 경우다.
  ...socialMeta({ title: TITLE, description: DESCRIPTION, path: "/blog/roadmap" }),
};
