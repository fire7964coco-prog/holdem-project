...
順子湊成的方法大約是同花的 ==r:**兩倍**==——在 2,598,960 手五張牌裡是 10,200 種對 5,108 種。算到河牌的七張牌上，差距縮到 ==約 1.5 倍==（4.62% 對 3.03%），但方向沒變：順子出現得更頻繁——這就讓它成為比較弱的一手。同一條頻率法則解釋了整個牌型階梯；每一手牌的精確數字都在[德州撲克機率與勝率表](/zh-hant/blog/holdem-probability "thumb:/images/holdem-probability-hero.webp")裡。
...
==r:**但有兩個警告要一起記住。**==第一：這手順子**不是堅果**——拿著 T-9 的人已經有更大的 10-9-8-7-6。第二：你自己最大的紅心只有 ==9♥==。河牌只要來的紅心不是 6♥，每個拿著兩張紅心的對手同樣成同花，而他只要有一張大過 9 的紅心就贏你——A♥ 2♥ 就夠了。升級是真的，但==r:這不是把底池打大的通行證==。
...
A. 不會。在標準德州撲克裡，順子（第 6 名）永遠不會贏過同花（第 5 名）。這是常見的混淆，因為順子感覺比較難湊，但同花更罕見——五張牌裡 5,108 種對 10,200 種，七張牌上 3.03% 對 4.62%——所以同花永遠把底池贏走。

**Q. 為什麼同花比順子大？**

A. 純粹是數學。順子不用管花色，所以大約有 10,200 種湊法，而同花只有 5,108 種。這讓同花在五張牌裡大約罕見兩倍；算到河牌的七張牌上，仍留有約 1.5 倍（3.03% 對 4.62%）。撲克裡越罕見的牌型排名永遠越高。
...
2. 它會贏是因為它更罕見：五張牌裡 **5,108** 種同花組合對 **10,200** 種順子組合——算到河牌的七張牌上是 3.03% 對 4.62%。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/zh-hant/blog/holdem-hand-rankings" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">全部 10 種牌型，附機率、範例與牌面謎題</div>
  </a>
  <a href="/zh-hant/blog/holdem-tiebreak-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">比牌與踢腳牌規則</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">同花或順子平手時——誰把底池贏走？</div>
  </a>
  <a href="/zh-hant/blog/holdem-split-pot-rules" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">什麼時候會分池？</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">5 種平分底池的情況，包含同花平手</div>
  </a>
  <a href="/zh-hant/blog/holdem-kicker" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:hsl(var(--primary));margin-bottom:6px">踢腳牌</div>
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">踢腳牌（Kicker）是什麼</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">順子沒有踢腳牌，但同花逐張比到底</div>
  </a>
</div>
`.trim(),
};
