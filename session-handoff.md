...
**8편은 끝났고 1편이 남았다.** 경위·검산치는 `WORKLOG.md` 2026-08-12 (5)~(11).

| 글 | 로케일 | 남은 결함 |
|---|---:|---|
| `holdem-hand-rankings` | **13** | 용어 동일시 · 「대부분의 팟은 원페어」(43,82% < 50%) · 무늬 서열 한정 |

🔴 **이 1편이 미러 트랙의 마지막이다.** 13 로케일이라 규모가 가장 크다.
...
| 미러 전파 | ✅ showdown-rules(25·9자리) · betting-actions(25·6종) · split-pot(8) · reading-the-board(8) · **equity(8)** · **flush-vs-straight(8)** · **implied-odds(8)** · **outs(8)** / 🔴 **잔여 1편(hand-rankings·13)** |
