...
const HAND_TABLE: TierEntry[] = [
  ...
  [2, "A10s", "스윗드 에이스 중 최상위권", "LP 레이즈, EP에선 폴드(테이블이 수동적일 때만 예외)"],
  ...
  [2, "88",  "드로우 잠재력 좋은 포켓페어", "LP 레이즈, EP에선 레이즈에 콜, 첫 진입이면 레이즈 아니면 폴드 — 오픈 림프 금지"],
  ...
  [4, "A3s", "휠 카드를 낀 너트 플러시 드로우, A2s보다 한 단계 위", "BTN/SB에서만"],
  ...
  [4, "K10o", "K-10 오프수트, 약함", "BTN에서만 가끔"],
  [4, "Q10o", "연결성 낮은 오프수트", "BTN에서만"],
  [4, "J10o", "좋은 오프수트지만 취약", "BTN에서 가끔"],
