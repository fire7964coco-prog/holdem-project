 ...
 * 🔴 WPT Global 약관(09-24 원문 재확인): 퀄리파이어 8/16~10/25 일요일 · 스텝·새틀 ~10/25 · 호텔 확인 10/28 ·
 *   숙박 11/4–8 고정 · KYC 11/1. 09-23엔 KYC를 «원문 미확인»으로 뺐으나 약관 본문에 있다.
...
$88 Qualifier | 매주 일요일 12:05 UTC · 1,500달러 패키지 3개 보장 · 10월 25일 종료
...
**온라인 예선에는 마감이 있습니다.** 약관 원문은 퀄리파이어가 「every Sunday from August 16 through October 25, 2026」, 스텝·새틀라이트는 8월 9일부터 **10월 25일까지** 매일 열린다고 적었습니다. 대회 기간인 11월 1일·8일 일요일에는 퀄리파이어가 없습니다. 호텔을 받은 사람은 **10월 28일까지 사용 의사를 확인**해야 합니다. 확인하지 않으면 다음 당첨자에게 넘어갑니다. 숙박일은 **11월 4~8일로 고정**이라 바꿀 수 없습니다. 패키지 자격을 유지하려면 **11월 1일까지 계정 본인 인증(KYC)**도 끝내야 합니다(약관 원문 「Players must complete KYC verification by November 1, 2026」).
...
A. WPT Global에서 1.10달러 스텝부터 8.80달러 새틀라이트, 88달러 퀄리파이어를 거쳐 1,500달러 패키지를 딸 수 있습니다. 88달러 퀄리파이어는 8월 16일부터 10월 25일까지 매주 일요일 12:05 UTC에 열리고 패키지 3개가 보장됩니다. 패키지에는 11월 5일 메인 Day 1A 참가권이 들어 있습니다.
