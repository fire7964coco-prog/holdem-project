...
export const CALC_DICT_ES: CalcDict = {
  ...
  outs: {
    ...
    exactNote: "La cifra mostrada en tamaño grande es la exacta",
  ...
  pot: {
    ...
    sliderFlush: "Proyecto de color (turn) 19.6%",
  ...
  starting: {
    ...
    hands: {
      ...
      A10s: { desc: "Uno de los mejores ases del mismo palo", action: "Subir en posición media/tardía; desde UTG sube o foldea — nunca limpees" },
      ...
      A3s: { desc: "Carta de rueda + proyecto de color al nuts, un escalón por encima de A2s", action: "Solo en posición tardía" },
      A2s: { desc: "Rueda + color al nuts, pero débil", action: "Solo en posición tardía" },
      ...
      "98s": { desc: "Conector del mismo palo fuerte", action: "Si nadie ha entrado, sube desde tardía; paga una subida con posición" },
      "87s": { desc: "Buen conector del mismo palo", action: "Si nadie ha entrado, sube desde tardía; paga una subida con posición" },
      ...
      "44": { desc: "Casi sin valor si no liga set", action: "Si nadie ha entrado, sube desde tardía; paga una sola subida en tardía si tú y quien subió tienen cada uno al menos unas 15 veces lo que pagas detrás" },
      "33": { desc: "Tiene que buscar set; especulativa", action: "Si nadie ha entrado, sube desde tardía; por lo demás, solo pagando una subida en botes multiway con stacks profundos" },
      "22": { desc: "El par servido más bajo", action: "Si nadie ha entrado, sube desde tardía; por lo demás, solo pagando una subida en botes multiway con stacks profundos" },
      K10o: { desc: "K-10 de distinto palo, débil", action: "Abre con una subida desde CO/BTN si todos han foldeado" },
      Q10o: { desc: "Poca conectividad y distinto palo", action: "Solo BTN" },
      J10o: { desc: "Aceptable de distinto palo, pero vulnerable", action: "Solo BTN" },
      ...
      "65s": { desc: "Conector del mismo palo; quiere botes multiway y odds implícitas", action: "Si nadie ha entrado, sube desde tardía; paga una subida solo con posición y stacks profundos" },
      "54s": { desc: "Conector bajo del mismo palo; especulativo", action: "Si nadie ha entrado, sube desde tardía; paga una subida solo con posición y en botes multiway baratos" },
    },
  },
  ...
  pushfold: {
    ...
    huNote: {
      ...
      p1: ": se asume que la SB solo hace shove o fold. La opción de ante suma 0.125bb por jugador (12.5% de la ciega grande por jugador — lo que da un big blind ante en una mesa de 8; en heads-up son solo 0.25bb en total). Los rangos se amplían cuanto más cortos son los stacks — y por debajo de ~3–4bb la BB paga correctamente con un rango ",
      em: "más amplio",
  ...
  quickRef: [
    {
      ...
      intro: "La equity de dos manos que van all-in preflop, promediada sobre todas las combinaciones de palos de cada enfrentamiento (calculada de antemano: los 1,712,304 boards posibles de cada uno). Una combinación de palos concreta puede variar más de dos puntos (A♠K♠ contra Q♠J♠: 66.0%) — mete las cartas exactas en la pestaña «Equity» de arriba.",
  ...
  guide: {
    ...
    cards: [
      ...
      { icon: "⚡", title: "Tabla push/fold de Nash", body: "Una tabla 13×13 de Nash para heads-up, 6-max y 9-max: con qué manos hacer open-shove de 1 a 25bb (y, en heads-up, con cuáles pagar). Imprescindible en las fases finales de un torneo." },
    ],
  },
