...
const SPEC: [string, string][] = [
  ...
  ["语言", "简体中文（另有繁体中文、韩语、英语、日语、西班牙语、葡萄牙语、德语、法语、印尼语、马来语、印地语）"],
...
const SPOT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { board: "Q♥T♥7♠", slug: "3bet-pot-bet-sizing", name: "多变的双色牌面", note: "虽然是 3bet 底池，但这个牌面对跟注方也不差。可 3bet 方并不会收手——98.4% 的范围都用同一个 2/3 尺寸打出去" },
