...
A. 先比大对，再比小对，最后比那唯一一张踢脚牌——所以 A 带 3 赢过 K 带 Q，哪怕第二对小得多。让人栽跟头的是像 K-K-9-9-5 这样的双对牌面：除非有人拿着 K、9，或比 9 大的口袋对子，否则每个人都是同样的两对，整手牌就坍缩成一张踢脚牌，全桌最大的那张底牌拿走底池——要是没人的底牌能压过牌面上的 5，那就全员打公牌，平分底池。两对正好只带一张踢脚牌，绝不会有两张。
