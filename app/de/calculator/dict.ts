...
export const CALC_DICT_DE: CalcDict = {
  ...
  starting: {
    ...
    hands: {
      ...
      A10s: { desc: "Eines der besten Suited Aces", action: "Mittel/spät raisen; aus UTG raisen oder folden – niemals limpen" },
      ...
      A3s: { desc: "Wheel-Karte + Nut-Flush-Draw, eine Spur über A2s", action: "Nur spät" },
      A2s: { desc: "Wheel + Nut-Flush, aber schwach", action: "Nur spät" },
      ...
      K10o: { desc: "K-10 offsuit, schwach", action: "CO/BTN open-raisen, wenn vor dir alle gefoldet haben" },
      Q10o: { desc: "Offsuit, kaum Connectivity", action: "Nur BTN" },
      J10o: { desc: "Ordentlich offsuit, aber anfällig", action: "Nur BTN" },
  ...
  pushfold: {
    ...
    huNote: {
      ...
      p1: ": Vereinfachend wird angenommen, dass der SB entweder shovt oder foldet. Die Ante-Einstellung addiert 0,125bb pro Spieler (12,5% des Big Blinds pro Spieler – so viel ergibt eine Big Blind Ante am 8er-Tisch; heads-up sind das insgesamt nur 0,25bb). Die Ranges werden breiter, je kürzer die Stacks sind – und unter ~3–4bb callt der BB korrekterweise ",
      em: "breiter",
  ...
  quickRef: [
    {
      ...
      intro: "Equity, wenn zwei Hände preflop all-in gehen – gemittelt über jede Farbkombination des Matchups (offline vorberechnet: alle 1.712.304 Boards pro Zeile). Eine bestimmte Farbkombination kann um mehr als zwei Punkte abweichen (A♠K♠ gegen Q♠J♠: 66,0%) – gib die genauen Karten oben im Tab „Equity“ ein.",
  ...
  guide: {
    ...
    cards: [
      ...
      { icon: "⚡", title: "Nash-Push/Fold-Chart", body: "Ein 13×13-Nash-Chart für Heads-up, 6-max und 9-max: welche Hände du bei 1–25bb open-shovst (und heads-up, mit welchen du callst). Pflicht für die späte Turnierphase." },
    ],
  },
