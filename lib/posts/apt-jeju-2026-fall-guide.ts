...
APT 인천은 8월 7~16일, APT 제주 가을은 9월 25일~10월 4일. 약 5주 간격으로 두 대회 모두 참가할 수 있습니다. 단, 두 대회는 장소가 다릅니다.

| | APT 인천 2026 | APT 제주 2026 가을 |
|--|-------------|-----------------|
| 카지노 | 파라다이스 시티 (인천 영종도) | LES A 카지노 (제주 신화월드) |
| 날짜 | 8월 7~16일 | 9월 25~10월 4일 |
...
② <strong style="color:var(--foreground)">My Documents</strong> 탭 선택<br/>
③ 여권 앞면 사진 업로드<br/>
...
| 단계 | 바이인 | 보상 |
|------|--------|------|
| Step 위성 | **$3.50** 또는 $20 | Mega Satellite 티켓 |
| Mega Satellite ($35) | $35 | 메인이벤트 Live Day 1 시트 |
| Mega Satellite ($200) | $200 | 메인이벤트 Live Day 1 시트 |
| 온라인 직접 바이인 | ~$1,570 | 메인이벤트 OnLive Day 3 직행 |

</div>

**Natural8 위성 찾는 법:**
로그인 → 로비 상단 **"Tournaments"** → **"APT"** 또는 **"Jeju"** 검색 → 위성 목록 확인

==g:Natural8 위성 통과자 전용 혜택: $8,000 Last Longer Challenge 참가 자격 (APT 제주 클래식 기준 — 가을 대회도 유사 이벤트 예정)==

---

## STEP 3 — Natural8으로 온라인 사전 등록

위성 통과 또는 온라인 직접 바이인 후 사전 등록 가능합니다.

**1. Natural8 로그인 → Tournaments → APT Jeju 2026 이벤트 선택**

**2. 원하는 토너먼트 클릭 → "Register" 클릭**
- 온라인 등록은 **대회 24시간 전까지** 가능
- 이후에는 반드시 현장 등록 데스크 방문

**3. 등록 확인 이메일 수신**

**4. 현장에서 Registration Desk 방문 → 시트 카드 수령**
...
✅ 현금(KRW) — 가능<br/>
✅ 카지노 칩 — 가능<br/>
✅ Natural8 계정 잔액 (온라인 사전 등록) — 가능<br/>
...
**2. 최초 방문자: 무료 Landing 멤버십 카드 발급 (5분)**
- 카드 발급 시 여권 제시 필수
- 이미 APT 인천 또는 APT 제주 클래식에서 발급받은 Landing 카드가 있다면 재사용 가능

**3. APT Registration Desk 찾기**
- 카지노 내부 또는 포커룸 입구에 "APT Registration" 표지판 있음
- 모르면 직원에게 "APT Jeju Registration?" 하면 안내

**4. 등록 데스크에서 처리**
- 여권 + 결제 수단(Natural8 계정 또는 현금) 제시
- 사전 등록자: 이메일 확인서 제시 → 시트 카드 수령
- 현장 등록: 결제 후 바로 시트 배정
...
<div style="display:flex;align-items:center;gap:10px;padding:8px 0"><span style="width:18px;height:18px;border-radius:4px;background:rgba(34,197,94,0.15);border:1.5px solid rgba(34,197,94,0.5);flex-shrink:0;display:flex;align-items:center;justify-content:center;color:#22c55e;font-size:11px">✓</span><span>편한 복장 — 슬리퍼, 민소매 입장 불가</span></div>
</div>
</div>
...
A. 가능합니다. 두 대회가 약 5주 간격으로 열립니다. APT 인천은 인천 영종도 파라다이스 시티, APT 제주는 제주 신화월드로 장소가 다릅니다. 자세한 내용은 [APT 인천 2026 가이드](/blog/apt-incheon-2026-guide/)를 참고하세요.
...
A. 공식 발표 전이지만, APT 제주 클래식 2026 기준 전체 상금 보장 규모는 **49억원(~USD 340만)** 이었습니다. 가을 대회도 유사한 규모로 예상됩니다.
