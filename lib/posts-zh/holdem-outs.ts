...
这个习惯叫数 **outs（补牌）**——poker 里"数牌"的真正答案——它是每一个赔率决策底下都躺着的那一项基本功。在你能问"这次跟注划算吗？"之前，你得先答上"有几张牌能帮我赢下这手？"这篇讲的是数牌这一半——[德扑赔率与概率对照表](/zh/blog/holdem-probability "thumb:/images/holdem-probability-hero.webp")是它背后的参考，而[底池赔率](/zh/blog/holdem-pot-odds)是你拿到这个数字之后要做的事。
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  ...
  <div style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px">
