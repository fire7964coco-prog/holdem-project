...
サイドポットの計算、誰が先にカードを見せるか、テーブルステークスといった仕組みの全体は [オールインのルールとサイドポット](/ja/blog/holdem-all-in-rules) にまとめています。
...
A. リンプとは、プリフロップでレイズせずにビッグブラインド額をコールするだけで参加することです。合法ですが、多くの場合は弱いプレイとされています。
