...
实战法则：==你是最后进攻者，就得亮牌——哪怕是被跟注的诈唬。== 盖牌不亮是跟注方的权利，而且要在看过下注方的牌之后。自己下注却抢着盖牌，等于亏两次：跟注方本来就可以要求看你的牌；而且牌面说话，不少底池是被"以为输了"的人扔掉的，其实他的 A 高还领先。
...
| 河牌圈的全押下注被跟注 | 全押下注者作为最后进攻者先亮牌——但 ==r:这里谁都不能盖牌==：按 TDA 第 16 条，跟注方同样必须摊牌 |
...
这条规则是双向的。如果你以为自己输了，没亮牌就直接盖掉，而你的牌本来是赢的——==r:底池就没了==。只有当荷官把牌推进弃牌堆、再也无法清楚辨认时，这手牌才算死牌——只是扣着放下并不会自动作废（TDA 第 14 条）。话虽如此，永远别指望这一点。只要你不是 100% 确定自己输了，盖牌前一定先让荷官读牌。
...
A. 必须——如果你是河牌圈最后一个下注或加注的人，被跟注后你要先亮牌。如果你是跟注方，看过对方的牌后确认自己输了，可以牌面朝下盖掉。不过在大多数牌室，任何本局发到牌的玩家都可以要求荷官翻开一手被跟注后盖掉的牌。
