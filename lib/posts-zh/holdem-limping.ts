...
有一点老实的提醒，因为环境能改变一切。在**线上和更硬的牌局**里，limp 挨打的机制很具体：你 open-limp 的范围是封了顶的（真正的强牌你会加注），后面的玩家看准这一点，就用 iso-raise 把你单独拎出来——翻牌之后你既没位置、范围又比他弱，两头都吃亏。小盲位补齐之所以是例外，是因为那里只需要再补半个盲注、身后也只剩大盲一个人能加注，理由见上文。

在**非常被动的现场低级别牌局**里，那是另一个世界。如果桌上惯常让 limper 花很少看翻牌、没人惩罚他们，那用投机牌 limp 的代价就小得多——你不会被隔离，还能用那些不太想面对加注的牌去兑现胜率。它仍然不是*最优*——其中从前面位置 open-limp 依旧是最糟的一种——但代价很小，在一个"全家福"底池里钓暗三还能印钞。读懂你的桌子：牌局越软越被动，你能蒙混过关的 limp 就越多；牌局越硬，你就越应该严格地加注或弃牌。
