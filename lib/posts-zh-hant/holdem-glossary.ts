...
export const POST: Post = {
  ...
  content: `
我第一次坐進現場局的時候，整桌人簡直像在說另一種語言。有人「槍口位」，另一個人「3-bet 了 CO」，荷官問我要不要「分兩次發（run it twice）」，等我拿著一對 K 輸牌，別人還告訴我「這都算不上 Bad Beat，只是個 Cooler（冷牌組）」。我像聽懂了一樣點頭。其實我一句都沒懂。
...
> **快速解答**
> 先整理這 8 組詞的理由很單純：其餘九十幾個術語聽不懂頂多尷尬，這 8 組搞混會直接讓你付錢——把過牌當跟注、把明三條當暗三條，錯的是動作，不是詞彙。
...
| **Cooler vs Bad Beat** | [Cooler（冷牌組）](/zh-hant/blog/holdem-cooler)＝你一路落後又蓋不掉；Bad Beat（爆冷門）＝你本來領先卻被對手超車。 |
...
| **拉桿注（String bet）** | 沒宣告就回手再拿籌碼——只有第一個動作算數（通常判為跟注）。先喊「加注」，分次推碼就是合法的。 |
...
> **快速解答**
> 與其記座位名稱，不如記「誰在誰之後說話」：按鈕位翻後最後、小盲翻後最先、槍口位翻前最先，其餘都是相對關係。台灣現場多半直接喊 CO、HJ 這些英文縮寫，中文名稱知道就好。
...
| **[Cooler（冷牌組）](/zh-hant/blog/holdem-cooler)** | 大牌輸給更大的牌、卻沒有任何失誤——是撲克裡最無奈的一種輸法。 |
...
| **[抽水（Rake）](/zh-hant/blog/holdem-rake)** | 撲克室從每個底池抽的一小份。 |
...
A. Bad Beat（爆冷門）是錢進去時你是大熱門，卻被一張幸運牌超車。Cooler（冷牌組）是你一路落後、手上又是一手強到蓋不掉的牌，對手根本不需要運氣——大牌從頭到尾都領先。快速判斷：如果對手要 *改善* 才能贏，那是 Bad Beat；不用，就是 Cooler。
