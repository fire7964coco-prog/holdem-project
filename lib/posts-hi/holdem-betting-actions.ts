...
| Check | सिर्फ़ तब जब आपके सामने कोई चालू bet न हो (preflop: सिर्फ़ big blind के तौर पर) | मुफ़्त — chips डाले बिना पास करते हैं |
...
सबसे अहम नियम जो शुरुआती चूक जाते हैं: ==r:आपके सामने चालू bet हो तो आप check नहीं कर सकते==। जैसे ही pot में ऐसे chips आ जाते हैं जिन्हें आपने मैच नहीं किया, आपके विकल्प सिमटकर fold, call या raise रह जाते हैं।
...
| | Check | Call |
|-|-------|------|
| कब मौजूद होता है | आपके सामने कोई चालू bet नहीं है (preflop: सिर्फ़ big blind के तौर पर) | आपसे पहले किसी ने bet किया है |
...
हाँ — जब भी action आप पर हो आप fold कर सकते हैं, कुछ भी bet करने से पहले भी, और वह fold बाध्यकारी होता है। पूरी तरह मुफ़्त हालाँकि नहीं है: टूर्नामेंट में, सामने कोई bet न होते हुए fold करना ==WSOP नियम 84== के तहत "non-standard fold" माना जाता है और इस पर चेतावनी मिल सकती है। और इस जाल का भी ध्यान रखें: **जब check मुफ़्त हो सकता था तब fold करना बिना वजह हैंड फेंक देना है**। अगर किसी ने bet नहीं किया, तो बस check करें।
...
1. **chips हिलाने से पहले "raise" बोलें।** "call" बोलकर फिर और chips आगे धकेलना? आपकी घोषणा उसी पल बाध्यकारी हो चुकी थी (==नियम 90.d==) — अतिरिक्त हिस्सा गिना ही नहीं जाएगा। असली ==string bet== कुछ और है: पहले "raise" कहे बिना कई मूवमेंट में chips आगे बढ़ाना (==नियम 103==)।
...
**Fixed-Limit** गेम में हर राउंड पर cap होता है (एक "capped" pot)। WSOP के टूर्नामेंट नियम cap को ==एक bet और चार raise== पर रखते हैं (नियम 100.b) — और अपवाद ज़्यादातर लोगों की उम्मीद से ठीक उल्टा चलता है: ==r:हैंड में सिर्फ़ दो खिलाड़ी बचे हों तब भी cap लागू रहता है==। यह तभी हटता है जब **पूरा टूर्नामेंट** heads-up हो जाए। cash game में house rules चलते हैं, तो डीलर से पूछ लें।
...
flop पर पहले action करना है, किसी ने bet नहीं किया, और एक नया खिलाड़ी **चुपचाप** chips आगे सरका देता है, "call करने के लिए"। यहाँ call करने के लिए कुछ है ही नहीं: ==WSOP नियम 90.a== के मुताबिक bet घोषणा से *या* chips आगे बढ़ाने से होती है — उसने अनजाने में bet कर दिया। अगर उसने "call" *कहा* होता, तो ==नियम 90.b.1== के तहत वह सिर्फ़ check होता। जब street खुली न हो, तो check करें और कार्ड मुफ़्त में देखें।
...
$10 के bet के सामने खिलाड़ी चुपचाप एक $100 chip डाल देता है, बदले में change *और* एक raise की उम्मीद में। ==one-chip नियम== WSOP के नियमों में हूबहू ऐसे ही है (==नियम 97==): बिना बोले डाला गया एक बड़ा chip सिर्फ़ call है। raise करना है तो "raise" शब्द **chip के मेज़ को छूने से पहले** निकलना चाहिए।
...
A. No-Limit में raise की संख्या पर कोई cap नहीं — जब तक हर raise minimum increment पर खरी उतरे, re-raise तब तक चल सकती है जब तक कोई खिलाड़ी all-in न हो। Fixed-Limit में WSOP के टूर्नामेंट नियम राउंड का cap एक bet और चार raise पर रखते हैं (नियम 100.b), और हैंड में दो खिलाड़ी बचने पर भी वह cap लागू रहता है।
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin:24px 0">
  <a href="/hi/blog/texas-holdem-rules-for-beginners" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">शुरुआती के लिए टेक्सस होल्डम के नियम</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">पूरी नियम गाइड — blinds से showdown तक</div>
  </a>
  <a href="/hi/blog/holdem-game-order" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:14px;font-weight:700;color:hsl(var(--foreground));line-height:1.4">टेक्सस होल्डम का खेल क्रम</div>
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">असली हैंड उदाहरणों के साथ preflop से river तक</div>
  </a>
  <a href="/hi/blog/holdem-blind-meaning" style="display:block;padding:16px 18px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:12px;text-decoration:none;transition:border-color 0.2s" onmouseover="this.style.borderColor='rgba(212,175,55,0.45)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.10)'">
    ...
    <div style="font-size:12px;color:hsl(var(--muted-foreground));margin-top:4px">आप कार्ड देखने से पहले क्यों चुकाते हैं</div>
  </a>
</div>
`.trim(),
};
