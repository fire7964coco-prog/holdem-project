...
> **快速回答**
> 对几乎所有人来说不赚，是 -EV：你在看牌之前就盲投了钱，位置优势被压缩（求解器在被 straddle 的池里反而开更少的牌），抽水也可能增加。站得住脚的只有松-被动桌、全桌按相同条件轮流抓的局，或者纯为了乐子。
...
A. 对大多数玩家来说，不赚——这是个 -EV 的打法。你盲投了钱，你缩小了自己的位置优势（求解器在有 straddle 的底池里开的牌*更少*，不是更多），你还可能多付抽水。它只有在松-被动的桌子上、在全桌按相同条件轮流抓的局里、或者纯为了乐子时才站得住脚——几乎不能当作赚钱的手段。不过，GTO Wizard 指出，全桌按相同条件轮流抓、共同提高赌注时，桌上实力较强的玩家通常能从中受益。
