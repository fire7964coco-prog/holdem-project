...
最后进攻者亮牌之后，其余玩家可以二选一：
- 觉得自己赢了就**亮牌**
- 看到自己输了就**牌面朝下盖掉**——不必让任何人看到你的底牌。但这只在没人全押时成立：一旦有人全押，按 TDA 第 16 条，该底池涉及的所有牌都必须摊开，谁都不能盖牌
...
A. 必须——如果你是河牌圈最后一个下注或加注的人，被跟注后你要先亮牌。如果你是跟注方，看过对方的牌后确认自己输了，可以牌面朝下盖掉。例外是全押：按 TDA 第 16 条，跟注方同样必须摊牌。而在锦标赛里，只有手上仍有牌或已经摊牌的人才能要求看牌——不可剥夺的，只限最后进攻者那一手。
